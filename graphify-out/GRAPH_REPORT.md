...
## Corpus Check
- 142 files · ~374,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1705 nodes · 4587 edges · 96 communities (90 shown, 6 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2140 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a03db234`
...
Cohesion: 0.06
Nodes (40): ai_diagnostics(), apply_sideboard(), autoplay_tick(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+32 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (35): check_cost_option_available(), collect_cost_options(), CostOption, RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card() (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (48): apply_cost_modifiers(), CostContext, _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color(), count_untapped_nonland_mana_sources_by_color(), _find_any_untapped_land() (+40 more)
...
Cohesion: 0.14
Nodes (43): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), apply_state_based_actions(), from_decks(), _setup_creature() (+35 more)
...
Cohesion: 0.08
Nodes (19): draw_card(), compute_max_land_plays_this_turn(), RulesEngine, test_discard_additional_cost_is_paid(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th (+11 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (36): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage. (+28 more)
...
Cohesion: 0.18
Nodes (30): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+22 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (11): AIDecision, AIDecision, _card_looks_like_land(), _auto_bottom_cards(), topdeck_put_creatures_battlefield(), add_generic_to_cost(), parse_mana_cost(), _auto_bottom_cards() (+3 more)

### Community 20 - "Community 20"
Cohesion: 0.18
Nodes (27): _creature_value(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power(), effective_toughness() (+19 more)
...
Cohesion: 0.16
Nodes (25): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _max_attackers_blockable_by_creature(), _minimum_blockers_required(), _remaining_lethal_damage() (+17 more)

### Community 25 - "Community 25"
Cohesion: 0.12
Nodes (22): simulate_batch_start(), create_token(), topdeck_put_creatures_battlefield(), Enum, assign_static_order_on_battlefield_entry(), _infer_keywords(), _infer_loyalty(), _infer_power() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (21): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land(), _is_land_card(), pass_priority() (+13 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (22): _can_cast_spell(), _has_any_target_options(), _is_land_card(), card_cant_attack(), card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers() (+14 more)
...
Cohesion: 0.13
Nodes (21): destroy_all_creatures(), destroy_permanent(), draw_cards(), gain_life(), lose_life(), _move_creature_to_graveyard(), sacrifice(), replace_draw_cards() (+13 more)

### Community 30 - "Community 30"
Cohesion: 0.18
Nodes (20): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints() (+12 more)
...
Cohesion: 0.23
Nodes (14): init_db(), autoplay_tick(), _is_full_ai_match(), _ensure_card_faces_column(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match(), test_autoplay_forces_ai_land_drop_on_own_main_phase() (+6 more)
...
Cohesion: 0.19
Nodes (16): declare_attackers(), _defender_label(), _valid_defenders(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), test_static_you_cant_cast_spells_during_combat_enforced() (+8 more)

### Community 37 - "Community 37"
Cohesion: 0.21
Nodes (15): emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice(), add_to_stack(), resolve_top_of_stack(), add_to_stack() (+7 more)
...
Cohesion: 0.16
Nodes (14): _deal_unblocked_damage(), _mark_creature_damage(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage() (+6 more)
...
Cohesion: 0.31
Nodes (10): _collect_triggers(), _first_number(), _maybe_payload(), _trigger_from_oracle(), _collect_triggers(), _first_number(), _matches_creature_dies_trigger(), _maybe_payload() (+2 more)
...
Cohesion: 0.6
Nodes (4): _board_value(), evaluate_inevitability(), _noncreature_value(), _planeswalker_count()
...
- **Why does `AIAgent` connect `Community 1` to `Community 0`, `Community 33`, `Community 2`, `Community 67`, `Community 3`, `Community 38`, `Community 7`, `Community 73`, `Community 10`, `Community 11`, `Community 12`, `Community 45`, `Community 46`, `Community 15`, `Community 19`, `Community 25`, `Community 31`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 6` to `Community 32`, `Community 33`, `Community 0`, `Community 67`, `Community 3`, `Community 37`, `Community 4`, `Community 36`, `Community 10`, `Community 43`, `Community 12`, `Community 13`, `Community 18`, `Community 19`, `Community 20`, `Community 25`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 15`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 33`, `Community 36`, `Community 43`, `Community 45`, `Community 46`, `Community 60`, `Community 63`, `Community 67`?**
