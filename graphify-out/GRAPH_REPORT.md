...
## Corpus Check
- 141 files · ~373,268 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1681 nodes · 4542 edges · 92 communities (90 shown, 2 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2133 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9dd70c5`
...
Cohesion: 0.05
Nodes (87): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), CardInstance, PlayerState, _extract_keywords_from_text(), _extract_modes(), _first_creature() (+79 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (46): check_cost_option_available(), RulesEngine, from_decks(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid() (+38 more)
...
Cohesion: 0.06
Nodes (54): resolve_effect(), gain_life(), resolve_effect(), test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage. (+46 more)
...
Cohesion: 0.06
Nodes (39): ai_diagnostics(), apply_sideboard(), _card_looks_like_land(), _default_player_for_state(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), _force_ai_land_action(), get_legal_moves() (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (49): apply_cost_modifiers(), CostContext, _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color(), count_untapped_nonland_mana_sources_by_color(), _find_any_untapped_land() (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (24): AIAgent, _card_looks_like_land(), _step_key(), guess_archetype(), start_match(), test_aggro_ai_prefers_creature_development_over_burn_early(), test_ai_avoids_mana_tap_loop_when_no_cast_available(), test_ai_does_not_treat_mana_creature_as_land_in_forced_land_logic() (+16 more)
...
Cohesion: 0.22
Nodes (37): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, list_cards(), MatchController (+29 more)
...
Cohesion: 0.06
Nodes (13): copy_ability(), copy_spell(), _copy_stack_object(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments(), destroy_all_enchantments(), _destroy_all_permanents_of_types(), create_token() (+5 more)

### Community 13 - "Community 13"
Cohesion: 0.15
Nodes (37): combat_damage(), declare_blockers(), _max_attackers_blockable_by_creature(), combat_damage(), declare_blockers(), _max_attackers_blockable_by_creature(), from_decks(), _setup_creature() (+29 more)
...
Cohesion: 0.12
Nodes (30): 3) Frontend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+22 more)

### Community 16 - "Community 16"
Cohesion: 0.17
Nodes (28): _combat_damage_step(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power() (+20 more)
...
Cohesion: 0.16
Nodes (24): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _defender_label(), _mark_creature_damage(), _minimum_blockers_required(), _remove_dead_creatures() (+16 more)

### Community 23 - "Community 23"
Cohesion: 0.18
Nodes (19): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), _start_next_game_state(), _ensure_card_faces_column(), init_db() (+11 more)
...
Cohesion: 0.13
Nodes (22): _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), destroy_all_creatures(), destroy_permanent(), gain_life(), lose_life(), _move_creature_to_graveyard() (+14 more)
...
Cohesion: 0.13
Nodes (12): compute_max_land_plays_this_turn(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn() (+4 more)
...
Cohesion: 0.21
Nodes (4): get_match_replay(), simulate_batch_start(), str, test_replay_endpoint_returns_entries()
...
Cohesion: 0.22
Nodes (8): _deal_unblocked_damage(), consume_player_prevention_shield(), _deal_unblocked_damage(), test_unblocked_damage_to_removed_planeswalker_disappears(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam, test_attack_can_target_planeswalker_and_reduce_loyalty(), test_planeswalker_loyalty_ability_appears_in_legal_moves(), test_unblocked_damage_to_removed_planeswalker_disappears()
...
Cohesion: 0.24
Nodes (6): draw_cards(), draw_card(), draw_cards(), replace_draw_cards(), _auto_bottom_cards(), draw_card()
...
## Knowledge Gaps
- **180 isolated node(s):** `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Push control decks to convert resources instead of over-passing in developed boa`, `Ingest external tournament event payloads into normalized local tables.      Exp`, `When an unblocked attacker targets a PW that leaves the battlefield,     the dam`, `Spell damage should kill creatures — state-based lethal check after damage.` (+175 more)
...
- **Why does `AIAgent` connect `Community 4` to `Community 33`, `Community 1`, `Community 2`, `Community 36`, `Community 5`, `Community 7`, `Community 9`, `Community 42`, `Community 43`, `Community 48`, `Community 17`, `Community 21`, `Community 23`, `Community 27`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 1` to `Community 0`, `Community 32`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 41`, `Community 13`, `Community 48`, `Community 16`, `Community 53`, `Community 23`, `Community 56`, `Community 62`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 13`, `Community 16`, `Community 17`, `Community 20`, `Community 23`, `Community 28`, `Community 29`, `Community 30`, `Community 35`, `Community 41`, `Community 42`, `Community 43`, `Community 48`, `Community 51`, `Community 53`, `Community 56`?**
