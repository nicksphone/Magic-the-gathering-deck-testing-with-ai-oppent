...
## Corpus Check
- 142 files · ~373,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1691 nodes · 4562 edges · 91 communities (89 shown, 2 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2138 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25357c52`
...
Cohesion: 0.09
Nodes (52): _auto_bottom_cards(), topdeck_put_creatures_battlefield(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost() (+44 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (54): AIAgent, test_ai_assigns_two_blockers_against_menace_attacker(), test_ai_attack_selection_avoids_suicidal_one_one_into_bigger_board(), test_ai_blocks_with_stronger_creature_to_prevent_damage(), test_ai_materialize_sets_default_cost_choice_when_options_present(), test_ai_materializes_block_assignments(), test_ai_materializes_x_value_for_x_spells(), test_aggro_ai_avoids_suicide_attack_into_larger_blocker() (+46 more)
...
Cohesion: 0.07
Nodes (34): apply_sideboard(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _is_full_ai_match(), next_game() (+26 more)
...
Cohesion: 0.09
Nodes (36): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature. (+28 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (29): _hydrate_deck_cards(), fallback_card_payload(), ensure_placeholder_image(), _family(), _svg_for(), _cache_remote_token_image(), _extract_image_uri(), resolve_token_image_uri() (+21 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (26): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), first_log_divergence(), normalize_log_line(), get_match_replay(), classify_first_divergence(), classify_log_line() (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (27): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), classify(), main() (+19 more)
...
Cohesion: 0.11
Nodes (32): 3) Frontend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+24 more)
...
Cohesion: 0.17
Nodes (28): _creature_value(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power() (+20 more)
...
Cohesion: 0.1
Nodes (24): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, Zone (+16 more)
...
Cohesion: 0.13
Nodes (14): AnalyticsService, _batch_seed(), compare_replay_logs(), _extract_turn_summaries(), analytics_history(), simulate_batch(), start_match(), guess_archetype() (+6 more)
...
Cohesion: 0.15
Nodes (24): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _defender_label(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (6): main(), parse_args(), load_json(), main(), run_cmd(), str
...
Cohesion: 0.19
Nodes (15): emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice(), add_to_stack(), add_to_stack(), resolve_top_of_stack() (+7 more)
...
Cohesion: 0.19
Nodes (8): compute_max_land_plays_this_turn(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard()

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (15): card_color_names(), _deal_unblocked_damage(), _mark_creature_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), _creature_is_lethally_damaged() (+7 more)
...
- **Why does `AIAgent` connect `Community 3` to `Community 33`, `Community 1`, `Community 35`, `Community 4`, `Community 66`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 46`, `Community 17`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 28`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 33`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 60`, `Community 64`, `Community 66`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 18` to `Community 0`, `Community 1`, `Community 66`, `Community 34`, `Community 2`, `Community 64`, `Community 7`, `Community 40`, `Community 41`, `Community 10`, `Community 11`, `Community 43`, `Community 47`, `Community 19`, `Community 22`, `Community 26`, `Community 59`, `Community 28`?**
