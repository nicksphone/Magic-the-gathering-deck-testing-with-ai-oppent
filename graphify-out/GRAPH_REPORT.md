...
## Corpus Check
- 171 files · ~435,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2338 nodes · 6091 edges · 114 communities (112 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2738 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7376ef3`
...
1. `AIAgent` - 239 edges
2. `CardInstance` - 154 edges
3. `RulesEngine` - 151 edges
...
Cohesion: 0.05
Nodes (71): _board_role_hint(), build_priors_from_examples(), build_priors_from_logs(), _build_priors_payload(), _count_creatures(), _record_card_timing(), save_log_priors(), _sum_power() (+63 more)
...
Cohesion: 0.05
Nodes (55): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action() (+47 more)
...
Cohesion: 0.06
Nodes (45): legal_moves(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, extract_loyalty_abilities(), draw_card(), test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn() (+37 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (32): get_repo(), init_db(), CardCache, DeckRecord, MatchRecord, StatsSnapshot, _ensure_card_cache_columns(), _ensure_card_faces_column() (+24 more)

### Community 7 - "Community 7"
Cohesion: 0.14
Nodes (46): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), MatchController (+38 more)
...
Cohesion: 0.07
Nodes (47): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone, draw_cards() (+39 more)
...
Cohesion: 0.07
Nodes (26): _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), lifespan() (+18 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (27): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell() (+19 more)
...
Cohesion: 0.07
Nodes (20): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+12 more)
...
Cohesion: 0.07
Nodes (23): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response. (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (17): card_completeness(), list_cards(), Report cached metadata and asset gaps for a deck's distinct card names., saved_deck_card_completeness(), saved_deck_completeness(), suggest_card(), CardService, ScryfallSyncService (+9 more)
...
Cohesion: 0.15
Nodes (34): _all_battlefield_ids(), _continuous_pt_delta(), _counter_pt_delta(), effective_keywords(), effective_power(), effective_toughness(), _has_subtype(), _is_battlefield() (+26 more)
...
Cohesion: 0.12
Nodes (25): MatchState, AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices() (+17 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (28): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+20 more)
...
Cohesion: 0.13
Nodes (23): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+15 more)
...
Cohesion: 0.15
Nodes (20): _count_controlled_type(), gain_life(), lose_life(), gain_life(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts() (+12 more)
...
Cohesion: 0.23
Nodes (21): effective_power(), effective_toughness(), test_counters_affect_effective_stats_dynamically(), Anthem-like buffs must not permanently modify card.power/toughness., +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin, Anthem-like buffs must not permanently modify card.power/toughness., +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin, _setup_creature() (+13 more)

### Community 39 - "Community 39"
Cohesion: 0.17
Nodes (20): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), CardInstance (+12 more)
...
Cohesion: 0.14
Nodes (15): _infer_mana_from_land(), _is_land_card(), pass_priority(), cycling_cost(), cycling_is_variable(), cycling_variant(), Return a cycling cost, optionally including a validated X/Y symbol., Return a cycling cost, optionally including a validated X/Y symbol. (+7 more)
...
Cohesion: 0.13
Nodes (6): Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Search small-board attack subsets through the defender's best legal blocks.

### Community 52 - "Community 52"
Cohesion: 0.17
Nodes (11): card_color_names(), protection_match_reason(), _protection_tokens(), _damage_prevented_by_protection(), _deal_unblocked_damage(), protected_from_source(), protection_match_reason(), _protection_tokens() (+3 more)
...
Cohesion: 0.22
Nodes (9): extract_activated_abilities(), Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface. (+1 more)
...
## Knowledge Gaps
- **331 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+326 more)
...
- **Why does `AIAgent` connect `Community 1` to `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 18`, `Community 21`, `Community 25`, `Community 26`, `Community 32`, `Community 35`, `Community 40`, `Community 41`, `Community 47`, `Community 48`, `Community 51`, `Community 61`, `Community 62`, `Community 73`, `Community 85`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 5` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 19`, `Community 23`, `Community 26`, `Community 29`, `Community 32`, `Community 38`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 48`, `Community 61`, `Community 73`, `Community 85`, `Community 95`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 10` to `Community 0`, `Community 1`, `Community 5`, `Community 9`, `Community 12`, `Community 16`, `Community 19`, `Community 26`, `Community 29`, `Community 36`, `Community 39`, `Community 46`, `Community 59`, `Community 60`, `Community 61`, `Community 66`, `Community 86`, `Community 89`, `Community 95`, `Community 96`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Are the 144 inferred relationships involving `AIAgent` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`AIAgent` has 144 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 152 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 152 INFERRED edges - model-reasoned connections that need verification._
