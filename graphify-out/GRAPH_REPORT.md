...
## Corpus Check
- 140 files · ~369,358 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1605 nodes · 4379 edges · 97 communities (91 shown, 6 thin omitted)
- Extraction: 52% EXTRACTED · 48% INFERRED · 0% AMBIGUOUS · INFERRED: 2096 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f043e41c`
...
Cohesion: 0.06
Nodes (42): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _extract_turn_summaries(), classify() (+34 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (39): check_cost_option_available(), collect_cost_options(), CostOption, RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine (+31 more)
...
Cohesion: 0.1
Nodes (50): apply_cost_modifiers(), CostContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color(), count_untapped_nonland_mana_sources_by_color() (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (38): ai_diagnostics(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _hydrate_deck_cards(), _is_full_ai_match() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (23): copy_ability(), copy_spell(), _copy_stack_object(), create_token(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard() (+15 more)
...
Cohesion: 0.1
Nodes (35): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature. (+27 more)
...
Cohesion: 0.13
Nodes (25): autoplay_tick(), ingest_tournament_json(), MatchController, tournament_event_summary(), Ingest external tournament event payloads into normalized local tables.      Exp, TournamentIngestService, init_db(), autoplay_tick() (+17 more)
...
Cohesion: 0.18
Nodes (27): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), apply_state_based_actions() (+19 more)
...
Cohesion: 0.21
Nodes (26): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+18 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (23): _can_cast_spell(), _has_any_target_options(), _is_land_card(), card_cant_attack(), card_cant_attack_alone(), card_cant_block(), card_must_attack_if_able(), card_must_block_if_able() (+15 more)
...
Cohesion: 0.15
Nodes (15): build_cast_hints(), enrich_divide_total(), _infer_mana_from_land(), _is_land_card(), pass_priority(), build_cast_hints(), enrich_divide_total(), _extract_equip_cost_text() (+7 more)
...
Cohesion: 0.14
Nodes (16): draw_cards(), gain_life(), lose_life(), replace_draw_cards(), replace_gain_life(), player_cant_gain_life(), player_cant_lose_life(), Return destination zone for a dying creature: 'graveyard' or 'exile'. (+8 more)
...
Cohesion: 0.15
Nodes (6): guess_archetype(), _auto_bottom_cards(), topdeck_put_creatures_battlefield(), parse_mana_cost(), _auto_bottom_cards(), parse_mana_cost()
...
Cohesion: 0.27
Nodes (14): destroy_permanent(), sacrifice(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text(), _put_trigger_creature() (+6 more)
...
Cohesion: 0.21
Nodes (14): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _extract_keywords_from_text(), _first_creature() (+6 more)

### Community 42 - "Community 42"
Cohesion: 0.29
Nodes (13): _extract_modes(), inspect_target_hints(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text() (+5 more)
...
Cohesion: 0.22
Nodes (12): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), apply_additional_costs(), check_cost_option_available(), collect_cost_options() (+4 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Push control decks to convert resources instead of over-passing in developed boa`, `Ingest external tournament event payloads into normalized local tables.      Exp`, `When an unblocked attacker targets a PW that leaves the battlefield,     the dam`, `Spell damage should kill creatures — state-based lethal check after damage.` (+159 more)
...
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 18`, `Community 19`, `Community 23`, `Community 28`, `Community 32`, `Community 35`, `Community 38`, `Community 39`, `Community 43`, `Community 44`, `Community 58`, `Community 64`, `Community 66`, `Community 69`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `AIAgent` connect `Community 2` to `Community 0`, `Community 1`, `Community 66`, `Community 36`, `Community 4`, `Community 6`, `Community 7`, `Community 38`, `Community 69`, `Community 43`, `Community 12`, `Community 13`, `Community 17`, `Community 53`, `Community 23`, `Community 25`, `Community 26`, `Community 57`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 12` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 11`, `Community 13`, `Community 18`, `Community 20`, `Community 23`, `Community 24`, `Community 27`, `Community 32`, `Community 35`, `Community 36`, `Community 39`, `Community 42`, `Community 44`, `Community 64`, `Community 69`, `Community 76`?**
