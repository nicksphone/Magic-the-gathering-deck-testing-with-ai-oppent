...
## Corpus Check
- 110 files · ~293,053 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 985 nodes · 2859 edges · 51 communities (50 shown, 1 thin omitted)
- Extraction: 47% EXTRACTED · 53% INFERRED · 0% AMBIGUOUS · INFERRED: 1521 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0824cea`
...
3. `AIAgent` - 87 edges
4. `RulesEngine` - 85 edges
5. `AIAgent` - 82 edges
6. `RulesEngine` - 79 edges
7. `Repository` - 49 edges
...
- `test_timing_restriction_first_main_phase_only()` --calls--> `RulesEngine`  [INFERRED]
  backend/tests/test_new_rules_batch.py → backend/rules_engine/engine.py
- `card_cant_attack_alone()` --calls--> `_creature_is_lethally_damaged()`  [INFERRED]
  backend/rules_engine/restrictions.py → backend/rules_engine/combat.py

## Communities (51 total, 1 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (93): combat_damage(), declare_attackers(), declare_blockers(), _defender_label(), _valid_defenders(), check_cost_option_available(), RulesEngine, from_decks() (+85 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (37): AIAgent, AIDecision, _card_looks_like_land(), _step_key(), AIAgent, AIDecision, _card_looks_like_land(), _step_key() (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (65): attached_to(), is_aura(), is_equipment(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection() (+57 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (23): card_color_names(), create_token(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), destroy_permanent(), _move_creature_to_graveyard(), prevent_damage() (+15 more)
...
Cohesion: 0.07
Nodes (29): classify(), main(), compact_action(), hand_snapshot(), hydrate_deck(), load_named_deck(), main(), now_utc() (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (40): apply_cost_modifiers(), CostContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color(), count_untapped_nonland_mana_sources_by_color() (+32 more)
...
Cohesion: 0.09
Nodes (30): gain_life(), resolve_effect(), draw_cards(), gain_life(), resolve_effect(), apply_damage_replacements(), replace_draw_cards(), replace_gain_life() (+22 more)

### Community 9 - "Community 9"
Cohesion: 0.25
Nodes (29): ActionRequest, BulkSyncRequest, DeckImportRequest, PriorityStopsRequest, set_priority_stops(), SideboardRequest, StartMatchRequest, BaseModel (+21 more)
...
Cohesion: 0.12
Nodes (15): get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), list_expansion_top_decks(), sync_cards_bulk(), get_expansion_top_deck() (+7 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (23): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _can_cast_spell() (+15 more)
...
Cohesion: 0.29
Nodes (17): autoplay_tick(), _human_priority_pause(), MatchController, _post_step_finalize(), take_action(), init_db(), autoplay_tick(), _human_priority_pause() (+9 more)
...
Cohesion: 0.16
Nodes (11): enrich_divide_total(), validate_cast_choice(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), _extract_equip_cost_text(), _infer_mana_from_land() (+3 more)
...
Cohesion: 0.28
Nodes (14): sacrifice(), StackItem, emit_event(), add_to_stack(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+6 more)
...
Cohesion: 0.3
Nodes (10): attach_if_legal(), resolve_top_of_stack(), add_to_stack(), resolve_top_of_stack(), StackItem, _put_static_permanent_with_oracle(), test_sheoldred_opponent_draw_trigger_loses_life(), test_sheoldred_you_draw_trigger_gains_life_not_draw() (+2 more)
...
Cohesion: 0.28
Nodes (7): PlayerState, PlayerState, validate_cast_targets(), validate_protection_targets(), test_choose_two_validator(), test_divide_validator(), test_validate_protection_targets_blocks_protection_from_creatures()
...
- **Why does `from_decks()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 15`, `Community 16`, `Community 20`, `Community 25`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 15`, `Community 16`, `Community 20`, `Community 25`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 0` to `Community 1`, `Community 34`, `Community 5`, `Community 8`, `Community 9`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 27`?**
...
- **Are the 74 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 74 INFERRED edges - model-reasoned connections that need verification._