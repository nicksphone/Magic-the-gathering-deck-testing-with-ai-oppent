...
## Corpus Check
- 160 files · ~420,884 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2150 nodes · 5695 edges · 105 communities (103 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2590 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `beffac56`
...
## Communities (105 total, 2 thin omitted)
...
Cohesion: 0.05
Nodes (56): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_builtin_decks(), _force_ai_land_action() (+48 more)
...
Cohesion: 0.07
Nodes (42): draw_card(), legal_moves(), RulesEngine, extract_loyalty_abilities(), test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves() (+34 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (43): _hydrate_deck_cards(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), get_with_backoff(), ensure_placeholder_image() (+35 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (53): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), from_decks(), MatchState (+45 more)
...
Cohesion: 0.07
Nodes (44): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _auto_bottom_cards() (+36 more)
...
Cohesion: 0.07
Nodes (26): check_cost_option_available(), RulesEngine, draw_cards(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana() (+18 more)
...
Cohesion: 0.08
Nodes (18): _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), list_expansion_top_decks(), sync_cards_bulk() (+10 more)
...
Cohesion: 0.13
Nodes (32): discard_cards(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text(), _put_trigger_creature(), _put_trigger_permanent() (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (30): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+22 more)
...
Cohesion: 0.11
Nodes (22): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, Zone (+14 more)
...
Cohesion: 0.13
Nodes (25): attach_if_legal(), attached_to(), is_aura(), is_equipment(), cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, emit_event(), _order_apnap() (+17 more)
...
Cohesion: 0.19
Nodes (27): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature() (+19 more)
...
Cohesion: 0.16
Nodes (19): draw_cards(), gain_life(), lose_life(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+11 more)

### Community 36 - "Community 36"
Cohesion: 0.16
Nodes (19): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _choose_any_permanent_target() (+11 more)
...
Cohesion: 0.19
Nodes (14): compact_action(), hand_snapshot(), now_utc(), run(), battlefield_snapshot(), _cluster_labels(), compact_action(), hand_snapshot() (+6 more)
...
Cohesion: 0.18
Nodes (5): test_attack_is_declared_once_per_combat_step(), test_expansion_top_entries_have_deck_text(), test_ai_prefers_attack_on_open_board(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_deal_damage_to_creature_marks_damage_not_toughness()
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 14`, `Community 15`, `Community 20`, `Community 25`, `Community 28`, `Community 30`, `Community 33`, `Community 34`, `Community 40`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 51`, `Community 53`, `Community 64`, `Community 66`, `Community 82`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 14`, `Community 15`, `Community 19`, `Community 22`, `Community 25`, `Community 28`, `Community 29`, `Community 33`, `Community 40`, `Community 43`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 66`, `Community 76`, `Community 82`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 6` to `Community 1`, `Community 66`, `Community 4`, `Community 5`, `Community 27`, `Community 10`, `Community 45`, `Community 14`, `Community 15`, `Community 48`, `Community 49`, `Community 82`, `Community 22`, `Community 25`, `Community 59`, `Community 28`, `Community 29`, `Community 31`?**
