...
## Corpus Check
- 171 files · ~435,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2336 nodes · 6089 edges · 117 communities (115 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2738 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eb122cf1`
...
Cohesion: 0.05
Nodes (57): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (48): analytics_history(), apply_sideboard(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (43): legal_moves(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves() (+35 more)
...
Cohesion: 0.05
Nodes (22): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_search(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+14 more)

### Community 11 - "Community 11"
Cohesion: 0.17
Nodes (43): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, MatchController, PriorityStopsRequest (+35 more)

### Community 12 - "Community 12"
Cohesion: 0.14
Nodes (46): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), from_decks(), MatchState (+38 more)
...
Cohesion: 0.08
Nodes (29): _hydrate_deck_cards(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), get_with_backoff(), ensure_placeholder_image() (+21 more)
...
Cohesion: 0.08
Nodes (19): RulesEngine, draw_cards(), compute_max_land_plays_this_turn(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), test_attack_is_declared_once_per_combat_step(), Creatures present at untap lose summoning sickness; new ones keep it. (+11 more)
...
Cohesion: 0.12
Nodes (26): exile_permanent(), emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), resolve_top_of_stack(), add_to_stack(), resolve_top_of_stack() (+18 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (26): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+18 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (18): check_cost_option_available(), evaluate_board(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_cast_uses_available_alternate_cost_when_no_cost_choice_provided() (+10 more)
...
Cohesion: 0.13
Nodes (22): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback() (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.11
Nodes (16): _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, _ensure_card_cache_columns(), _ensure_card_faces_column() (+8 more)

### Community 35 - "Community 35"
Cohesion: 0.1
Nodes (14): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., evaluate_board(), test_ai_combat_uses_granted_keywords_from_static_effects() (+6 more)
...
Cohesion: 0.21
Nodes (19): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match() (+11 more)
...
Cohesion: 0.18
Nodes (19): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), CardInstance (+11 more)
...
Cohesion: 0.17
Nodes (15): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), classify_timeout_state(), normalize_log_line(), _parse_ai_trace_payload(), _trace_context_summary(), test_best_of_replay_aggregates_games_deterministically() (+7 more)
...
Cohesion: 0.2
Nodes (11): card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers(), _valid_defenders(), can_cast_in_current_timing(), card_cant_attack(), card_cant_attack_alone() (+3 more)
...
Cohesion: 0.27
Nodes (8): apply_state_based_actions(), apply_state_based_actions(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_state_based_action_lethal_creature_emits_permanent_and_creature_death_triggers(), test_state_based_action_zero_loyalty_planeswalker_emits_permanent_death_trigger()
...
## Knowledge Gaps
- **329 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+324 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 11`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 34`, `Community 35`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 48`, `Community 52`, `Community 53`, `Community 55`, `Community 62`, `Community 71`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 5` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 11`, `Community 12`, `Community 17`, `Community 18`, `Community 20`, `Community 27`, `Community 29`, `Community 32`, `Community 34`, `Community 39`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 55`, `Community 71`, `Community 98`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 7` to `Community 0`, `Community 5`, `Community 12`, `Community 14`, `Community 18`, `Community 27`, `Community 29`, `Community 33`, `Community 34`, `Community 36`, `Community 42`, `Community 45`, `Community 47`, `Community 55`, `Community 67`, `Community 74`, `Community 75`, `Community 90`, `Community 94`, `Community 98`?**
