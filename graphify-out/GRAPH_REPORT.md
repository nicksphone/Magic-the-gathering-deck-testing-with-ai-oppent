...
## Corpus Check
- 174 files · ~439,331 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2436 nodes · 6275 edges · 138 communities (133 shown, 5 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2802 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfb73ea7`
...
1. `AIAgent` - 240 edges
2. `CardInstance` - 166 edges
3. `RulesEngine` - 158 edges
...
Cohesion: 0.06
Nodes (53): RulesEngine, RulesEngine, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect() (+45 more)
...
Cohesion: 0.05
Nodes (52): ai_diagnostics(), analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action() (+44 more)
...
Cohesion: 0.07
Nodes (32): _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), lifespan() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.15
Nodes (41): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, list_cards(), PriorityStopsRequest (+33 more)
...
Cohesion: 0.05
Nodes (25): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), _creature_is_lethally_damaged(), crew_vehicle(), deal_damage_multi(), destroy_all_artifacts() (+17 more)
...
Cohesion: 0.08
Nodes (40): _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), resolve_effect(), from_decks(), _infer_keywords() (+32 more)
...
Cohesion: 0.11
Nodes (35): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), declare_attackers(), _defender_label() (+27 more)
...
Cohesion: 0.15
Nodes (27): autoplay_tick(), _human_priority_pause(), MatchController, init_db(), autoplay_tick(), _human_priority_pause(), MatchController, _ensure_card_cache_columns() (+19 more)
...
Cohesion: 0.14
Nodes (24): _extract_keywords_from_text(), extract_loyalty_abilities(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+16 more)
...
Cohesion: 0.14
Nodes (20): enrich_divide_total(), _extract_modes(), inspect_target_hints(), enrich_divide_total(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_non_divide_x_spell_does_not_auto_set_divide_total() (+12 more)

### Community 37 - "Community 37"
Cohesion: 0.13
Nodes (21): destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), damage_cant_be_prevented() (+13 more)
...
Cohesion: 0.16
Nodes (13): _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), normalize_cost_choice(), _extract_equip_cost_text(), _infer_mana_from_land(), _is_land_card() (+5 more)

### Community 52 - "Community 52"
Cohesion: 0.22
Nodes (14): build_cast_hints(), check_cost_option_available(), compute_max_land_plays_this_turn(), _can_cast_spell(), _has_any_target_options(), _is_land_card(), legal_moves(), can_cast_in_current_timing() (+6 more)
...
Cohesion: 0.27
Nodes (10): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), Zone, test_spell_cast_count_and_day_night_state_survive_snapshot_restore(), test_match_snapshot_round_trip_preserves_rng_sequence() (+2 more)
...
Cohesion: 0.23
Nodes (10): apply_state_based_actions(), apply_state_based_actions(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_ai_prefers_attack_on_open_board(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery() (+2 more)
...
Cohesion: 0.2
Nodes (5): test_attack_is_declared_once_per_combat_step(), test_expansion_top_entries_have_deck_text(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage(), test_prevent_damage_shield_reduces_player_damage()

### Community 78 - "Community 78"
Cohesion: 0.22
Nodes (10): card_cant_block(), card_must_block_if_able(), declare_attackers(), _defender_label(), _valid_defenders(), card_cant_attack(), card_cant_attack_alone(), card_cant_block() (+2 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 11`, `Community 15`, `Community 20`, `Community 21`, `Community 22`, `Community 26`, `Community 27`, `Community 33`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 45`, `Community 53`, `Community 61`, `Community 63`, `Community 66`, `Community 69`, `Community 71`, `Community 85`, `Community 89`, `Community 101`, `Community 112`, `Community 114`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 25`, `Community 28`, `Community 39`, `Community 40`, `Community 41`, `Community 45`, `Community 51`, `Community 53`, `Community 55`, `Community 63`, `Community 66`, `Community 71`, `Community 76`, `Community 77`, `Community 89`, `Community 94`, `Community 95`, `Community 99`, `Community 114`, `Community 115`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 7` to `Community 0`, `Community 1`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 25`, `Community 35`, `Community 36`, `Community 37`, `Community 41`, `Community 48`, `Community 63`, `Community 66`, `Community 67`, `Community 73`, `Community 99`, `Community 102`, `Community 103`, `Community 114`, `Community 115`, `Community 119`?**
...
- **Are the 164 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 164 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 142 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 142 INFERRED edges - model-reasoned connections that need verification._