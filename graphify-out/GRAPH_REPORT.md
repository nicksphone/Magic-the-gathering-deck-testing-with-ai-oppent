...
## Corpus Check
- 183 files · ~446,865 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2562 nodes · 6541 edges · 141 communities (136 shown, 5 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2888 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76b7d3dc`
...
Cohesion: 0.05
Nodes (55): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state() (+47 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (34): _get_attr_or_key(), select_display_image_uri(), get_with_backoff(), ensure_placeholder_image(), _family(), _slug(), _svg_for(), fuzzy_card_lookup() (+26 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (46): build_cast_hints(), check_cost_option_available(), draw_card(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), card_cant_attack(), RulesEngine (+38 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (30): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_search(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+22 more)
...
Cohesion: 0.08
Nodes (36): Enum, from_decks(), _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+28 more)
...
Cohesion: 0.05
Nodes (37): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+29 more)
...
Cohesion: 0.16
Nodes (36): combat_damage(), declare_blockers(), inspect_target_hints(), combat_damage(), declare_blockers(), from_decks(), _infer_keywords(), _infer_loyalty() (+28 more)
...
Cohesion: 0.12
Nodes (30): enrich_divide_total(), validate_cast_choice(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), test_non_divide_x_spell_does_not_auto_set_divide_total(), _state_with_target(), test_bounce_ability_spec_is_not_marked_as_oracle_fallback() (+22 more)

### Community 24 - "Community 24"
Cohesion: 0.15
Nodes (33): _all_battlefield_ids(), _continuous_pt_delta(), _counter_pt_delta(), effective_keywords(), effective_toughness(), _has_subtype(), _is_battlefield(), _iter_keyword_grants() (+25 more)

### Community 25 - "Community 25"
Cohesion: 0.1
Nodes (32): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+24 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (33): Backend tests, code:bash (cd frontend), Frontend, Frontend, Frontend, Frontend, Frontend, Frontend (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.14
Nodes (29): deal_damage(), resolve_effect(), test_noncombat_damage_replacement_does_not_apply_to_controller_creature(), test_noncombat_damage_replacement_puts_minus_counters_on_opposing_creature(), Bug #8: resolve_effect should gracefully handle non-dict payloads., Bug #8: resolve_effect should gracefully handle non-dict payloads., test_resolve_effect_rejects_non_dict_payload(), test_topdeck_creature_deploy_effect_puts_eligible_creatures_onto_battlefield() (+21 more)
...
Cohesion: 0.06
Nodes (31): Backend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+23 more)

### Community 30 - "Community 30"
Cohesion: 0.17
Nodes (23): lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick(), MatchController, _ensure_card_cache_columns(), _ensure_card_faces_column() (+15 more)

### Community 31 - "Community 31"
Cohesion: 0.11
Nodes (27): _move_creature_to_graveyard(), sacrifice(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+19 more)
...
Cohesion: 0.13
Nodes (10): AIDecision, _card_looks_like_land(), AIDecision, _card_looks_like_land(), _cmc(), _auto_bottom_cards(), mana_value(), parse_mana_cost() (+2 more)
...
Cohesion: 0.12
Nodes (18): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback(), test_planeswalker_static_and_loyalty_text_is_not_cast_time_fallback(), _state() (+10 more)

### Community 37 - "Community 37"
Cohesion: 0.15
Nodes (20): destroy_all_creatures(), exile_permanent(), resolve_top_of_stack(), add_to_stack(), StackItem, _state_with_cycler(), test_cycling_discard_cost_emits_discard_trigger_before_cycle_draw(), test_cycling_draw_uses_draw_replacement_effects() (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.25
Nodes (22): effective_power(), effective_power(), effective_toughness(), _setup_creature(), test_counters_affect_effective_stats_dynamically(), test_other_creatures_you_control_get_bonus_excludes_source(), test_tribal_static_buff_applies_to_subtype(), +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin (+14 more)
...
Cohesion: 0.13
Nodes (19): _remove_dead_creatures(), emit_event(), resolve_top_of_stack(), _put_static_permanent_with_oracle(), test_sheoldred_opponent_draw_trigger_loses_life(), test_sheoldred_you_draw_trigger_gains_life_not_draw(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event() (+11 more)
...
Cohesion: 0.18
Nodes (17): declare_attackers(), test_defender_creature_cannot_attack(), test_vigilance_attacker_does_not_tap(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), test_must_block_if_able_auto_assignment() (+9 more)
...
Cohesion: 0.16
Nodes (14): apply_state_based_actions(), apply_state_based_actions(), _setup_permanent(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_indestructible_grant_prevents_combat_lethal_death(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard() (+6 more)
...
Cohesion: 0.16
Nodes (14): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers. (+6 more)
...
Cohesion: 0.29
Nodes (7): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability.
...
Cohesion: 0.5
Nodes (3): test_creature_death_trigger_deals_its_power_as_damage(), test_enter_trigger_casts_target_instant_from_graveyard(), test_hydroid_krasis_self_cast_trigger_resolves_before_x_creature_enters()
...
## Knowledge Gaps
- **443 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+438 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 5`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 21`, `Community 28`, `Community 30`, `Community 33`, `Community 35`, `Community 37`, `Community 39`, `Community 41`, `Community 42`, `Community 47`, `Community 50`, `Community 55`, `Community 64`, `Community 67`, `Community 80`, `Community 81`, `Community 85`, `Community 107`, `Community 108`, `Community 112`, `Community 120`, `Community 126`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 5` to `Community 0`, `Community 1`, `Community 3`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 27`, `Community 30`, `Community 33`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 48`, `Community 49`, `Community 50`, `Community 55`, `Community 64`, `Community 71`, `Community 75`, `Community 81`, `Community 86`, `Community 92`, `Community 108`, `Community 112`, `Community 115`, `Community 120`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 7` to `Community 0`, `Community 5`, `Community 11`, `Community 14`, `Community 15`, `Community 20`, `Community 23`, `Community 25`, `Community 27`, `Community 31`, `Community 36`, `Community 37`, `Community 44`, `Community 49`, `Community 50`, `Community 52`, `Community 61`, `Community 76`, `Community 79`, `Community 86`, `Community 94`, `Community 99`, `Community 102`, `Community 111`, `Community 112`, `Community 115`, `Community 126`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Are the 147 inferred relationships involving `AIAgent` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`AIAgent` has 147 INFERRED edges - model-reasoned connections that need verification._
- **Are the 185 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 185 INFERRED edges - model-reasoned connections that need verification._
