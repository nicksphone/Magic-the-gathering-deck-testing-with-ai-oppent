...
Cohesion: 0.05
Nodes (44): draw_cards(), replace_draw_cards(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active() (+36 more)
...
Cohesion: 0.14
Nodes (45): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), list_cards() (+37 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (53): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), apply_state_based_actions(), apply_state_based_actions() (+45 more)
...
Cohesion: 0.06
Nodes (40): card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match_replay(), _is_full_ai_match() (+32 more)

### Community 12 - "Community 12"
Cohesion: 0.11
Nodes (49): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+41 more)
...
Cohesion: 0.08
Nodes (26): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), resolve_top_of_stack(), test_cannot_target_creature_with_protection_from_source_color() (+18 more)
...
Cohesion: 0.07
Nodes (20): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response. (+12 more)
...
Cohesion: 0.21
Nodes (21): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), MatchController, start_match(), _start_next_game_state() (+13 more)

### Community 38 - "Community 38"
Cohesion: 0.16
Nodes (21): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance (+13 more)
...
Cohesion: 0.16
Nodes (12): attach_if_legal(), card_color_names(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), protection_match_reason(), _protection_tokens() (+4 more)

### Community 53 - "Community 53"
Cohesion: 0.18
Nodes (14): emit_event(), _order_apnap(), destroy_permanent(), gain_life(), sacrifice(), topdeck_put_creatures_battlefield(), replace_gain_life(), _put_static_permanent_with_oracle() (+6 more)
...
Cohesion: 0.2
Nodes (11): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, StackItem, add_to_stack() (+3 more)
...
Cohesion: 0.33
Nodes (8): prevent_damage(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield(), consume_card_prevention_shield(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage(), test_prevent_damage_shield_reduces_player_damage()
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 18`, `Community 23`, `Community 24`, `Community 27`, `Community 31`, `Community 37`, `Community 39`, `Community 40`, `Community 45`, `Community 51`, `Community 73`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 6` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 21`, `Community 22`, `Community 23`, `Community 29`, `Community 31`, `Community 33`, `Community 37`, `Community 39`, `Community 46`, `Community 47`, `Community 49`, `Community 51`, `Community 67`, `Community 68`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 12` to `Community 0`, `Community 34`, `Community 6`, `Community 38`, `Community 9`, `Community 43`, `Community 44`, `Community 77`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 61`, `Community 21`, `Community 58`, `Community 29`, `Community 31`?**
