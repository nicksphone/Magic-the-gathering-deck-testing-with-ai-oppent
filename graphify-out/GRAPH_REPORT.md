...
## Corpus Check
- 133 files · ~366,905 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1474 nodes · 4145 edges · 83 communities (75 shown, 8 thin omitted)
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 2041 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `335391f4`
...
Cohesion: 0.05
Nodes (91): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _infer_mana_from_land(), _is_land_card(), CardInstance, PlayerState, _extract_keywords_from_text() (+83 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (72): card_color_names(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), declare_attackers() (+64 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (45): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid() (+37 more)
...
Cohesion: 0.07
Nodes (35): analyze_deck(), guess_archetype(), classify(), main(), analyze_deck_payload(), fallback_card_payload(), compact_action(), hand_snapshot() (+27 more)
...
Cohesion: 0.15
Nodes (43): combat_damage(), declare_blockers(), from_decks(), MatchState, combat_damage(), declare_blockers(), from_decks(), MatchState (+35 more)
...
Cohesion: 0.22
Nodes (20): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), MatchController, start_match(), _start_next_game_state() (+12 more)
...
Cohesion: 0.17
Nodes (19): destroy_permanent(), sacrifice(), _collect_triggers(), _first_number(), _maybe_payload(), _trigger_from_oracle(), _collect_triggers(), emit_event() (+11 more)
...
Cohesion: 0.2
Nodes (16): emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice(), topdeck_put_creatures_battlefield(), add_to_stack(), resolve_top_of_stack() (+8 more)
...
Cohesion: 0.14
Nodes (14): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone, _infer_keywords() (+6 more)
...
Cohesion: 0.17
Nodes (12): gain_life(), lose_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), damage_cant_be_prevented(), player_cant_gain_life(), player_cant_lose_life() (+4 more)
...
Cohesion: 0.31
Nodes (9): _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), _state(), test_controller_scoped_damage_cant_be_prevented_ignores_shield(), test_global_damage_cant_be_prevented_ignores_player_shield(), test_optional_stack_effect_can_be_declined() (+1 more)
...
- **Why does `AIAgent` connect `Community 6` to `Community 32`, `Community 2`, `Community 35`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 43`, `Community 15`, `Community 18`, `Community 19`, `Community 50`, `Community 23`, `Community 24`, `Community 31`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 29`, `Community 31`, `Community 32`, `Community 35`, `Community 43`, `Community 44`, `Community 45`, `Community 50`, `Community 55`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 10` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `Community 43`, `Community 44`, `Community 50`, `Community 19`, `Community 51`, `Community 20`, `Community 55`, `Community 26`, `Community 29`?**
