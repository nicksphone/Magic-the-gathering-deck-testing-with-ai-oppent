...
## Corpus Check
- 170 files · ~434,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2316 nodes · 6053 edges · 107 communities (105 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2726 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2955a48`
...
Cohesion: 0.05
Nodes (41): _hydrate_deck_cards(), sync_card(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), get_with_backoff() (+33 more)
...
Cohesion: 0.08
Nodes (58): _auto_bottom_cards(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+50 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (56): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+48 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (47): analyze_deck(), _card_text_matches(), _cmc(), _derive_face_based_mana_cost(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _summarize_card_metadata() (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (47): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_expansion_top_decks(), _force_ai_land_action() (+39 more)
...
Cohesion: 0.06
Nodes (39): draw_cards(), replace_draw_cards(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active() (+31 more)
...
Cohesion: 0.13
Nodes (49): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), from_decks(), _setup_creature() (+41 more)
...
Cohesion: 0.11
Nodes (47): CardInstance, infer_effect_from_oracle(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing(), test_oracle_multiclause_sequence_parsing(), test_oracle_prevent_next_damage_parsing() (+39 more)
...
Cohesion: 0.08
Nodes (26): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), start_match(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color() (+18 more)
...
Cohesion: 0.1
Nodes (35): attach_if_legal(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label() (+27 more)
...
Cohesion: 0.11
Nodes (24): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback() (+16 more)
...
Cohesion: 0.1
Nodes (14): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., evaluate_board(), evaluate_board(), test_ai_combat_uses_granted_keywords_from_static_effects() (+6 more)
...
Cohesion: 0.12
Nodes (26): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), infer_effect_from_oracle(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses() (+18 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (24): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.13
Nodes (14): import_deck(), ai_diagnostics(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file() (+6 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (13): _ensure_builtin_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck_file(), import_expansion_top_deck(), list_expansion_top_decks(), sync_cards_bulk(), ensure_builtin_decks() (+5 more)

### Community 35 - "Community 35"
Cohesion: 0.17
Nodes (24): deal_damage(), resolve_effect(), Bug #8: resolve_effect should gracefully handle non-dict payloads., Bug #8: resolve_effect should gracefully handle non-dict payloads., test_resolve_effect_rejects_non_dict_payload(), test_topdeck_creature_deploy_effect_puts_eligible_creatures_onto_battlefield(), _state(), test_combat_damage_ignores_prevention_when_source_says_cant_be_prevented() (+16 more)
...
Cohesion: 0.17
Nodes (21): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast() (+13 more)

### Community 38 - "Community 38"
Cohesion: 0.23
Nodes (20): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), MatchController, _start_next_game_state(), init_db() (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (16): apply_state_based_actions(), resolve_top_of_stack(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard() (+8 more)
...
Cohesion: 0.13
Nodes (6): get_repo(), analytics_history(), get_repo(), sync_card(), Repository, ScryfallSyncService

### Community 45 - "Community 45"
Cohesion: 0.17
Nodes (18): _count_controlled_type(), gain_life(), lose_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), damage_cant_be_prevented() (+10 more)

### Community 46 - "Community 46"
Cohesion: 0.17
Nodes (17): exile_permanent(), resolve_top_of_stack(), add_to_stack(), StackItem, _state_with_cycler(), test_cycling_discard_cost_emits_discard_trigger_before_cycle_draw(), test_cycling_draw_uses_draw_replacement_effects(), test_cycling_pays_cost_discards_then_draws_on_resolution() (+9 more)
...
Cohesion: 0.18
Nodes (16): get_match(), _serialize_match_controller(), deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), serialize_match() (+8 more)
...
Cohesion: 0.22
Nodes (15): attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura(), is_equipment() (+7 more)
...
Cohesion: 0.23
Nodes (10): prevent_damage(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield(), consume_card_prevention_shield(), test_ai_prefers_attack_on_open_board(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_deal_damage_to_creature_marks_damage_not_toughness() (+2 more)
...
Cohesion: 0.24
Nodes (10): emit_event(), _order_apnap(), destroy_permanent(), gain_life(), sacrifice(), topdeck_put_creatures_battlefield(), replace_gain_life(), _put_static_permanent_with_oracle() (+2 more)
...
Cohesion: 0.29
Nodes (4): Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat.
...
Cohesion: 0.4
Nodes (5): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., transform_if_top_matches()

### Community 82 - "Community 82"
Cohesion: 0.4
Nodes (5): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., transform_card()
...
Cohesion: 0.5
Nodes (4): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback.
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 32`, `Community 38`, `Community 40`, `Community 41`, `Community 44`, `Community 46`, `Community 48`, `Community 58`, `Community 74`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 9` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 26`, `Community 29`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 46`, `Community 49`, `Community 50`, `Community 52`, `Community 58`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 13` to `Community 0`, `Community 9`, `Community 11`, `Community 17`, `Community 19`, `Community 26`, `Community 29`, `Community 35`, `Community 37`, `Community 45`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 53`, `Community 61`, `Community 63`, `Community 79`, `Community 80`?**
...
- **Are the 148 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 148 INFERRED edges - model-reasoned connections that need verification._