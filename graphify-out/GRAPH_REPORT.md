...
## Corpus Check
- 174 files · ~437,416 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2385 nodes · 6175 edges · 126 communities (125 shown, 1 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2768 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b51deb2a`
...
Cohesion: 0.05
Nodes (56): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action() (+48 more)
...
Cohesion: 0.05
Nodes (35): _get_attr_or_key(), select_display_image_uri(), get_with_backoff(), ensure_placeholder_image(), _family(), _slug(), _svg_for(), fuzzy_card_lookup() (+27 more)
...
Cohesion: 0.04
Nodes (28): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments(), destroy_all_enchantments() (+20 more)
...
Cohesion: 0.16
Nodes (42): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), apply_state_based_actions(), apply_state_based_actions(), from_decks() (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (41): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage. (+33 more)
...
Cohesion: 0.1
Nodes (16): card_completeness(), list_cards(), Report cached metadata and asset gaps for a deck's distinct card names., suggest_card(), sync_card(), CardService, ScryfallSyncService, _BlankCachedCard (+8 more)
...
Cohesion: 0.21
Nodes (25): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature(), test_counters_affect_effective_stats_dynamically() (+17 more)
...
Cohesion: 0.14
Nodes (21): attach_if_legal(), attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura() (+13 more)
...
Cohesion: 0.12
Nodes (22): destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts() (+14 more)
...
Cohesion: 0.19
Nodes (19): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast() (+11 more)

### Community 41 - "Community 41"
Cohesion: 0.22
Nodes (15): init_db(), autoplay_tick(), _start_next_game_state(), _ensure_card_cache_columns(), _ensure_card_faces_column(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match() (+7 more)
...
Cohesion: 0.2
Nodes (16): destroy_all_creatures(), exile_permanent(), resolve_top_of_stack(), _state_with_cycler(), test_cycling_discard_cost_emits_discard_trigger_before_cycle_draw(), test_cycling_draw_uses_draw_replacement_effects(), test_cycling_pays_cost_discards_then_draws_on_resolution(), test_cycling_trigger_is_matched_by_card_name_and_put_above_ability() (+8 more)
...
Cohesion: 0.2
Nodes (11): card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers(), _defender_label(), can_cast_in_current_timing(), card_cant_attack(), card_cant_attack_alone() (+3 more)
...
Cohesion: 0.22
Nodes (9): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The (+1 more)

### Community 82 - "Community 82"
Cohesion: 0.22
Nodes (9): put_land_from_hand(), Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is (+1 more)
...
Cohesion: 0.25
Nodes (8): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., transform_if_top_matches()

### Community 85 - "Community 85"
Cohesion: 0.25
Nodes (8): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., transform_card()
...
Cohesion: 0.29
Nodes (7): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback.
...
## Knowledge Gaps
- **356 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+351 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 15`, `Community 22`, `Community 23`, `Community 25`, `Community 30`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 41`, `Community 45`, `Community 46`, `Community 47`, `Community 50`, `Community 53`, `Community 62`, `Community 72`, `Community 97`, `Community 104`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 11` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 35`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 49`, `Community 51`, `Community 53`, `Community 72`, `Community 86`, `Community 87`, `Community 96`, `Community 97`, `Community 104`, `Community 105`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 9` to `Community 0`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 40`, `Community 42`, `Community 45`, `Community 51`, `Community 52`, `Community 69`, `Community 73`, `Community 104`, `Community 105`?**
...
- **Are the 158 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 158 INFERRED edges - model-reasoned connections that need verification._
