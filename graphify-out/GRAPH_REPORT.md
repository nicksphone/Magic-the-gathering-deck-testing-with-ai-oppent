...
## Corpus Check
- 174 files · ~437,995 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2400 nodes · 6209 edges · 128 communities (126 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2780 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d018286`
...
Cohesion: 0.06
Nodes (77): _all_battlefield_ids(), _continuous_pt_delta(), _counter_pt_delta(), effective_keywords(), effective_power(), effective_toughness(), _has_subtype(), _is_battlefield() (+69 more)
...
Cohesion: 0.05
Nodes (52): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_builtin_decks(), _ensure_expansion_top_decks() (+44 more)
...
Cohesion: 0.08
Nodes (28): AIAgent, AIDecision, _card_looks_like_land(), _step_key(), AIDecision, MatchState, test_aggro_ai_prefers_creature_development_over_burn_early(), test_ai_avoids_mana_tap_loop_when_no_cast_available() (+20 more)
...
Cohesion: 0.08
Nodes (35): legal_moves(), RulesEngine, test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_ability_oracle_marks_land_playable_when_type_metadata_missing() (+27 more)
...
Cohesion: 0.11
Nodes (43): combat_damage(), from_decks(), resolve_effect(), combat_damage(), apply_state_based_actions(), apply_state_based_actions(), from_decks(), test_anthem_effect_allows_creature_to_survive_marked_damage() (+35 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (45): resolve_effect(), infer_effect_from_oracle(), infer_effect_from_oracle(), CardInstance, test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing() (+37 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (24): RulesEngine, draw_cards(), compute_max_land_plays_this_turn(), extract_loyalty_abilities(), replace_draw_cards(), draw_card(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana() (+16 more)
...
Cohesion: 0.09
Nodes (27): crew_vehicle(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), _has_any_target_options(), _is_land_card(), pass_priority(), can_cast_in_current_timing() (+19 more)
...
Cohesion: 0.12
Nodes (31): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+23 more)
...
Cohesion: 0.14
Nodes (28): build_cast_hints(), enrich_divide_total(), CardInstance, inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed() (+20 more)
...
Cohesion: 0.12
Nodes (21): emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), add_to_stack(), resolve_top_of_stack(), StackItem, _put_static_permanent_with_oracle() (+13 more)

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (23): apply_additional_costs(), check_cost_option_available(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice() (+15 more)

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (5): _card_looks_like_land(), topdeck_put_creatures_battlefield(), parse_mana_cost(), mana_value(), parse_mana_cost()
...
Cohesion: 0.13
Nodes (16): prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield() (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (22): destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), gain_life(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts() (+14 more)

### Community 40 - "Community 40"
Cohesion: 0.1
Nodes (20): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone, _infer_keywords() (+12 more)
...
Cohesion: 0.14
Nodes (15): MatchState, AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback(), test_planeswalker_static_and_loyalty_text_is_not_cast_time_fallback() (+7 more)

### Community 45 - "Community 45"
Cohesion: 0.17
Nodes (18): validate_cast_choice(), PlayerState, validate_cast_targets(), validate_hexproof_shroud_targets(), validate_protection_targets(), validate_cast_targets(), validate_protection_targets(), test_choose_two_validator() (+10 more)
...
Cohesion: 0.13
Nodes (18): declare_attackers(), _defender_label(), _valid_defenders(), card_cant_attack(), card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers() (+10 more)
...
Cohesion: 0.18
Nodes (12): _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), hydrate_deck(), fallback_card_payload(), test_control_ramp_fallback_catalog_contains_core_fields() (+4 more)

### Community 53 - "Community 53"
Cohesion: 0.24
Nodes (14): build_cast_hints(), validate_cast_choice(), _state_with_target(), test_bounce_ability_spec_is_not_marked_as_oracle_fallback(), test_bounce_inference_exposes_nonland_permanent_targets(), test_bounce_rejects_card_outside_current_target_candidates(), test_bounce_returns_stolen_permanent_to_owner_hand_and_clears_control(), test_validate_cast_choice_rejects_out_of_range_face_index() (+6 more)
...
Cohesion: 0.21
Nodes (10): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., _apply_legend_rule(), _apply_saga_state_actions(), _is_legendary(), _saga_chapter_numbers() (+2 more)
...
Cohesion: 0.2
Nodes (10): cycle_search(), _place_searched_card(), Resolve an alternate-cycling search and shuffle the remaining library., search_library(), Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter. (+2 more)
...
Cohesion: 0.33
Nodes (8): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), test_spell_cast_count_and_day_night_state_survive_snapshot_restore(), test_match_snapshot_round_trip_preserves_rng_sequence(), test_match_snapshot_round_trip_preserves_rules_state()
...
Cohesion: 0.6
Nodes (5): _state(), test_day_night_change_triggers_use_the_stack(), test_day_night_starts_at_upkeep_after_no_spells(), test_day_night_transforms_matching_double_faced_permanents(), test_day_night_transitions_only_on_zero_or_two_spells()
...
## Knowledge Gaps
- **364 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+359 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 20`, `Community 22`, `Community 23`, `Community 30`, `Community 33`, `Community 36`, `Community 40`, `Community 41`, `Community 43`, `Community 44`, `Community 50`, `Community 51`, `Community 61`, `Community 66`, `Community 75`, `Community 78`, `Community 85`, `Community 105`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 8` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 34`, `Community 40`, `Community 41`, `Community 44`, `Community 50`, `Community 51`, `Community 58`, `Community 61`, `Community 65`, `Community 75`, `Community 77`, `Community 85`, `Community 94`, `Community 95`, `Community 96`, `Community 105`, `Community 108`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 27` to `Community 0`, `Community 1`, `Community 8`, `Community 11`, `Community 12`, `Community 18`, `Community 31`, `Community 39`, `Community 40`, `Community 44`, `Community 45`, `Community 49`, `Community 53`, `Community 61`, `Community 68`, `Community 77`, `Community 93`, `Community 94`, `Community 96`, `Community 100`, `Community 105`, `Community 108`?**
...
- **Are the 159 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 159 INFERRED edges - model-reasoned connections that need verification._
