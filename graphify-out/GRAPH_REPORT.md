...
## Corpus Check
- 172 files · ~435,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2350 nodes · 6117 edges · 116 communities (112 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2748 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce96ae91`
...
1. `AIAgent` - 239 edges
2. `CardInstance` - 155 edges
3. `RulesEngine` - 155 edges
...
Cohesion: 0.07
Nodes (63): _auto_bottom_cards(), topdeck_put_creatures_battlefield(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost() (+55 more)
...
Cohesion: 0.05
Nodes (46): draw_cards(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active() (+38 more)
...
Cohesion: 0.06
Nodes (52): ai_diagnostics(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_builtin_decks() (+44 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (57): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), apply_state_based_actions(), from_decks() (+49 more)
...
Cohesion: 0.05
Nodes (27): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_search(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+19 more)
...
Cohesion: 0.13
Nodes (43): resolve_effect(), CardInstance, infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_arboreal_grazer_style_land_from_hand_enters_tapped_without_land_play(), test_copy_ability_handler_replays_target_ability(), test_copy_spell_handler_replays_target_effect(), test_counter_ability_handler_removes_stack_item() (+35 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (18): fuzzy_card_lookup(), normalize_card_lookup_name(), ensure_builtin_decks(), DeckParser, ParsedDeck, DeckParser, ParsedDeck, FakeRepo (+10 more)
...
Cohesion: 0.1
Nodes (36): attach_if_legal(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label() (+28 more)
...
Cohesion: 0.06
Nodes (28): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+20 more)
...
Cohesion: 0.11
Nodes (13): RulesEngine, test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life(), test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn() (+5 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (28): build_cast_hints(), enrich_divide_total(), _extract_modes(), infer_effect_from_oracle(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance (+20 more)
...
Cohesion: 0.12
Nodes (18): check_cost_option_available(), load_named_deck(), main(), guess_archetype(), compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), run() (+10 more)
...
Cohesion: 0.13
Nodes (16): _hydrate_deck_cards(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), hydrate_deck(), fallback_card_payload() (+8 more)
...
Cohesion: 0.17
Nodes (20): attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura(), is_equipment() (+12 more)
...
Cohesion: 0.15
Nodes (14): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback() (+6 more)
...
Cohesion: 0.16
Nodes (17): compact_action(), hand_snapshot(), now_utc(), battlefield_snapshot(), _cluster_labels(), compact_action(), hand_snapshot(), now_utc() (+9 more)
...
Cohesion: 0.25
Nodes (12): build_cast_hints(), validate_cast_choice(), _state_with_target(), test_bounce_ability_spec_is_not_marked_as_oracle_fallback(), test_bounce_inference_exposes_nonland_permanent_targets(), test_bounce_returns_stolen_permanent_to_owner_hand_and_clears_control(), _state_with_searcher(), test_cultivate_inference_searches_up_to_two_basic_lands_to_hand() (+4 more)
...
## Knowledge Gaps
- **335 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+330 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `Community 21`, `Community 22`, `Community 23`, `Community 28`, `Community 31`, `Community 36`, `Community 41`, `Community 43`, `Community 47`, `Community 49`, `Community 51`, `Community 57`, `Community 60`, `Community 69`, `Community 76`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `Community 17`, `Community 20`, `Community 21`, `Community 26`, `Community 29`, `Community 31`, `Community 36`, `Community 45`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 60`, `Community 75`, `Community 76`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 15` to `Community 0`, `Community 65`, `Community 34`, `Community 3`, `Community 36`, `Community 37`, `Community 6`, `Community 40`, `Community 42`, `Community 45`, `Community 46`, `Community 17`, `Community 51`, `Community 53`, `Community 55`, `Community 88`, `Community 27`, `Community 62`?**
...
- **Are the 153 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 153 INFERRED edges - model-reasoned connections that need verification._
- **Are the 140 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 140 INFERRED edges - model-reasoned connections that need verification._