...
## Corpus Check
- 143 files · ~375,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1718 nodes · 4615 edges · 90 communities (88 shown, 2 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2150 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48956cba`
...
Cohesion: 0.05
Nodes (95): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature() (+87 more)
...
Cohesion: 0.06
Nodes (39): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _classify_divergence_category(), classify_first_divergence() (+31 more)
...
Cohesion: 0.06
Nodes (53): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature. (+45 more)
...
Cohesion: 0.06
Nodes (28): draw_card(), RulesEngine, extract_loyalty_abilities(), draw_card(), test_discard_additional_cost_is_paid(), test_engine_upkeep_start_enqueues_begin_step_triggers(), test_cast_spell_rejects_if_cost_unpaid(), test_mana_pool_empties_on_step_transition() (+20 more)

### Community 9 - "Community 9"
Cohesion: 0.18
Nodes (37): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), list_cards() (+29 more)
...
Cohesion: 0.11
Nodes (34): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _max_attackers_blockable_by_creature() (+26 more)
...
Cohesion: 0.11
Nodes (10): AIDecision, AIDecision, _card_looks_like_land(), _auto_bottom_cards(), topdeck_put_creatures_battlefield(), parse_mana_cost(), _auto_bottom_cards(), parse_mana_cost() (+2 more)

### Community 24 - "Community 24"
Cohesion: 0.14
Nodes (21): fallback_card_payload(), compact_action(), hand_snapshot(), hydrate_deck(), load_named_deck(), main(), now_utc(), parse_args() (+13 more)

### Community 25 - "Community 25"
Cohesion: 0.15
Nodes (19): check_cost_option_available(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_attack_is_declared_once_per_combat_step() (+11 more)
...
Cohesion: 0.23
Nodes (22): _base_pt_with_layers(), effective_power(), effective_toughness(), apply_state_based_actions(), _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically(), test_creatures_you_control_have_reach_allows_blocking_flyers() (+14 more)
...
Cohesion: 0.15
Nodes (17): classify(), main(), compact_action(), hand_snapshot(), now_utc(), parse_args(), run(), classify() (+9 more)
...
Cohesion: 0.24
Nodes (18): _all_battlefield_ids(), continuous_layer_trace(), _continuous_pt_delta(), effective_keywords(), _is_battlefield(), _iter_keyword_grants(), _iter_keyword_removals(), _iter_pt_modifiers() (+10 more)
...
Cohesion: 0.16
Nodes (17): _mark_creature_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), deal_damage(), deal_damage_multi() (+9 more)

### Community 38 - "Community 38"
Cohesion: 0.24
Nodes (17): _all_battlefield_ids(), _continuous_pt_delta(), _counter_pt_delta(), effective_keywords(), effective_power(), effective_toughness(), _has_subtype(), _is_battlefield() (+9 more)
...
- **Why does `AIAgent` connect `Community 1` to `Community 32`, `Community 2`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 45`, `Community 46`, `Community 13`, `Community 17`, `Community 19`, `Community 22`, `Community 23`, `Community 24`, `Community 57`, `Community 28`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 13`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 40`, `Community 44`, `Community 45`, `Community 46`, `Community 63`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 13` to `Community 0`, `Community 3`, `Community 4`, `Community 8`, `Community 10`, `Community 15`, `Community 18`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 33`, `Community 37`, `Community 39`, `Community 40`, `Community 44`, `Community 63`, `Community 72`?**
...
- **Are the 102 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 102 INFERRED edges - model-reasoned connections that need verification._