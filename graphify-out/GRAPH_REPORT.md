...
## Corpus Check
- 170 files · ~433,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2304 nodes · 6030 edges · 110 communities (107 shown, 3 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2717 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b21e8f3`
...
Cohesion: 0.05
Nodes (80): AIAgent, test_ai_materializes_required_library_search_choice(), test_master_block_search_prevents_lethal_damage_when_trade_is_available(), test_aggro_ai_avoids_suicide_attack_into_larger_blocker(), test_aggro_ai_mulligans_hand_without_early_pressure(), test_aggro_ai_prefers_creature_development_over_burn_early(), test_aggro_cast_bias_values_stronger_modal_face_higher(), test_aggro_modal_face_prefers_creature_face_when_board_is_empty() (+72 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (61): _board_role_hint(), build_priors_from_examples(), build_priors_from_logs(), _build_priors_payload(), _count_creatures(), _record_card_timing(), save_log_priors(), _sum_power() (+53 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (63): topdeck_put_creatures_battlefield(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+55 more)
...
Cohesion: 0.05
Nodes (57): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card() (+49 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (44): draw_cards(), legal_moves(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn() (+36 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (47): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+39 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (49): attach_if_legal(), attached_to(), is_aura(), is_equipment(), cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The (+41 more)
...
Cohesion: 0.08
Nodes (48): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), exile_permanent(), sacrifice(), emit_event(), _put_trigger_creature() (+40 more)
...
Cohesion: 0.08
Nodes (25): build_cast_hints(), check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana() (+17 more)
...
Cohesion: 0.12
Nodes (31): _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), infer_effect_from_oracle(), inspect_target_hints(), CardInstance (+23 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (18): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response. (+10 more)
...
Cohesion: 0.11
Nodes (26): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), PlayerState, validate_cast_targets(), validate_hexproof_shroud_targets() (+18 more)
...
Cohesion: 0.18
Nodes (28): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature() (+20 more)
...
Cohesion: 0.12
Nodes (8): get_repo(), analytics_history(), apply_sideboard(), get_repo(), _hydrate_deck_cards(), sync_card(), Repository, ScryfallSyncService
...
Cohesion: 0.14
Nodes (21): enrich_divide_total(), validate_cast_choice(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints(), test_non_divide_x_spell_does_not_auto_set_divide_total() (+13 more)

### Community 38 - "Community 38"
Cohesion: 0.13
Nodes (21): collect_cost_options(), CostOption, resolve_effect(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill. (+13 more)
...
Cohesion: 0.13
Nodes (22): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _choose_any_permanent_target() (+14 more)

### Community 41 - "Community 41"
Cohesion: 0.21
Nodes (19): autoplay_tick(), _human_priority_pause(), init_db(), autoplay_tick(), _human_priority_pause(), _start_next_game_state(), init_db(), main() (+11 more)
...
Cohesion: 0.27
Nodes (11): gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), damage_cant_be_prevented() (+3 more)
...
Cohesion: 0.29
Nodes (6): _balance_alerts(), _batch_seed(), compare_replay_logs(), _extract_turn_summaries(), _first_divergence_excerpt(), _wilson_interval()
...
Cohesion: 0.24
Nodes (8): card_color_names(), protected_from_source(), protection_match_reason(), _protection_tokens(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), protection_match_reason(), _protection_tokens()
...
Cohesion: 0.24
Nodes (10): prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield() (+2 more)
...
Cohesion: 0.25
Nodes (9): apply_state_based_actions(), apply_state_based_actions(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_state_based_action_lethal_creature_emits_permanent_and_creature_death_triggers() (+1 more)
...
Cohesion: 0.2
Nodes (10): cycle_search(), _place_searched_card(), put_green_creature_from_hand(), Resolve an alternate-cycling search and shuffle the remaining library., return_creature_from_graveyard_to_battlefield(), return_permanent_from_graveyard_to_battlefield(), search_library(), topdeck_put_creatures_battlefield() (+2 more)
...
Cohesion: 0.38
Nodes (3): guess_archetype(), start_match(), run()
...
Cohesion: 0.4
Nodes (3): test_attack_is_declared_once_per_combat_step(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage()
...
- **Why does `AIAgent` connect `Community 0` to `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 24`, `Community 26`, `Community 28`, `Community 34`, `Community 39`, `Community 41`, `Community 42`, `Community 44`, `Community 57`, `Community 64`, `Community 65`, `Community 71`, `Community 76`, `Community 83`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 7` to `Community 0`, `Community 2`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 21`, `Community 23`, `Community 26`, `Community 27`, `Community 30`, `Community 32`, `Community 38`, `Community 39`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 65`, `Community 70`, `Community 71`, `Community 76`, `Community 80`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 17` to `Community 32`, `Community 0`, `Community 37`, `Community 7`, `Community 72`, `Community 9`, `Community 11`, `Community 46`, `Community 15`, `Community 16`, `Community 81`, `Community 23`, `Community 58`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Are the 142 inferred relationships involving `AIAgent` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`AIAgent` has 142 INFERRED edges - model-reasoned connections that need verification._
