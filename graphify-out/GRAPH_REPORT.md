...
## Corpus Check
- 176 files · ~443,152 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2496 nodes · 6411 edges · 130 communities (127 shown, 3 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2846 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5db0eca2`
...
## Communities (130 total, 3 thin omitted)
...
Cohesion: 0.07
Nodes (33): build_cast_hints(), check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card() (+25 more)
...
Cohesion: 0.09
Nodes (43): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), sacrifice(), StackItem, emit_event(), add_to_stack() (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (43): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage() (+35 more)
...
Cohesion: 0.09
Nodes (41): deal_damage(), resolve_effect(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill. (+33 more)
...
Cohesion: 0.14
Nodes (29): autoplay_tick(), _human_priority_pause(), lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick(), _human_priority_pause() (+21 more)
...
Cohesion: 0.18
Nodes (29): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature(), _setup_permanent() (+21 more)
...
Cohesion: 0.12
Nodes (28): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+20 more)
...
Cohesion: 0.1
Nodes (23): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., _apply_legend_rule() (+15 more)
...
Cohesion: 0.11
Nodes (20): draw_cards(), resolve_effect(), replace_draw_cards(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage., test_create_token_respects_amount_and_keywords() (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (21): _move_creature_to_graveyard(), gain_life(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), _choose_replacement_candidate() (+13 more)
...
Cohesion: 0.15
Nodes (20): enrich_divide_total(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text() (+12 more)
...
Cohesion: 0.13
Nodes (18): crew_vehicle(), _has_any_target_options(), _is_land_card(), cycling_cost(), cycling_is_variable(), cycling_variant(), Return a cycling cost, optionally including a validated X/Y symbol., Return a cycling cost, optionally including a validated X/Y symbol. (+10 more)
...
Cohesion: 0.16
Nodes (17): emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), topdeck_put_creatures_battlefield(), add_to_stack(), resolve_top_of_stack(), StackItem (+9 more)
...
Cohesion: 0.22
Nodes (16): attach_if_legal(), attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura() (+8 more)
...
Cohesion: 0.36
Nodes (3): Apply a spell-created restriction until the active turn's cleanup., set_turn_restriction(), str
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 7`, `Community 12`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 40`, `Community 42`, `Community 44`, `Community 47`, `Community 51`, `Community 55`, `Community 57`, `Community 68`, `Community 82`, `Community 88`, `Community 107`, `Community 110`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 12`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 23`, `Community 27`, `Community 32`, `Community 35`, `Community 36`, `Community 42`, `Community 44`, `Community 47`, `Community 49`, `Community 51`, `Community 54`, `Community 55`, `Community 57`, `Community 64`, `Community 91`, `Community 107`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 8` to `Community 0`, `Community 4`, `Community 13`, `Community 16`, `Community 20`, `Community 29`, `Community 32`, `Community 38`, `Community 41`, `Community 42`, `Community 46`, `Community 49`, `Community 51`, `Community 53`, `Community 54`, `Community 59`, `Community 73`, `Community 76`, `Community 92`, `Community 96`, `Community 101`, `Community 107`, `Community 111`?**
