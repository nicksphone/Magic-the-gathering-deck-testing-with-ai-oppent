...
## Corpus Check
- 163 files · ~422,661 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2191 nodes · 5782 edges · 115 communities (111 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2623 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92a02960`
...
Cohesion: 0.07
Nodes (57): check_cost_option_available(), _auto_bottom_cards(), RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid() (+49 more)
...
Cohesion: 0.08
Nodes (57): apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color() (+49 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (29): AIAgent, AIDecision, _card_looks_like_land(), _step_key(), AIDecision, topdeck_put_creatures_battlefield(), add_generic_to_cost(), parse_mana_cost() (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (55): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), from_decks(), _setup_creature() (+47 more)
...
Cohesion: 0.12
Nodes (47): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+39 more)
...
Cohesion: 0.09
Nodes (43): 3) Frontend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+35 more)
...
Cohesion: 0.11
Nodes (38): create_shark_token(), create_token(), discard_cards(), emit_event(), _order_apnap(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your() (+30 more)
...
Cohesion: 0.17
Nodes (30): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _creature_is_lethally_damaged(), effective_power(), effective_toughness() (+22 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (11): compute_max_land_plays_this_turn(), apply_state_based_actions(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures() (+3 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (25): _infer_mana_from_land(), _is_land_card(), _has_any_target_options(), _is_land_card(), pass_priority(), normalize_cost_choice(), cycling_cost(), cycling_is_variable() (+17 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (27): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), validate_cast_choice() (+19 more)
...
Cohesion: 0.11
Nodes (14): _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), list_expansion_top_decks(), sync_cards_bulk() (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (27): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+19 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (18): _deal_unblocked_damage(), prevent_damage(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield() (+10 more)

### Community 29 - "Community 29"
Cohesion: 0.17
Nodes (23): deal_damage(), resolve_effect(), Bug #8: resolve_effect should gracefully handle non-dict payloads., Bug #8: resolve_effect should gracefully handle non-dict payloads., test_resolve_effect_rejects_non_dict_payload(), test_topdeck_creature_deploy_effect_puts_eligible_creatures_onto_battlefield(), _state(), test_combat_damage_ignores_prevention_when_source_says_cant_be_prevented() (+15 more)
...
Cohesion: 0.16
Nodes (19): gain_life(), lose_life(), draw_cards(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+11 more)
...
Cohesion: 0.13
Nodes (17): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone, CostOption (+9 more)

### Community 41 - "Community 41"
Cohesion: 0.21
Nodes (18): _collect_triggers(), _first_number(), _maybe_payload(), _trigger_from_oracle(), _collect_triggers(), _first_number(), _has_artifact_or_enchantment_type(), _matches_attack_trigger() (+10 more)
...
Cohesion: 0.18
Nodes (17): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _choose_any_permanent_target(), _choose_noncreature_permanent_target() (+9 more)
...
Cohesion: 0.17
Nodes (7): sync_card(), ai_diagnostics(), _hydrate_deck_cards(), start_match(), sync_card(), ScryfallSyncService, test_hydrate_deck_cards_uses_fallback_when_cache_unavailable()
...
Cohesion: 0.18
Nodes (12): ensure_placeholder_image(), _family(), _slug(), _svg_for(), _cache_remote_token_image(), _extract_image_uri(), resolve_token_image_uri(), _search_scryfall_token_image() (+4 more)
...
Cohesion: 0.22
Nodes (15): declare_attackers(), card_cant_attack(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), test_must_block_if_able_auto_assignment(), _setup_creature() (+7 more)
...
Cohesion: 0.22
Nodes (11): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, MatchState, AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain (+3 more)
...
Cohesion: 0.33
Nodes (4): test_sorcery_speed_not_castable_off_main_timing(), test_first_player_skips_first_draw_with_explicit_log(), test_london_mulligan_flow_completes_pregame(), test_players_draw_on_later_turns_with_hand_count_change_log()
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 17`, `Community 19`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 39`, `Community 40`, `Community 48`, `Community 50`, `Community 54`, `Community 61`, `Community 62`, `Community 65`, `Community 66`, `Community 71`, `Community 79`, `Community 86`, `Community 96`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 15`, `Community 16`, `Community 21`, `Community 22`, `Community 23`, `Community 32`, `Community 33`, `Community 34`, `Community 40`, `Community 50`, `Community 52`, `Community 54`, `Community 61`, `Community 65`, `Community 71`, `Community 79`, `Community 86`, `Community 87`, `Community 96`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `Repository` connect `Community 8` to `Community 32`, `Community 33`, `Community 3`, `Community 7`, `Community 71`, `Community 45`, `Community 14`, `Community 50`, `Community 20`, `Community 54`, `Community 88`, `Community 26`, `Community 31`?**
