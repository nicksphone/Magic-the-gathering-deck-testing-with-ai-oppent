...
## Corpus Check
- 177 files · ~443,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2500 nodes · 6414 edges · 131 communities (127 shown, 4 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2846 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `707b3b50`
...
- `gain_life()` --calls--> `player_cant_gain_life()`  [INFERRED]
...
Cohesion: 0.09
Nodes (66): combat_damage(), declare_blockers(), from_decks(), _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types() (+58 more)
...
Cohesion: 0.06
Nodes (52): attach_if_legal(), attached_to(), is_aura(), is_equipment(), card_color_names(), destroy_all_creatures(), exile_permanent(), protection_match_reason() (+44 more)
...
Cohesion: 0.05
Nodes (49): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_expansion_top_decks(), _force_ai_land_action() (+41 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (38): RulesEngine, test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_creature_is_not_misclassified_as_land_from_oracle_text(), test_non_active_player_cannot_get_play_land_legal_move(), test_london_mulligan_flow_completes_pregame() (+30 more)

### Community 9 - "Community 9"
Cohesion: 0.15
Nodes (45): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, list_cards(), MatchController (+37 more)
...
Cohesion: 0.08
Nodes (29): check_cost_option_available(), RulesEngine, draw_cards(), compute_max_land_plays_this_turn(), start_match(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing() (+21 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (47): deal_damage(), resolve_effect(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill. (+39 more)
...
Cohesion: 0.07
Nodes (47): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), declare_attackers(), _defender_label(), _max_attackers_blockable_by_creature() (+39 more)
...
Cohesion: 0.11
Nodes (36): create_shark_token(), create_token(), discard_cards(), emit_event(), _put_trigger_creature(), _put_trigger_permanent(), test_apnap_trigger_order_on_shared_event(), test_artifact_and_enchantment_sacrifice_clauses_trigger_from_sacrificed_permanents() (+28 more)
...
Cohesion: 0.15
Nodes (33): _combat_damage_step(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness() (+25 more)
...
Cohesion: 0.12
Nodes (27): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+19 more)
...
Cohesion: 0.13
Nodes (23): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), enrich_divide_total(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed() (+15 more)
...
Cohesion: 0.14
Nodes (21): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., draw_card(), gain_life() (+13 more)
...
Cohesion: 0.19
Nodes (14): _restore_active_matches(), deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match_snapshot(), _tupleize(), Zone, _state(), test_day_night_change_triggers_use_the_stack() (+6 more)
...
Cohesion: 0.21
Nodes (14): emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice(), add_to_stack(), add_to_stack(), resolve_top_of_stack() (+6 more)
...
Cohesion: 0.13
Nodes (15): cycle_search(), _place_searched_card(), Resolve an alternate-cycling search and shuffle the remaining library., Resolve an alternate-cycling search and shuffle the remaining library., Resolve an alternate-cycling search and shuffle the remaining library., search_library(), Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter. (+7 more)
...
Cohesion: 0.21
Nodes (14): _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_cast_only_during_your_turn_restriction_and_move_hint(), test_must_attack_if_able_auto_added_when_omitted(), test_static_you_cant_cast_spells_during_combat_enforced(), _setup_creature(), test_cant_attack_alone_enforced() (+6 more)
...
Cohesion: 0.22
Nodes (5): ai_diagnostics(), apply_sideboard(), _hydrate_deck_cards(), sync_card(), ScryfallSyncService
...
Cohesion: 0.14
Nodes (14): destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying creature: 'graveyard' or 'exile'. (+6 more)

### Community 61 - "Community 61"
Cohesion: 0.23
Nodes (11): _mark_creature_damage(), prevent_damage(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield(), consume_card_prevention_shield(), consume_player_prevention_shield(), test_ai_prefers_attack_on_open_board() (+3 more)
...
Cohesion: 0.17
Nodes (12): 0. Fix runtime and deployment blockers, 1. Make match and simulator state durable, 2. Replace regex-only Oracle growth with structured abilities, 3. Complete high-value rules fidelity, 4. Raise AI from scoring to tactical planning, 5. Build a serious regression and balance matrix, 6. Finish card data and asset reliability, 7. Complete the testing UI and release hardening (+4 more)
...
Cohesion: 0.31
Nodes (9): _count_controlled_type(), gain_life(), lose_life(), player_cant_lose_life(), _basic_state(), test_keyword_layer_grant_then_remove(), test_players_cant_gain_life_lock(), test_players_cant_lose_life_lock() (+1 more)
...
Cohesion: 0.22
Nodes (7): test_attack_can_target_planeswalker_and_reduce_loyalty(), test_planeswalker_loyalty_ability_appears_in_legal_moves(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam, When an unblocked attacker targets a PW that leaves the battlefield,     the dam, test_attack_can_target_planeswalker_and_reduce_loyalty(), test_planeswalker_loyalty_ability_appears_in_legal_moves(), test_unblocked_damage_to_removed_planeswalker_disappears()

### Community 86 - "Community 86"
Cohesion: 0.36
Nodes (6): _ensure_builtin_decks(), ensure_builtin_decks(), ensure_expansion_top_decks(), load_json(), main(), run_cmd()

### Community 87 - "Community 87"
Cohesion: 0.25
Nodes (7): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers.
...
## Knowledge Gaps
- **416 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+411 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 22`, `Community 24`, `Community 25`, `Community 28`, `Community 31`, `Community 34`, `Community 35`, `Community 38`, `Community 42`, `Community 46`, `Community 47`, `Community 61`, `Community 63`, `Community 71`, `Community 74`, `Community 75`, `Community 76`, `Community 82`, `Community 106`, `Community 108`?**
  _High betweenness centrality (0.200) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 20`, `Community 21`, `Community 23`, `Community 34`, `Community 35`, `Community 41`, `Community 43`, `Community 46`, `Community 47`, `Community 51`, `Community 55`, `Community 61`, `Community 71`, `Community 72`, `Community 76`, `Community 85`, `Community 87`, `Community 93`, `Community 94`, `Community 106`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 11` to `Community 0`, `Community 2`, `Community 5`, `Community 8`, `Community 13`, `Community 21`, `Community 33`, `Community 40`, `Community 41`, `Community 45`, `Community 47`, `Community 60`, `Community 64`, `Community 80`, `Community 90`, `Community 92`, `Community 93`, `Community 98`, `Community 106`?**
