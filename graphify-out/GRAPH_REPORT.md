...
## Corpus Check
- 165 files · ~425,133 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2230 nodes · 5861 edges · 119 communities (115 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2647 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30cb6486`
...
Cohesion: 0.06
Nodes (60): _human_priority_pause(), check_cost_option_available(), RulesEngine, _human_priority_pause(), legal_moves(), extract_loyalty_abilities(), RulesEngine, test_discard_additional_cost_is_paid() (+52 more)
...
Cohesion: 0.05
Nodes (50): analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+42 more)
...
Cohesion: 0.04
Nodes (26): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), _count_controlled_type(), cycle_draw(), deal_damage_multi(), destroy_all_artifacts() (+18 more)
...
Cohesion: 0.05
Nodes (47): 0. Fix runtime and deployment blockers, 1. Close Rules-Engine Gaps, 1. Expand Rules-Engine Coverage, 1. Make match and simulator state durable, 2. Deepen AI Decision Quality, 2. Finish BO3 and Sideboard UX, 2. Improve AI Decision Quality, 2. Replace regex-only Oracle growth with structured abilities (+39 more)
...
Cohesion: 0.12
Nodes (35): destroy_permanent(), discard_cards(), StackItem, emit_event(), add_to_stack(), _put_trigger_creature(), _put_trigger_permanent(), test_apnap_trigger_order_on_shared_event() (+27 more)
...
Cohesion: 0.14
Nodes (23): autoplay_tick(), get_repo(), lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick(), get_repo() (+15 more)
...
Cohesion: 0.11
Nodes (12): sync_card(), get_with_backoff(), ScryfallSyncService, _BlankCachedCard, _CachedCard, _CompleteCachedCard, _DummyRepo, test_completeness_report_identifies_cached_and_missing_card_data() (+4 more)

### Community 25 - "Community 25"
Cohesion: 0.19
Nodes (27): effective_power(), effective_toughness(), apply_state_based_actions(), _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_opponent_static_minus_kills_x1_creature() (+19 more)

### Community 26 - "Community 26"
Cohesion: 0.13
Nodes (19): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), MatchState, Zone, CostOption (+11 more)

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (23): CardInstance, inspect_target_hints(), inspect_target_hints(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text(), test_shark_typhoon_does_not_require_x_value_for_cast() (+15 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (22): destroy_all_creatures(), _move_creature_to_graveyard(), sacrifice(), gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements() (+14 more)
...
Cohesion: 0.15
Nodes (20): validate_cast_choice(), PlayerState, validate_cast_choice(), validate_cast_targets(), validate_hexproof_shroud_targets(), validate_protection_targets(), PlayerState, validate_cast_targets() (+12 more)
...
Cohesion: 0.14
Nodes (14): ensure_placeholder_image(), _family(), _slug(), _svg_for(), _cache_remote_token_image(), _extract_image_uri(), resolve_token_image_uri(), _search_scryfall_token_image() (+6 more)
...
Cohesion: 0.14
Nodes (17): _has_any_target_options(), _is_land_card(), can_cast_in_current_timing(), cycling_cost(), cycling_is_variable(), cycling_variant(), Return a cycling cost, optionally including a validated X/Y symbol., Return a cycling cost, optionally including a validated X/Y symbol. (+9 more)
...
Cohesion: 0.16
Nodes (5): _cmc(), _auto_bottom_cards(), add_generic_to_cost(), mana_value(), parse_mana_cost()
...
Cohesion: 0.16
Nodes (14): build_cast_hints(), enrich_divide_total(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), build_cast_hints(), enrich_divide_total() (+6 more)
...
Cohesion: 0.23
Nodes (15): analyze_deck(), _card_text_matches(), _derive_face_based_mana_cost(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _summarize_card_metadata(), analyze_deck_payload() (+7 more)
...
Cohesion: 0.13
Nodes (15): create_shark_token(), create_token(), cycle_search(), _place_searched_card(), put_green_creature_from_hand(), Resolve an alternate-cycling search and shuffle the remaining library., return_creature_from_graveyard_to_battlefield(), return_permanent_from_graveyard_to_battlefield() (+7 more)
...
Cohesion: 0.17
Nodes (9): Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Spell damage should kill creatures — state-based lethal check after damage., Spell damage should kill creatures — state-based lethal check after damage., test_deal_damage_destroys_creature_with_lethal_damage(), test_deal_damage_non_lethal_doesnt_kill(), Bug #8: resolve_effect should gracefully handle non-dict payloads., Bug #8: resolve_effect should gracefully handle non-dict payloads. (+1 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 2`, `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 17`, `Community 21`, `Community 24`, `Community 26`, `Community 32`, `Community 40`, `Community 44`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 55`, `Community 60`, `Community 82`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 18`, `Community 19`, `Community 21`, `Community 25`, `Community 26`, `Community 32`, `Community 41`, `Community 42`, `Community 43`, `Community 47`, `Community 48`, `Community 52`, `Community 54`, `Community 60`, `Community 78`, `Community 84`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 10` to `Community 96`, `Community 2`, `Community 4`, `Community 37`, `Community 69`, `Community 71`, `Community 40`, `Community 41`, `Community 42`, `Community 9`, `Community 48`, `Community 84`, `Community 21`, `Community 54`, `Community 25`, `Community 26`, `Community 27`, `Community 30`?**
