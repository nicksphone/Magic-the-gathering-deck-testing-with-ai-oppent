...
## Corpus Check
- 174 files · ~439,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2440 nodes · 6287 edges · 134 communities (131 shown, 3 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2810 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76fefe5d`
...
## Communities (134 total, 3 thin omitted)
...
Cohesion: 0.06
Nodes (49): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+41 more)
...
Cohesion: 0.06
Nodes (49): Enum, from_decks(), _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+41 more)
...
Cohesion: 0.07
Nodes (33): RulesEngine, test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_creature_is_not_misclassified_as_land_from_oracle_text(), test_non_active_player_cannot_get_play_land_legal_move(), test_london_mulligan_flow_completes_pregame() (+25 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (30): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card(), test_cannot_target_creature_with_protection_from_source_color() (+22 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (49): CardInstance, infer_effect_from_oracle(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing(), test_oracle_multiclause_sequence_parsing(), test_oracle_prevent_next_damage_parsing() (+41 more)
...
Cohesion: 0.13
Nodes (26): autoplay_tick(), get_repo(), lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick(), get_repo() (+18 more)
...
Cohesion: 0.1
Nodes (29): _count_controlled_type(), gain_life(), lose_life(), _move_creature_to_graveyard(), sacrifice(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts() (+21 more)
...
Cohesion: 0.13
Nodes (30): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage() (+22 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (26): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback() (+18 more)

### Community 28 - "Community 28"
Cohesion: 0.21
Nodes (30): combat_damage(), declare_blockers(), combat_damage(), declare_blockers(), from_decks(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage(), test_anthem_effect_increases_combat_damage_output() (+22 more)
...
Cohesion: 0.13
Nodes (24): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), infer_effect_from_oracle(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses() (+16 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (22): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast() (+14 more)
...
Cohesion: 0.18
Nodes (11): apply_state_based_actions(), apply_state_based_actions(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_ai_prefers_attack_on_open_board(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery() (+3 more)
...
Cohesion: 0.25
Nodes (4): test_expansion_top_entries_have_deck_text(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage(), test_prevent_damage_shield_reduces_player_damage()
...
Cohesion: 0.25
Nodes (8): Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., search_card_matches()
...
Cohesion: 0.29
Nodes (6): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers.
...
## Knowledge Gaps
- **391 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+386 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 5`, `Community 8`, `Community 9`, `Community 14`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 29`, `Community 35`, `Community 37`, `Community 41`, `Community 44`, `Community 47`, `Community 49`, `Community 54`, `Community 59`, `Community 61`, `Community 67`, `Community 78`, `Community 83`, `Community 97`, `Community 111`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 9` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 8`, `Community 10`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 28`, `Community 34`, `Community 37`, `Community 44`, `Community 46`, `Community 47`, `Community 49`, `Community 54`, `Community 61`, `Community 69`, `Community 72`, `Community 83`, `Community 88`, `Community 89`, `Community 91`, `Community 95`, `Community 97`, `Community 108`, `Community 109`, `Community 111`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 11` to `Community 0`, `Community 5`, `Community 9`, `Community 13`, `Community 16`, `Community 24`, `Community 27`, `Community 39`, `Community 43`, `Community 47`, `Community 49`, `Community 52`, `Community 65`, `Community 69`, `Community 91`, `Community 95`, `Community 99`, `Community 108`, `Community 109`, `Community 110`, `Community 111`, `Community 117`?**
...
- **Are the 165 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 165 INFERRED edges - model-reasoned connections that need verification._
- **Are the 150 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 150 INFERRED edges - model-reasoned connections that need verification._
