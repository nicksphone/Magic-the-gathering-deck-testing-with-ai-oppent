...
## Corpus Check
- 133 files · ~366,384 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1465 nodes · 4124 edges · 95 communities (90 shown, 5 thin omitted)
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 2032 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `361e95c3`
...
Cohesion: 0.08
Nodes (62): build_cast_hints(), CardInstance, _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), infer_effect_from_oracle(), _infer_topdeck_creature_put_effect() (+54 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (54): _auto_bottom_cards(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (35): check_cost_option_available(), RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color() (+27 more)
...
Cohesion: 0.12
Nodes (25): resolve_effect(), gain_life(), resolve_effect(), Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), test_create_token_respects_amount_and_keywords(), test_deal_damage_cumulative_lethal(), test_deal_damage_destroys_creature_with_lethal_damage() (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (4): copy_ability(), copy_spell(), _copy_stack_object(), create_token()
...
Cohesion: 0.18
Nodes (26): _all_battlefield_ids(), _continuous_pt_delta(), effective_keywords(), _has_subtype(), _is_battlefield(), _iter_keyword_grants(), _iter_pt_modifiers(), _scope_controller() (+18 more)
...
Cohesion: 0.12
Nodes (20): simulate_batch_start(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone (+12 more)

### Community 19 - "Community 19"
Cohesion: 0.18
Nodes (24): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin (+16 more)
...
Cohesion: 0.18
Nodes (16): PlayerState, protection_match_reason(), _protection_tokens(), validate_hexproof_shroud_targets(), validate_protection_targets(), MatchState, PlayerState, validate_cast_targets() (+8 more)
...
Cohesion: 0.18
Nodes (16): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), MatchState (+8 more)
...
Cohesion: 0.18
Nodes (9): compute_max_land_plays_this_turn(), resolve_top_of_stack(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life(), test_summoning_sickness_cleared_only_for_old_creatures() (+1 more)

### Community 37 - "Community 37"
Cohesion: 0.2
Nodes (14): attach_if_legal(), attached_to(), is_aura(), is_equipment(), create_token(), topdeck_put_creatures_battlefield(), assign_static_order_on_battlefield_entry(), resolve_top_of_stack() (+6 more)

### Community 38 - "Community 38"
Cohesion: 0.26
Nodes (14): destroy_permanent(), sacrifice(), emit_event(), _order_apnap(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+6 more)

### Community 39 - "Community 39"
Cohesion: 0.19
Nodes (12): card_color_names(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield() (+4 more)

### Community 40 - "Community 40"
Cohesion: 0.26
Nodes (13): compact_action(), hand_snapshot(), load_named_deck(), main(), now_utc(), parse_args(), battlefield_snapshot(), compact_action() (+5 more)
...
Cohesion: 0.18
Nodes (11): gain_life(), lose_life(), replace_gain_life(), apply_damage_replacements(), damage_cant_be_prevented(), player_cant_gain_life(), player_cant_lose_life(), Return destination zone for a dying creature: 'graveyard' or 'exile'. (+3 more)
...
Cohesion: 0.22
Nodes (7): draw_cards(), draw_card(), draw_cards(), replace_draw_cards(), _auto_bottom_cards(), replace_draw_cards(), draw_card()

### Community 50 - "Community 50"
Cohesion: 0.24
Nodes (10): enrich_divide_total(), validate_cast_choice(), enrich_divide_total(), validate_cast_choice(), validate_cast_targets(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_validate_cast_choice_accepts_zero_x_value_when_required(), test_validate_cast_choice_rejects_out_of_range_face_index() (+2 more)
...
Cohesion: 0.36
Nodes (5): protected_from_source(), _damage_prevented_by_protection(), protected_from_source(), protection_match_reason(), _protection_tokens()
...
Cohesion: 0.38
Nodes (5): fallback_card_payload(), hydrate_deck(), fallback_card_payload(), hydrate_deck(), test_control_ramp_fallback_catalog_contains_core_fields()
...
Cohesion: 0.47
Nodes (5): StackItem, add_to_stack(), add_to_stack(), StackItem, test_aura_without_target_goes_to_graveyard()
...
- **Why does `AIAgent` connect `Community 3` to `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 16`, `Community 17`, `Community 20`, `Community 24`, `Community 25`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 40`, `Community 41`, `Community 43`, `Community 45`, `Community 52`, `Community 66`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 24`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 49`, `Community 66`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 10` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 12`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 27`, `Community 29`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 45`, `Community 49`, `Community 54`, `Community 66`?**
