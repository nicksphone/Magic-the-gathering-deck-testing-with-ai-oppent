...
## Corpus Check
- 165 files · ~425,447 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2231 nodes · 5862 edges · 120 communities (115 shown, 5 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2647 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34559ebf`
...
Cohesion: 0.05
Nodes (62): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state() (+54 more)
...
Cohesion: 0.08
Nodes (59): _auto_bottom_cards(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+51 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (44): check_cost_option_available(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, extract_loyalty_abilities(), test_additional_land_effect_text_allows_second_land_same_turn(), test_generates_basic_legal_moves() (+36 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (47): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), list_cards() (+39 more)
...
Cohesion: 0.07
Nodes (45): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage() (+37 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (43): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), sacrifice(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event() (+35 more)
...
Cohesion: 0.13
Nodes (24): RulesEngine, from_decks(), MatchState, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_attack_is_declared_once_per_combat_step() (+16 more)
...
Cohesion: 0.15
Nodes (24): StackItem, add_to_stack(), resolve_top_of_stack(), add_to_stack(), resolve_top_of_stack(), _put_static_permanent_with_oracle(), test_sheoldred_opponent_draw_trigger_loses_life(), test_sheoldred_you_draw_trigger_gains_life_not_draw() (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.15
Nodes (23): from_decks(), resolve_effect(), apply_state_based_actions(), apply_state_based_actions(), _setup_permanent(), test_continuous_buff_does_not_mutate_base_stats(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_opponent_static_minus_kills_x1_creature() (+15 more)

### Community 27 - "Community 27"
Cohesion: 0.18
Nodes (20): MatchController, init_db(), MatchController, _ensure_card_cache_columns(), _ensure_card_faces_column(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match() (+12 more)
...
Cohesion: 0.17
Nodes (21): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints() (+13 more)

### Community 32 - "Community 32"
Cohesion: 0.16
Nodes (22): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), MatchState (+14 more)
...
Cohesion: 0.16
Nodes (19): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+11 more)
...
Cohesion: 0.21
Nodes (7): compute_max_land_plays_this_turn(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn()
...
Cohesion: 0.2
Nodes (10): destroy_all_creatures(), _move_creature_to_graveyard(), _creature_is_lethally_damaged(), _remove_dead_creatures(), Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying permanent: 'graveyard' or 'exile'., Return destination zone for a dying creature: 'graveyard' or 'exile'., Return destination zone for a dying creature: 'graveyard' or 'exile'. (+2 more)
...
Cohesion: 0.29
Nodes (3): test_expansion_top_entries_have_deck_text(), test_ai_prefers_attack_on_open_board(), test_deal_damage_to_creature_marks_damage_not_toughness()
...
Cohesion: 0.33
Nodes (6): emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), topdeck_put_creatures_battlefield(), StackItem
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 5`, `Community 6`, `Community 15`, `Community 20`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 42`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 53`, `Community 57`, `Community 69`, `Community 82`, `Community 88`, `Community 91`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 5` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 34`, `Community 36`, `Community 39`, `Community 42`, `Community 43`, `Community 45`, `Community 49`, `Community 52`, `Community 62`, `Community 69`, `Community 81`, `Community 82`, `Community 90`, `Community 91`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 26` to `Community 4`, `Community 5`, `Community 7`, `Community 14`, `Community 15`, `Community 19`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 36`, `Community 38`, `Community 43`, `Community 49`, `Community 52`, `Community 58`, `Community 81`, `Community 82`, `Community 88`, `Community 91`?**
