...
## Corpus Check
- 169 files · ~432,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2287 nodes · 5997 edges · 117 communities (115 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2706 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f60a61c3`
...
Cohesion: 0.05
Nodes (51): ai_diagnostics(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_expansion_top_decks(), _force_ai_land_action() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (55): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+47 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (41): Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_creature_is_not_misclassified_as_land_from_oracle_text() (+33 more)
...
Cohesion: 0.09
Nodes (23): check_cost_option_available(), RulesEngine, draw_cards(), compute_max_land_plays_this_turn(), start_match(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing() (+15 more)
...
Cohesion: 0.13
Nodes (33): destroy_permanent(), discard_cards(), emit_event(), _put_trigger_creature(), _put_trigger_permanent(), test_apnap_trigger_order_on_shared_event(), test_artifact_and_enchantment_sacrifice_clauses_trigger_from_sacrificed_permanents(), test_artifact_etb_triggers_from_generic_permanent_entry() (+25 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (30): attach_if_legal(), attached_to(), is_aura(), is_equipment(), exile_permanent(), attach_if_legal(), attached_to(), attachment_target_is_legal() (+22 more)
...
Cohesion: 0.15
Nodes (32): CardInstance, infer_effect_from_oracle(), inspect_target_hints(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed() (+24 more)
...
Cohesion: 0.11
Nodes (14): _ensure_builtin_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), list_expansion_top_decks(), sync_cards_bulk() (+6 more)
...
Cohesion: 0.2
Nodes (14): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_validate_cast_choice_accepts_zero_x_value_when_required() (+6 more)
...
Cohesion: 0.23
Nodes (8): apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_legend_rule_applies_for_offline_named_legendary_permanents()
...
Cohesion: 0.33
Nodes (4): test_ai_prefers_attack_on_open_board(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage()
...
- **Why does `AIAgent` connect `Community 0` to `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 12`, `Community 13`, `Community 16`, `Community 21`, `Community 24`, `Community 26`, `Community 37`, `Community 38`, `Community 40`, `Community 41`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 62`, `Community 65`, `Community 74`, `Community 84`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 6` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 17`, `Community 20`, `Community 21`, `Community 26`, `Community 31`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 44`, `Community 46`, `Community 48`, `Community 50`, `Community 52`, `Community 55`, `Community 60`, `Community 74`, `Community 81`, `Community 84`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 23` to `Community 32`, `Community 36`, `Community 90`, `Community 6`, `Community 7`, `Community 71`, `Community 69`, `Community 42`, `Community 44`, `Community 47`, `Community 19`, `Community 20`, `Community 21`, `Community 54`, `Community 55`, `Community 26`?**
...
- **Are the 143 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 143 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 142 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 142 INFERRED edges - model-reasoned connections that need verification._