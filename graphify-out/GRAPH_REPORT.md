...
## Corpus Check
- 174 files · ~439,980 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2448 nodes · 6308 edges · 127 communities (125 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2816 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1e3b27cd`
...
Cohesion: 0.05
Nodes (57): ai_diagnostics(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+49 more)
...
Cohesion: 0.09
Nodes (64): combat_damage(), declare_blockers(), collect_cost_options(), CostOption, from_decks(), _infer_keywords(), _infer_loyalty(), _infer_power() (+56 more)
...
Cohesion: 0.06
Nodes (50): attach_if_legal(), attached_to(), is_aura(), is_equipment(), counter_spell(), attach_if_legal(), attached_to(), attachment_target_is_legal() (+42 more)
...
Cohesion: 0.09
Nodes (50): create_shark_token(), create_token(), destroy_all_creatures(), destroy_permanent(), discard_cards(), exile_permanent(), sacrifice(), CardInstance (+42 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (39): draw_cards(), legal_moves(), RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves() (+31 more)
...
Cohesion: 0.05
Nodes (25): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments(), destroy_all_enchantments() (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (49): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), declare_attackers(), _defender_label(), _mark_creature_damage() (+41 more)

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (41): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, list_cards(), MatchController (+33 more)
...
Cohesion: 0.11
Nodes (41): resolve_effect(), infer_effect_from_oracle(), inspect_target_hints(), test_arboreal_grazer_style_land_from_hand_enters_tapped_without_land_play(), test_copy_ability_handler_replays_target_ability(), test_copy_spell_handler_replays_target_effect(), test_counter_ability_handler_removes_stack_item(), test_goblin_guide_style_reveals_defending_top_land() (+33 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (21): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), extract_loyalty_abilities(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_cleanup_discards_down_to_seven_by_default() (+13 more)
...
Cohesion: 0.1
Nodes (31): build_cast_hints(), enrich_divide_total(), _extract_modes(), infer_effect_from_oracle(), inspect_target_hints(), enrich_divide_total(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast() (+23 more)
...
Cohesion: 0.17
Nodes (30): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature(), _setup_permanent() (+22 more)
...
Cohesion: 0.19
Nodes (26): _all_battlefield_ids(), _base_pt_with_layers(), _battlefield_card_matches_selector(), _battlefield_position_map(), continuous_layer_trace(), _continuous_pt_delta(), effective_keywords(), _extract_pt_set_groups() (+18 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (23): emit_event(), StackItem, add_to_stack(), add_to_stack(), resolve_top_of_stack(), StackItem, _put_static_permanent_with_oracle(), test_sheoldred_opponent_draw_trigger_loses_life() (+15 more)

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (6): _card_looks_like_land(), _auto_bottom_cards(), add_generic_to_cost(), choose_mana_color_for_player(), mana_value(), parse_mana_cost()

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (21): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _choose_any_permanent_target(), _choose_noncreature_permanent_target() (+13 more)
...
Cohesion: 0.16
Nodes (21): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), MatchState, Zone, activated_cost_available() (+13 more)
...
Cohesion: 0.16
Nodes (18): _move_creature_to_graveyard(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), damage_cant_be_prevented() (+10 more)

### Community 45 - "Community 45"
Cohesion: 0.11
Nodes (10): Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Evaluate small-board blocker assignments by resolving cloned combat., Search small-board attack subsets through the defender's best legal blocks. (+2 more)
...
Cohesion: 0.22
Nodes (14): _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), test_must_block_if_able_auto_assignment(), test_static_you_cant_cast_spells_during_combat_enforced(), _setup_creature(), test_cant_attack_alone_enforced() (+6 more)
...
Cohesion: 0.15
Nodes (13): cycle_search(), _place_searched_card(), Resolve an alternate-cycling search and shuffle the remaining library., Resolve an alternate-cycling search and shuffle the remaining library., search_library(), Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter. (+5 more)
...
Cohesion: 0.2
Nodes (10): _deal_unblocked_damage(), consume_player_prevention_shield(), _deal_unblocked_damage(), test_attack_can_target_planeswalker_and_reduce_loyalty(), test_unblocked_damage_to_removed_planeswalker_disappears(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam, When an unblocked attacker targets a PW that leaves the battlefield,     the dam, test_attack_can_target_planeswalker_and_reduce_loyalty() (+2 more)
...
Cohesion: 0.33
Nodes (7): apply_sideboard(), apply_sideboard_swaps(), _from_counter(), _to_counter(), test_sideboard_swap_moves_cards_between_zones(), test_sideboard_can_only_be_applied_once_per_game(), test_sideboard_swap_moves_cards_between_zones()
...
## Knowledge Gaps
- **392 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+387 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 14`, `Community 21`, `Community 23`, `Community 24`, `Community 28`, `Community 35`, `Community 38`, `Community 39`, `Community 41`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 54`, `Community 60`, `Community 98`, `Community 102`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 10` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 14`, `Community 17`, `Community 20`, `Community 21`, `Community 27`, `Community 31`, `Community 34`, `Community 38`, `Community 39`, `Community 41`, `Community 50`, `Community 51`, `Community 52`, `Community 54`, `Community 55`, `Community 60`, `Community 64`, `Community 65`, `Community 80`, `Community 87`, `Community 98`, `Community 102`, `Community 103`, `Community 105`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 9` to `Community 0`, `Community 4`, `Community 69`, `Community 102`, `Community 103`, `Community 6`, `Community 105`, `Community 10`, `Community 40`, `Community 42`, `Community 16`, `Community 51`, `Community 22`, `Community 88`, `Community 25`, `Community 31`?**
...
- **Are the 151 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
