...
## Corpus Check
- 143 files · ~376,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1727 nodes · 4639 edges · 97 communities (93 shown, 4 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2158 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d60d146`
...
Cohesion: 0.1
Nodes (46): check_cost_option_available(), RulesEngine, legal_moves(), extract_loyalty_abilities(), run(), can_cast_in_current_timing(), RulesEngine, extract_loyalty_abilities() (+38 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (45): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _summarize_card_metadata(), _batch_seed() (+37 more)
...
Cohesion: 0.06
Nodes (39): ai_diagnostics(), apply_sideboard(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _hydrate_deck_cards() (+31 more)
...
Cohesion: 0.07
Nodes (35): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _can_cast_spell() (+27 more)
...
Cohesion: 0.09
Nodes (32): resolve_effect(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage. (+24 more)
...
Cohesion: 0.1
Nodes (25): simulate_batch_start(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+17 more)
...
Cohesion: 0.09
Nodes (10): draw_card(), draw_cards(), compute_max_land_plays_this_turn(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th (+2 more)

### Community 22 - "Community 22"
Cohesion: 0.17
Nodes (27): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power(), effective_toughness(), _setup_creature() (+19 more)
...
Cohesion: 0.12
Nodes (20): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), build_cast_hints() (+12 more)
...
Cohesion: 0.15
Nodes (19): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), first_log_divergence(), normalize_log_line(), compare_replay_logs(), get_match_replay(), classify_first_divergence() (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (20): from_decks(), resolve_effect(), Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+12 more)
...
Cohesion: 0.14
Nodes (19): destroy_all_creatures(), destroy_permanent(), draw_cards(), gain_life(), lose_life(), sacrifice(), replace_draw_cards(), apply_damage_replacements() (+11 more)
...
Cohesion: 0.15
Nodes (16): card_color_names(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage() (+8 more)
...
Cohesion: 0.17
Nodes (17): _collect_triggers(), emit_event(), _first_number(), _maybe_payload(), _order_apnap(), _trigger_from_oracle(), destroy_permanent(), gain_life() (+9 more)
...
Cohesion: 0.26
Nodes (12): _active_card_surface(), _board_value(), _creature_value(), evaluate_board(), evaluate_inevitability(), _noncreature_value(), _planeswalker_count(), _types_from_type_line() (+4 more)
...
Cohesion: 0.25
Nodes (13): _extract_modes(), inspect_target_hints(), _extract_modes(), inspect_target_hints(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text(), test_shark_typhoon_does_not_require_x_value_for_cast() (+5 more)
...
Cohesion: 0.24
Nodes (11): classify(), main(), parse_args(), classify(), _looks_like_main_phase_pass_loop(), main(), _parse_trace(), test_classify_detects_land_drop_miss() (+3 more)
...
Cohesion: 0.25
Nodes (3): topdeck_put_creatures_battlefield(), parse_mana_cost(), parse_mana_cost()
...
Cohesion: 0.36
Nodes (10): emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text(), test_creature_dies_trigger_does_not_match_opponent_creature(), test_creature_dies_trigger_matches_you_control_clause(), test_engine_upkeep_start_enqueues_begin_step_triggers() (+2 more)
...
- **Why does `AIAgent` connect `Community 2` to `Community 0`, `Community 1`, `Community 33`, `Community 5`, `Community 69`, `Community 8`, `Community 59`, `Community 10`, `Community 42`, `Community 44`, `Community 13`, `Community 43`, `Community 18`, `Community 19`, `Community 52`, `Community 53`, `Community 58`, `Community 27`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 18`, `Community 21`, `Community 22`, `Community 25`, `Community 27`, `Community 33`, `Community 36`, `Community 42`, `Community 44`, `Community 56`, `Community 69`, `Community 70`, `Community 71`, `Community 84`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 28` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 8`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 39`, `Community 45`, `Community 60`, `Community 69`, `Community 70`?**
