...
## Corpus Check
- 176 files · ~443,308 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2496 nodes · 6411 edges · 130 communities (128 shown, 2 thin omitted)
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2846 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4168e379`
...
Cohesion: 0.08
Nodes (56): apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands() (+48 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (30): _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), fuzzy_card_lookup(), normalize_card_lookup_name(), DeckParser (+22 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (30): _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), lifespan() (+22 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (36): RulesEngine, test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_london_mulligan_flow_completes_pregame(), test_sorcery_speed_not_castable_off_main_timing(), test_replacement_gain_life_to_draw_cards() (+28 more)
...
Cohesion: 0.06
Nodes (40): ai_diagnostics(), apply_sideboard(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (24): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_search(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (30): check_cost_option_available(), RulesEngine, draw_cards(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card(), test_cannot_target_creature_with_protection_from_source_color() (+22 more)
...
Cohesion: 0.13
Nodes (44): resolve_effect(), CardInstance, infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_search_library_returns_all_matching_cards(), test_arboreal_grazer_style_land_from_hand_enters_tapped_without_land_play(), test_copy_ability_handler_replays_target_ability(), test_copy_spell_handler_replays_target_effect() (+36 more)
...
Cohesion: 0.08
Nodes (37): attach_if_legal(), attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura() (+29 more)
...
Cohesion: 0.2
Nodes (35): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), PriorityStopsRequest (+27 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (19): card_completeness(), list_cards(), list_decks(), Report cached metadata and asset gaps for a deck's distinct card names., saved_deck_card_completeness(), saved_deck_completeness(), suggest_card(), sync_card() (+11 more)
...
Cohesion: 0.19
Nodes (38): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), from_decks(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage() (+30 more)
...
Cohesion: 0.1
Nodes (33): build_cast_hints(), _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), inspect_target_hints(), _parse_count_token() (+25 more)
...
Cohesion: 0.12
Nodes (31): Backend tests, code:bash (cd frontend), Frontend, Frontend, Frontend, Frontend, Frontend, Frontend (+23 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (28): deal_damage(), _state(), test_combat_only_override_applies_to_combat_damage(), test_named_source_override_does_not_unlock_other_sources(), test_target_permanent_can_have_damage_prevention_override(), test_target_player_can_have_damage_prevention_override(), _state(), test_combat_damage_ignores_prevention_when_source_says_cant_be_prevented() (+20 more)

### Community 29 - "Community 29"
Cohesion: 0.12
Nodes (26): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), classify_timeout_state(), _parse_ai_trace_payload(), _trace_context_summary(), get_match_replay(), classify_first_divergence() (+18 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (29): Backend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+21 more)

### Community 31 - "Community 31"
Cohesion: 0.09
Nodes (19): compute_max_land_plays_this_turn(), resolve_effect(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn() (+11 more)
...
Cohesion: 0.11
Nodes (23): collect_cost_options(), CostOption, Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types() (+15 more)
...
Cohesion: 0.13
Nodes (23): _move_creature_to_graveyard(), sacrifice(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map(), _choose_replacement_candidate() (+15 more)
...
Cohesion: 0.14
Nodes (18): compact_action(), hand_snapshot(), now_utc(), run(), battlefield_snapshot(), _cluster_labels(), compact_action(), hand_snapshot() (+10 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (20): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, Return a battlefield permanent to its owner's hand without changing ownership., Put a qualifying spell from the controller's graveyard onto the stack.      The, Return a battlefield permanent to its owner's hand without changing ownership., Return a battlefield permanent to its owner's hand without changing ownership., Return a battlefield permanent to its owner's hand without changing ownership. (+12 more)

### Community 44 - "Community 44"
Cohesion: 0.22
Nodes (17): validate_cast_choice(), build_cast_hints(), validate_cast_choice(), _state_with_target(), test_bounce_ability_spec_is_not_marked_as_oracle_fallback(), test_bounce_inference_exposes_nonland_permanent_targets(), test_bounce_rejects_card_outside_current_target_candidates(), test_bounce_returns_stolen_permanent_to_owner_hand_and_clears_control() (+9 more)
...
Cohesion: 0.2
Nodes (17): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), activated_cost_available(), apply_activated_costs(), apply_additional_costs() (+9 more)
...
Cohesion: 0.2
Nodes (14): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), serialize_match(), _state(), test_day_night_change_triggers_use_the_stack() (+6 more)
...
Cohesion: 0.18
Nodes (14): enrich_divide_total(), test_non_divide_x_spell_does_not_auto_set_divide_total(), _state(), test_build_cast_hints_exposes_face_selection_schema(), test_bullet_and_choose_two_modes_are_exposed_as_explicit_choices(), test_choose_two_modes_resolve_as_ordered_effect_sequence(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed() (+6 more)
...
Cohesion: 0.17
Nodes (12): _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), enrich_divide_total(), normalize_cost_choice(), _extract_equip_cost_text(), _infer_mana_from_land() (+4 more)
...
Cohesion: 0.17
Nodes (12): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent. (+4 more)

### Community 71 - "Community 71"
Cohesion: 0.17
Nodes (12): put_land_from_hand(), Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is (+4 more)

### Community 72 - "Community 72"
Cohesion: 0.17
Nodes (12): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes. (+4 more)
...
Cohesion: 0.18
Nodes (11): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback. (+3 more)
...
Cohesion: 0.31
Nodes (11): infer_effect_from_oracle(), _split_clauses(), CardInstance, test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+3 more)
...
Cohesion: 0.33
Nodes (7): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., draw_card()
...
Cohesion: 0.33
Nodes (6): exile_all_creatures(), Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events.
...
## Knowledge Gaps
- **414 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+409 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 13`, `Community 14`, `Community 15`, `Community 21`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 29`, `Community 33`, `Community 34`, `Community 35`, `Community 42`, `Community 45`, `Community 47`, `Community 53`, `Community 62`, `Community 63`, `Community 74`, `Community 83`, `Community 90`, `Community 110`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 5` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 19`, `Community 21`, `Community 23`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 35`, `Community 36`, `Community 42`, `Community 47`, `Community 48`, `Community 53`, `Community 54`, `Community 56`, `Community 62`, `Community 64`, `Community 74`, `Community 94`, `Community 97`, `Community 98`, `Community 110`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 11` to `Community 0`, `Community 5`, `Community 12`, `Community 13`, `Community 19`, `Community 24`, `Community 28`, `Community 35`, `Community 37`, `Community 38`, `Community 44`, `Community 47`, `Community 48`, `Community 49`, `Community 54`, `Community 57`, `Community 59`, `Community 77`, `Community 79`, `Community 94`, `Community 95`, `Community 96`, `Community 110`?**
...
- **Are the 174 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 174 INFERRED edges - model-reasoned connections that need verification._
- **Are the 155 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
