...
## Corpus Check
- 141 files · ~372,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1665 nodes · 4494 edges · 89 communities (85 shown, 4 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2123 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6062db77`
...
Cohesion: 0.05
Nodes (94): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), CardInstance, PlayerState, _extract_keywords_from_text(), _extract_modes(), _first_creature() (+86 more)
...
Cohesion: 0.06
Nodes (51): attach_if_legal(), attached_to(), is_aura(), is_equipment(), apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card() (+43 more)
...
Cohesion: 0.06
Nodes (40): ai_diagnostics(), apply_sideboard(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _hydrate_deck_cards() (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (48): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature. (+40 more)
...
Cohesion: 0.09
Nodes (30): check_cost_option_available(), RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card(), test_discard_additional_cost_is_paid(), test_attack_is_declared_once_per_combat_step() (+22 more)
...
Cohesion: 0.09
Nodes (16): draw_card(), RulesEngine, test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_london_mulligan_flow_completes_pregame(), test_sorcery_speed_not_castable_off_main_timing(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam (+8 more)
...
Cohesion: 0.18
Nodes (27): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power(), effective_toughness(), apply_state_based_actions() (+19 more)
...
Cohesion: 0.22
Nodes (14): card_color_names(), deal_damage(), deal_damage_multi(), prevent_damage(), deal_damage(), deal_damage_multi(), prevent_damage(), add_card_prevention_shield() (+6 more)
...
Cohesion: 0.18
Nodes (11): draw_cards(), gain_life(), lose_life(), apply_damage_replacements(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), player_cant_gain_life() (+3 more)
...
Cohesion: 0.22
Nodes (9): destroy_all_creatures(), destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), _creature_is_lethally_damaged(), _remove_dead_creatures(), Return destination zone for a dying creature: 'graveyard' or 'exile'., Return destination zone for a dying creature: 'graveyard' or 'exile'. (+1 more)
...
- **Why does `AIAgent` connect `Community 1` to `Community 3`, `Community 4`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 16`, `Community 19`, `Community 24`, `Community 27`, `Community 29`, `Community 36`, `Community 38`, `Community 40`, `Community 42`, `Community 57`, `Community 58`, `Community 62`, `Community 63`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 14` to `Community 0`, `Community 33`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 37`, `Community 8`, `Community 39`, `Community 11`, `Community 16`, `Community 19`, `Community 21`, `Community 24`, `Community 58`, `Community 29`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 14` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 16`, `Community 19`, `Community 21`, `Community 24`, `Community 29`, `Community 31`, `Community 33`, `Community 37`, `Community 39`, `Community 58`, `Community 62`?**
...
- **Are the 98 inferred relationships involving `str` (e.g. with `sync_cards_bulk()` and `ingest_tournament_json()`) actually correct?**
