...
## Corpus Check
- 174 files · ~438,893 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2416 nodes · 6244 edges · 129 communities (126 shown, 3 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2794 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11fff637`
...
## Communities (129 total, 3 thin omitted)
...
Cohesion: 0.07
Nodes (54): _auto_bottom_cards(), RulesEngine, from_decks(), compute_max_land_plays_this_turn(), resolve_effect(), apply_state_based_actions(), from_decks(), MatchState (+46 more)
...
Cohesion: 0.05
Nodes (54): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action() (+46 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (56): check_cost_option_available(), apply_cost_modifiers(), CostContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color() (+48 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (44): legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, extract_loyalty_abilities(), test_additional_land_effect_text_allows_second_land_same_turn(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped() (+36 more)
...
Cohesion: 0.14
Nodes (47): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), MatchController (+39 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (25): get_repo(), analytics_history(), get_repo(), CardCache, DeckRecord, MatchRecord, StatsSnapshot, ActiveMatchRecord (+17 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (28): _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), list_decks() (+20 more)
...
Cohesion: 0.08
Nodes (42): deal_damage(), resolve_effect(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill. (+34 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (42): build_cast_hints(), enrich_divide_total(), _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), inspect_target_hints() (+34 more)
...
Cohesion: 0.09
Nodes (18): card_completeness(), list_cards(), Report cached metadata and asset gaps for a deck's distinct card names., saved_deck_card_completeness(), saved_deck_completeness(), suggest_card(), sync_card(), CardService (+10 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (38): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), sacrifice(), emit_event(), test_sacrifice_handler_puts_stolen_creature_into_its_owners_graveyard(), _put_trigger_creature() (+30 more)
...
Cohesion: 0.1
Nodes (11): AIDecision, AIDecision, _card_looks_like_land(), _cmc(), topdeck_put_creatures_battlefield(), parse_mana_cost(), _auto_bottom_cards(), mana_value() (+3 more)
...
Cohesion: 0.1
Nodes (25): crew_vehicle(), _infer_mana_from_land(), _is_land_card(), _has_any_target_options(), _is_land_card(), pass_priority(), normalize_cost_choice(), cycling_cost() (+17 more)

### Community 26 - "Community 26"
Cohesion: 0.18
Nodes (29): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _creature_is_lethally_damaged(), effective_power(), effective_toughness(), _setup_creature() (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (29): _collect_triggers(), emit_event(), _first_number(), _maybe_payload(), _order_apnap(), _trigger_from_oracle(), destroy_permanent(), sacrifice() (+21 more)
...
Cohesion: 0.09
Nodes (18): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., draw_card(), _infer_keywords(), _infer_loyalty(), _infer_power() (+10 more)
...
Cohesion: 0.16
Nodes (22): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), Zone (+14 more)
...
Cohesion: 0.15
Nodes (19): _move_creature_to_graveyard(), draw_cards(), gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts() (+11 more)
...
Cohesion: 0.17
Nodes (14): StackItem, add_to_stack(), add_to_stack(), resolve_top_of_stack(), StackItem, _put_static_permanent_with_oracle(), test_sheoldred_opponent_draw_trigger_loses_life(), test_sheoldred_you_draw_trigger_gains_life_not_draw() (+6 more)
...
Cohesion: 0.31
Nodes (13): init_db(), autoplay_tick(), _start_next_game_state(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match(), test_autoplay_forces_ai_land_drop_on_own_main_phase(), test_autoplay_land_guard_ignores_stale_land_counter_drift() (+5 more)
...
Cohesion: 0.18
Nodes (11): cycle_search(), _place_searched_card(), Resolve an alternate-cycling search and shuffle the remaining library., search_library(), Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter. (+3 more)
...
Cohesion: 0.2
Nodes (10): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent. (+2 more)
...
Cohesion: 0.2
Nodes (10): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes. (+2 more)
...
Cohesion: 0.22
Nodes (9): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback. (+1 more)
...
Cohesion: 0.33
Nodes (5): test_replacement_gain_life_to_draw_cards(), test_hexproof_blocks_opponent_targeted_spell(), test_replacement_gain_life_to_draw_cards(), test_timing_restriction_first_main_phase_only(), test_ward_tax_blocks_underpaid_targeted_spell()
...
Cohesion: 0.4
Nodes (5): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers.
...
## Knowledge Gaps
- **375 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+370 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 20`, `Community 21`, `Community 23`, `Community 28`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 41`, `Community 48`, `Community 53`, `Community 54`, `Community 62`, `Community 67`, `Community 69`, `Community 81`, `Community 100`, `Community 104`, `Community 105`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 18`, `Community 21`, `Community 25`, `Community 26`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 41`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 52`, `Community 53`, `Community 54`, `Community 69`, `Community 92`, `Community 94`, `Community 100`, `Community 105`, `Community 106`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `emit_event()` connect `Community 18` to `Community 1`, `Community 2`, `Community 11`, `Community 15`, `Community 19`, `Community 25`, `Community 27`, `Community 32`, `Community 35`, `Community 37`, `Community 40`, `Community 41`, `Community 46`, `Community 51`, `Community 70`, `Community 71`, `Community 77`, `Community 79`, `Community 94`, `Community 108`?**
...
- **Are the 163 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 163 INFERRED edges - model-reasoned connections that need verification._
