...
## Corpus Check
- 159 files · ~420,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2143 nodes · 5678 edges · 97 communities (93 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2583 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e6b3fc5`
...
3. `RulesEngine` - 137 edges
4. `from_decks()` - 136 edges
5. `CardInstance` - 123 edges
6. `AIAgent` - 87 edges
...
Cohesion: 0.06
Nodes (61): check_cost_option_available(), RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color() (+53 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (69): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature() (+61 more)
...
Cohesion: 0.06
Nodes (54): analyze_deck(), _card_text_matches(), _derive_face_based_mana_cost(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _summarize_card_metadata(), analyze_deck_payload() (+46 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (55): apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands(), count_untapped_lands_by_color() (+47 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (44): analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+36 more)
...
Cohesion: 0.05
Nodes (19): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_draw(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+11 more)

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (40): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+32 more)
...
Cohesion: 0.13
Nodes (31): autoplay_tick(), _human_priority_pause(), lifespan(), MatchController, _restore_active_matches(), set_priority_stops(), init_db(), autoplay_tick() (+23 more)
...
Cohesion: 0.07
Nodes (13): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+5 more)

### Community 21 - "Community 21"
Cohesion: 0.22
Nodes (34): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), from_decks(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage() (+26 more)
...
Cohesion: 0.07
Nodes (31): resolve_effect(), resolve_top_of_stack(), test_copying_a_spell_triggers_magecraft_style_pump(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill. (+23 more)
...
Cohesion: 0.11
Nodes (17): ai_diagnostics(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_expansion_top_deck(), list_decks(), list_expansion_top_decks(), saved_deck_card_completeness() (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.17
Nodes (29): _combat_damage_step(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness() (+21 more)
...
Cohesion: 0.11
Nodes (28): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+20 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (16): import_all_expansion_top_decks(), import_deck(), import_deck_file(), ai_diagnostics(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks() (+8 more)

### Community 31 - "Community 31"
Cohesion: 0.12
Nodes (20): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, Zone (+12 more)

### Community 32 - "Community 32"
Cohesion: 0.12
Nodes (9): _card_looks_like_land(), _cmc(), topdeck_put_creatures_battlefield(), add_generic_to_cost(), parse_mana_cost(), _auto_bottom_cards(), add_generic_to_cost(), mana_value() (+1 more)
...
Cohesion: 0.12
Nodes (15): compute_max_land_plays_this_turn(), apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures() (+7 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (21): resolve_effect(), test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage., test_create_token_respects_amount_and_keywords(), test_deal_damage_cumulative_lethal() (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (20): destroy_all_creatures(), destroy_permanent(), draw_cards(), _move_creature_to_graveyard(), draw_cards(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements() (+12 more)

### Community 37 - "Community 37"
Cohesion: 0.17
Nodes (19): _extract_modes(), inspect_target_hints(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_non_divide_x_spell_does_not_auto_set_divide_total() (+11 more)
...
Cohesion: 0.17
Nodes (18): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+10 more)
...
Cohesion: 0.22
Nodes (15): declare_attackers(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), test_must_block_if_able_auto_assignment(), test_static_you_cant_cast_spells_during_combat_enforced(), _setup_creature() (+7 more)
...
Cohesion: 0.15
Nodes (13): create_shark_token(), create_token(), _place_searched_card(), put_green_creature_from_hand(), return_creature_from_graveyard_to_battlefield(), return_permanent_from_graveyard_to_battlefield(), search_library(), topdeck_put_creatures_battlefield() (+5 more)
...
Cohesion: 0.52
Nodes (6): _state_with_cycler(), test_cycling_pays_cost_discards_then_draws_on_resolution(), test_cycling_trigger_is_matched_by_card_name_and_put_above_ability(), test_fixed_cycling_is_a_legal_hand_action(), test_variable_cycle_x_value_reaches_dynamic_cycle_trigger(), test_variable_cycling_exposes_only_mana_payable_x_values()
...
## Knowledge Gaps
- **250 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Push control decks to convert resources instead of over-passing in developed boa`, `Run a seeded match while preserving each game's independent replay seed.`, `Keep round-robin traces compact while retaining tactical board state.` (+245 more)
...
- **Why does `AIAgent` connect `Community 2` to `Community 32`, `Community 33`, `Community 0`, `Community 3`, `Community 68`, `Community 1`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 43`, `Community 44`, `Community 18`, `Community 20`, `Community 23`, `Community 31`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 18`, `Community 19`, `Community 21`, `Community 25`, `Community 27`, `Community 31`, `Community 34`, `Community 35`, `Community 44`, `Community 45`, `Community 48`, `Community 70`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 21` to `Community 0`, `Community 1`, `Community 34`, `Community 35`, `Community 37`, `Community 6`, `Community 7`, `Community 42`, `Community 10`, `Community 45`, `Community 15`, `Community 48`, `Community 18`, `Community 25`, `Community 27`, `Community 63`, `Community 31`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Are the 138 inferred relationships involving `AIAgent` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`AIAgent` has 138 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 126 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 126 INFERRED edges - model-reasoned connections that need verification._