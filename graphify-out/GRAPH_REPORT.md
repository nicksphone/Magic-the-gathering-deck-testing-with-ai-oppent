...
## Corpus Check
- 165 files · ~425,089 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2229 nodes · 5860 edges · 123 communities (119 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2647 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e257c149`
...
Cohesion: 0.05
Nodes (50): ai_diagnostics(), analytics_history(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+42 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (56): resolve_effect(), CardInstance, _extract_modes(), infer_effect_from_oracle(), inspect_target_hints(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_build_cast_hints_exposes_face_selection_schema(), test_memory_deluge_does_not_require_x_value_for_cast() (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (29): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), _count_controlled_type(), cycle_draw(), cycle_search(), deal_damage_multi() (+21 more)
...
Cohesion: 0.06
Nodes (38): RulesEngine, test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_creature_is_not_misclassified_as_land_from_oracle_text(), test_non_active_player_cannot_get_play_land_legal_move(), test_sorcery_speed_not_castable_off_main_timing(), test_replacement_gain_life_to_draw_cards(), test_planeswalker_loyalty_ability_appears_in_legal_moves() (+30 more)
...
Cohesion: 0.12
Nodes (29): autoplay_tick(), get_repo(), _human_priority_pause(), lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick() (+21 more)

### Community 16 - "Community 16"
Cohesion: 0.12
Nodes (27): RulesEngine, from_decks(), test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_attack_is_declared_once_per_combat_step(), test_combat_damage_reduces_life() (+19 more)
...
Cohesion: 0.09
Nodes (22): Enum, draw_card(), _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+14 more)
...
Cohesion: 0.13
Nodes (19): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), build_cast_hints() (+11 more)
...
Cohesion: 0.13
Nodes (16): apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures(), test_summoning_sickness_kept_for_creature_entering_this_turn() (+8 more)

### Community 33 - "Community 33"
Cohesion: 0.17
Nodes (16): _board_role_hint(), build_priors_from_examples(), build_priors_from_logs(), _build_priors_payload(), _count_creatures(), _record_card_timing(), save_log_priors(), _sum_power() (+8 more)

### Community 34 - "Community 34"
Cohesion: 0.14
Nodes (21): _extract_keywords_from_text(), extract_loyalty_abilities(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses() (+13 more)
...
Cohesion: 0.17
Nodes (18): gain_life(), gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+10 more)
...
Cohesion: 0.18
Nodes (17): check_cost_option_available(), compute_max_land_plays_this_turn(), _can_cast_spell(), _has_any_target_options(), _is_land_card(), legal_moves(), can_cast_in_current_timing(), card_cant_attack() (+9 more)

### Community 42 - "Community 42"
Cohesion: 0.19
Nodes (18): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), activated_cost_available() (+10 more)

### Community 43 - "Community 43"
Cohesion: 0.23
Nodes (18): from_decks(), infer_effect_from_oracle(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text(), test_shark_typhoon_does_not_require_x_value_for_cast() (+10 more)
...
Cohesion: 0.33
Nodes (7): _cache_remote_token_image(), _extract_image_uri(), resolve_token_image_uri(), _search_scryfall_token_image(), test_create_token_assigns_image_uri(), test_resolve_token_image_uri_falls_back_to_generic_token_art(), test_resolve_token_image_uri_returns_generic_or_remote()
...
Cohesion: 0.4
Nodes (5): extract_activated_abilities(), Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface.
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 7`, `Community 8`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 24`, `Community 25`, `Community 31`, `Community 35`, `Community 37`, `Community 43`, `Community 46`, `Community 48`, `Community 50`, `Community 57`, `Community 61`, `Community 62`, `Community 70`, `Community 90`, `Community 102`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 7` to `Community 0`, `Community 2`, `Community 3`, `Community 8`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 35`, `Community 37`, `Community 38`, `Community 43`, `Community 46`, `Community 47`, `Community 50`, `Community 62`, `Community 70`, `Community 102`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 43` to `Community 2`, `Community 4`, `Community 7`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 25`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 38`, `Community 47`, `Community 50`, `Community 52`, `Community 53`, `Community 90`?**
...
- **Are the 135 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
