...
## Corpus Check
- 163 files · ~421,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2176 nodes · 5746 edges · 108 communities (106 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2610 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d8120b2`
...
Cohesion: 0.07
Nodes (60): topdeck_put_creatures_battlefield(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+52 more)
...
Cohesion: 0.05
Nodes (51): ai_diagnostics(), analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_builtin_decks() (+43 more)
...
Cohesion: 0.09
Nodes (26): AIAgent, AIDecision, _card_looks_like_land(), _step_key(), test_aggro_ai_prefers_creature_development_over_burn_early(), test_ai_avoids_mana_tap_loop_when_no_cast_available(), test_ai_does_not_treat_mana_creature_as_land_in_forced_land_logic(), test_ai_forces_land_drop_even_when_legal_moves_omit_play_land() (+18 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (43): attached_to(), is_aura(), is_equipment(), apply_additional_costs(), check_cost_option_available(), collect_cost_options(), CostOption, _first_discardable_card() (+35 more)
...
Cohesion: 0.14
Nodes (47): combat_damage(), declare_blockers(), from_decks(), resolve_effect(), combat_damage(), declare_blockers(), from_decks(), _setup_creature() (+39 more)
...
Cohesion: 0.08
Nodes (24): _auto_bottom_cards(), RulesEngine, compute_max_land_plays_this_turn(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect() (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (45): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+37 more)
...
Cohesion: 0.08
Nodes (21): ensure_expansion_top_decks(), CardCache, DeckRecord, MatchRecord, StatsSnapshot, ActiveMatchRecord, CardCache, DeckRecord (+13 more)
...
Cohesion: 0.13
Nodes (30): autoplay_tick(), _human_priority_pause(), _is_full_ai_match(), MatchController, init_db(), autoplay_tick(), _human_priority_pause(), _is_full_ai_match() (+22 more)
...
Cohesion: 0.11
Nodes (36): create_shark_token(), create_token(), discard_cards(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+28 more)

### Community 21 - "Community 21"
Cohesion: 0.1
Nodes (35): deal_damage(), resolve_effect(), resolve_top_of_stack(), test_copying_a_spell_triggers_magecraft_style_pump(), test_create_token_respects_amount_and_keywords(), test_discard_effect_targets_specified_player(), test_effect_sequence_resolves_all_clauses(), test_search_library_returns_all_matching_cards() (+27 more)
...
Cohesion: 0.13
Nodes (20): AIDecision, Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+12 more)

### Community 30 - "Community 30"
Cohesion: 0.2
Nodes (26): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature(), _setup_permanent() (+18 more)
...
Cohesion: 0.12
Nodes (8): get_repo(), analytics_history(), get_repo(), _hydrate_deck_cards(), sync_card(), Repository, ScryfallSyncService, test_hydrate_deck_cards_uses_fallback_when_cache_unavailable()
...
Cohesion: 0.14
Nodes (21): gain_life(), lose_life(), draw_cards(), gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements() (+13 more)

### Community 35 - "Community 35"
Cohesion: 0.13
Nodes (22): _extract_keywords_from_text(), extract_loyalty_abilities(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses() (+14 more)
...
Cohesion: 0.14
Nodes (19): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), classify_timeout_state(), first_log_divergence(), normalize_log_line(), _parse_ai_trace_payload(), _trace_context_summary() (+11 more)
...
Cohesion: 0.13
Nodes (19): _has_any_target_options(), _is_land_card(), can_cast_in_current_timing(), card_cant_block(), card_must_block_if_able(), declare_attackers(), _defender_label(), _valid_defenders() (+11 more)
...
Cohesion: 0.18
Nodes (16): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice(), add_to_stack() (+8 more)

### Community 46 - "Community 46"
Cohesion: 0.18
Nodes (17): declare_attackers(), _defender_label(), card_cant_attack(), card_must_attack_if_able(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted() (+9 more)
...
Cohesion: 0.2
Nodes (8): _balance_alerts(), _batch_seed(), compare_replay_logs(), _extract_turn_summaries(), _wilson_interval(), guess_archetype(), _DummyRepo, test_batch_does_not_auto_award_unresolved_games_to_deck_a()
...
Cohesion: 0.33
Nodes (7): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback(), test_planeswalker_static_and_loyalty_text_is_not_cast_time_fallback()
...
Cohesion: 0.5
Nodes (4): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., draw_card()
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 18`, `Community 19`, `Community 23`, `Community 26`, `Community 29`, `Community 33`, `Community 36`, `Community 37`, `Community 42`, `Community 48`, `Community 51`, `Community 53`, `Community 60`, `Community 65`, `Community 75`, `Community 76`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 18`, `Community 20`, `Community 22`, `Community 26`, `Community 29`, `Community 30`, `Community 36`, `Community 37`, `Community 46`, `Community 51`, `Community 65`, `Community 75`, `Community 76`, `Community 77`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 8` to `Community 1`, `Community 4`, `Community 69`, `Community 38`, `Community 5`, `Community 44`, `Community 13`, `Community 12`, `Community 45`, `Community 46`, `Community 18`, `Community 51`, `Community 84`, `Community 20`, `Community 29`, `Community 30`, `Community 31`?**
