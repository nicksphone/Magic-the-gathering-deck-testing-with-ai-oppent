...
## Corpus Check
- 164 files · ~423,461 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2203 nodes · 5813 edges · 109 communities (105 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2633 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c7c69529`
...
9. `resolve_effect()` - 69 edges
10. `emit_event()` - 57 edges
...
Cohesion: 0.05
Nodes (92): _active_card_surface(), _board_value(), _creature_value(), evaluate_board(), evaluate_inevitability(), _noncreature_value(), _planeswalker_count(), _types_from_type_line() (+84 more)
...
Cohesion: 0.05
Nodes (57): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state() (+49 more)
...
Cohesion: 0.07
Nodes (55): deal_damage(), resolve_effect(), draw_cards(), gain_life(), resolve_effect(), replace_draw_cards(), replace_gain_life(), Zone (+47 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (51): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+43 more)
...
Cohesion: 0.09
Nodes (33): check_cost_option_available(), from_decks(), extract_loyalty_abilities(), can_cast_in_current_timing(), apply_state_based_actions(), from_decks(), MatchState, test_cannot_target_creature_with_protection_from_source_color() (+25 more)
...
Cohesion: 0.11
Nodes (38): create_shark_token(), create_token(), discard_cards(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+30 more)
...
Cohesion: 0.11
Nodes (30): legal_moves(), RulesEngine, test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_ability_oracle_marks_land_playable_when_type_metadata_missing() (+22 more)
...
Cohesion: 0.12
Nodes (30): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+22 more)
...
Cohesion: 0.1
Nodes (25): cycle_draw(), destroy_all_creatures(), destroy_permanent(), draw_cards(), _move_creature_to_graveyard(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., sacrifice() (+17 more)

### Community 27 - "Community 27"
Cohesion: 0.21
Nodes (25): combat_damage(), declare_blockers(), combat_damage(), declare_blockers(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage(), test_anthem_effect_increases_combat_damage_output(), test_blocker_with_additional_block_capacity_can_block_two_attackers() (+17 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (5): _card_looks_like_land(), _auto_bottom_cards(), choose_mana_color_for_player(), mana_value(), parse_mana_cost()
...
Cohesion: 0.17
Nodes (19): build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints() (+11 more)
...
Cohesion: 0.16
Nodes (17): cast_from_graveyard(), Put a qualifying spell from the controller's graveyard onto the stack.      The, Put a qualifying spell from the controller's graveyard onto the stack.      The, emit_event(), _order_apnap(), StackItem, destroy_permanent(), sacrifice() (+9 more)

### Community 40 - "Community 40"
Cohesion: 0.18
Nodes (18): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), _choose_any_permanent_target(), _choose_noncreature_permanent_target() (+10 more)
...
- **Why does `AIAgent` connect `Community 1` to `Community 0`, `Community 2`, `Community 6`, `Community 7`, `Community 11`, `Community 15`, `Community 18`, `Community 20`, `Community 22`, `Community 23`, `Community 28`, `Community 32`, `Community 33`, `Community 34`, `Community 37`, `Community 41`, `Community 46`, `Community 49`, `Community 52`, `Community 57`, `Community 59`, `Community 60`, `Community 66`, `Community 86`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 20` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 15`, `Community 17`, `Community 19`, `Community 23`, `Community 30`, `Community 32`, `Community 33`, `Community 37`, `Community 41`, `Community 42`, `Community 43`, `Community 46`, `Community 48`, `Community 49`, `Community 52`, `Community 59`, `Community 66`, `Community 75`, `Community 78`, `Community 79`, `Community 83`, `Community 86`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 15` to `Community 0`, `Community 4`, `Community 5`, `Community 10`, `Community 11`, `Community 17`, `Community 20`, `Community 27`, `Community 30`, `Community 33`, `Community 35`, `Community 36`, `Community 39`, `Community 41`, `Community 42`, `Community 48`, `Community 49`, `Community 52`, `Community 75`, `Community 78`, `Community 79`, `Community 83`, `Community 86`?**
...
- **Are the 131 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 131 INFERRED edges - model-reasoned connections that need verification._
