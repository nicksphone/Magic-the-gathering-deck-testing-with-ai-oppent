...
## Corpus Check
- 174 files · ~440,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2450 nodes · 6310 edges · 129 communities (125 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2816 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `37a3eb5c`
...
Cohesion: 0.05
Nodes (60): build_cast_hints(), check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine (+52 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (78): _active_card_surface(), _board_value(), _creature_value(), evaluate_inevitability(), _noncreature_value(), _planeswalker_count(), _types_from_type_line(), _all_battlefield_ids() (+70 more)
...
Cohesion: 0.05
Nodes (48): analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (55): counter_spell(), CardInstance, infer_effect_from_oracle(), _split_clauses(), infer_effect_from_oracle(), CardInstance, test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing() (+47 more)
...
Cohesion: 0.06
Nodes (48): Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, Zone (+40 more)

### Community 10 - "Community 10"
Cohesion: 0.15
Nodes (38): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, list_cards(), PriorityStopsRequest (+30 more)
...
Cohesion: 0.09
Nodes (47): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), sacrifice(), StackItem, emit_event(), add_to_stack() (+39 more)
...
Cohesion: 0.09
Nodes (36): attach_if_legal(), attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura() (+28 more)
...
Cohesion: 0.1
Nodes (34): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _deal_unblocked_damage(), _mark_creature_damage(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+26 more)
...
Cohesion: 0.12
Nodes (16): apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life(), test_summoning_sickness_cleared_only_for_old_creatures() (+8 more)
...
Cohesion: 0.18
Nodes (19): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), activated_cost_available() (+11 more)

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (19): _move_creature_to_graveyard(), gain_life(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+11 more)
...
Cohesion: 0.19
Nodes (15): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), serialize_match(), _state(), test_day_night_change_triggers_use_the_stack() (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.18
Nodes (17): declare_attackers(), _defender_label(), _valid_defenders(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_cast_only_during_your_turn_restriction_and_move_hint(), test_must_attack_if_able_auto_added_when_omitted() (+9 more)
...
Cohesion: 0.22
Nodes (10): card_color_names(), _damage_prevented_by_protection(), protected_from_source(), protection_match_reason(), _protection_tokens(), _attacker_has_active_landwalk_with_state(), _can_block_attacker(), protected_from_source() (+2 more)
...
Cohesion: 0.24
Nodes (13): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin, _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically() (+5 more)
...
Cohesion: 0.4
Nodes (5): emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), StackItem
...
## Knowledge Gaps
- **393 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+388 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 16`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 29`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 40`, `Community 48`, `Community 49`, `Community 52`, `Community 58`, `Community 64`, `Community 109`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 19`, `Community 21`, `Community 26`, `Community 32`, `Community 33`, `Community 36`, `Community 37`, `Community 40`, `Community 46`, `Community 47`, `Community 49`, `Community 50`, `Community 52`, `Community 66`, `Community 80`, `Community 89`, `Community 106`, `Community 108`, `Community 109`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 9`, `Community 13`, `Community 15`, `Community 16`, `Community 20`, `Community 26`, `Community 32`, `Community 43`, `Community 46`, `Community 54`, `Community 75`, `Community 92`, `Community 93`, `Community 106`, `Community 108`, `Community 109`?**
