...
## Corpus Check
- 143 files · ~374,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1711 nodes · 4599 edges · 81 communities (79 shown, 2 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2143 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9705285`
...
Cohesion: 0.05
Nodes (39): _card_looks_like_land(), _default_player_for_state(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), _force_ai_land_action(), get_expansion_top_deck(), get_legal_moves(), import_all_expansion_top_decks() (+31 more)
...
Cohesion: 0.08
Nodes (23): compute_max_land_plays_this_turn(), RulesEngine, test_discard_additional_cost_is_paid(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life() (+15 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (33): autoplay_tick(), _human_priority_pause(), MatchController, next_game(), _post_step_finalize(), set_priority_stops(), _start_next_game_state(), take_action() (+25 more)
...
Cohesion: 0.18
Nodes (39): combat_damage(), declare_blockers(), from_decks(), inspect_target_hints(), combat_damage(), declare_blockers(), from_decks(), test_memory_deluge_does_not_require_x_value_for_cast() (+31 more)
...
Cohesion: 0.09
Nodes (22): ai_diagnostics(), apply_sideboard(), get_match(), _hydrate_deck_cards(), _serialize_match_controller(), start_match(), apply_sideboard(), get_match() (+14 more)
...
Cohesion: 0.1
Nodes (24): simulate_batch_start(), create_token(), topdeck_put_creatures_battlefield(), Enum, assign_static_order_on_battlefield_entry(), _infer_keywords(), _infer_loyalty(), _infer_power() (+16 more)
...
Cohesion: 0.15
Nodes (24): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+16 more)
...
Cohesion: 0.17
Nodes (18): declare_attackers(), test_defender_creature_cannot_attack(), test_vigilance_attacker_does_not_tap(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_cast_only_during_your_turn_restriction_and_move_hint(), test_must_attack_if_able_auto_added_when_omitted() (+10 more)
...
Cohesion: 0.17
Nodes (17): _deal_unblocked_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), deal_damage(), deal_damage_multi() (+9 more)
...
Cohesion: 0.17
Nodes (12): card_color_names(), _damage_prevented_by_protection(), protected_from_source(), protection_match_reason(), _protection_tokens(), _damage_prevented_by_protection(), _deal_unblocked_damage(), protected_from_source() (+4 more)
...
- **Why does `AIAgent` connect `Community 4` to `Community 2`, `Community 35`, `Community 7`, `Community 10`, `Community 11`, `Community 42`, `Community 13`, `Community 12`, `Community 17`, `Community 18`, `Community 21`, `Community 59`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 12` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 26`, `Community 32`, `Community 35`, `Community 38`, `Community 42`, `Community 47`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 15` to `Community 0`, `Community 32`, `Community 34`, `Community 3`, `Community 2`, `Community 5`, `Community 39`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 21`, `Community 26`, `Community 27`?**
