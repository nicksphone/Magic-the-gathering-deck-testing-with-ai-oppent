...
## Corpus Check
- 167 files · ~431,398 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2265 nodes · 5958 edges · 114 communities (111 shown, 3 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2693 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11c8764a`
...
Cohesion: 0.06
Nodes (56): check_cost_option_available(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana() (+48 more)
...
Cohesion: 0.05
Nodes (56): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state() (+48 more)
...
Cohesion: 0.08
Nodes (28): AIAgent, AIDecision, _card_looks_like_land(), _step_key(), AIDecision, add_generic_to_cost(), parse_mana_cost(), test_aggro_ai_prefers_creature_development_over_burn_early() (+20 more)
...
Cohesion: 0.07
Nodes (23): get_repo(), get_repo(), CardCache, DeckRecord, MatchRecord, StatsSnapshot, ActiveMatchRecord, CardCache (+15 more)
...
Cohesion: 0.12
Nodes (45): CardInstance, infer_effect_from_oracle(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing(), test_oracle_multiclause_sequence_parsing(), test_oracle_prevent_next_damage_parsing() (+37 more)
...
Cohesion: 0.08
Nodes (41): Enum, from_decks(), _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+33 more)

### Community 16 - "Community 16"
Cohesion: 0.11
Nodes (38): create_shark_token(), create_token(), discard_cards(), StackItem, emit_event(), _order_apnap(), add_to_stack(), _put_trigger_creature() (+30 more)
...
Cohesion: 0.1
Nodes (35): deal_damage(), resolve_effect(), test_copying_a_spell_triggers_magecraft_style_pump(), Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill., test_create_token_respects_amount_and_keywords() (+27 more)
...
Cohesion: 0.09
Nodes (33): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+25 more)
...
Cohesion: 0.16
Nodes (30): _combat_damage_step(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness() (+22 more)
...
Cohesion: 0.22
Nodes (29): combat_damage(), declare_blockers(), combat_damage(), declare_blockers(), from_decks(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage(), test_anthem_effect_increases_combat_damage_output() (+21 more)
...
Cohesion: 0.13
Nodes (11): RulesEngine, draw_cards(), compute_max_land_plays_this_turn(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th (+3 more)
...
Cohesion: 0.15
Nodes (22): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), infer_effect_from_oracle(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+14 more)
...
Cohesion: 0.13
Nodes (18): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _auto_bottom_cards(), _infer_mana_from_land(), _is_land_card(), pass_priority(), enrich_divide_total() (+10 more)
...
Cohesion: 0.16
Nodes (19): _count_controlled_type(), gain_life(), lose_life(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+11 more)
...
Cohesion: 0.13
Nodes (10): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Apply a selected face to a battlefield double-faced permanent., transform_card(), transform_if_top_matches(), _ensure_card_cache_columns(), _ensure_card_faces_column(), str (+2 more)
...
Cohesion: 0.19
Nodes (18): _extract_modes(), inspect_target_hints(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_non_divide_x_spell_does_not_auto_set_divide_total() (+10 more)
...
Cohesion: 0.19
Nodes (16): PlayerState, validate_cast_targets(), validate_hexproof_shroud_targets(), validate_protection_targets(), PlayerState, validate_cast_targets(), validate_protection_targets(), test_choose_two_validator() (+8 more)
...
Cohesion: 0.21
Nodes (13): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), serialize_match(), _state(), test_day_night_starts_at_upkeep_after_no_spells() (+5 more)
...
Cohesion: 0.21
Nodes (11): apply_state_based_actions(), apply_state_based_actions(), _setup_permanent(), test_indestructible_grant_prevents_combat_lethal_death(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_legend_rule_applies_for_offline_named_legendary_permanents() (+3 more)
...
Cohesion: 0.29
Nodes (7): extract_activated_abilities(), Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface.
...
Cohesion: 0.33
Nodes (4): test_attack_is_declared_once_per_combat_step(), test_deal_damage_to_creature_marks_damage_not_toughness(), test_prevent_damage_shield_reduces_creature_damage(), test_prevent_damage_shield_reduces_player_damage()
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 14`, `Community 15`, `Community 18`, `Community 21`, `Community 33`, `Community 34`, `Community 44`, `Community 46`, `Community 48`, `Community 51`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 70`, `Community 86`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 2` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 14`, `Community 15`, `Community 16`, `Community 20`, `Community 24`, `Community 26`, `Community 28`, `Community 32`, `Community 39`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 51`, `Community 58`, `Community 61`, `Community 66`, `Community 70`, `Community 74`, `Community 78`, `Community 83`, `Community 86`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `emit_event()` connect `Community 16` to `Community 32`, `Community 65`, `Community 66`, `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 26`, `Community 8`, `Community 74`, `Community 47`, `Community 15`, `Community 19`, `Community 22`, `Community 90`, `Community 61`, `Community 63`?**
