...
## Corpus Check
- 143 files · ~375,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1716 nodes · 4610 edges · 96 communities (94 shown, 2 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2147 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9f088ec`
...
- `test_static_you_cant_cast_spells_during_combat_enforced()` --calls--> `RulesEngine`  [INFERRED]
  backend/tests/test_restrictions.py → backend/rules_engine/engine.py
- `test_cast_spell_rejects_if_cost_unpaid()` --calls--> `RulesEngine`  [INFERRED]
  backend/tests/test_mana_system.py → backend/rules_engine/engine.py

## Communities (96 total, 2 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (56): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage. (+48 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (53): _auto_bottom_cards(), apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost() (+45 more)
...
Cohesion: 0.06
Nodes (33): _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _is_full_ai_match(), next_game(), _post_step_finalize() (+25 more)
...
Cohesion: 0.1
Nodes (24): AIAgent, _card_looks_like_land(), _step_key(), start_match(), guess_archetype(), test_aggro_ai_prefers_creature_development_over_burn_early(), test_ai_avoids_mana_tap_loop_when_no_cast_available(), test_ai_does_not_treat_mana_creature_as_land_in_forced_land_logic() (+16 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (29): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), _batch_seed(), _extract_turn_summaries() (+21 more)

### Community 9 - "Community 9"
Cohesion: 0.16
Nodes (41): combat_damage(), declare_blockers(), from_decks(), inspect_target_hints(), combat_damage(), declare_blockers(), from_decks(), MatchState (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (15): copy_ability(), copy_spell(), _copy_stack_object(), create_token(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments(), destroy_all_enchantments(), _destroy_all_permanents_of_types() (+7 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (32): _hydrate_deck_cards(), fallback_card_payload(), ensure_placeholder_image(), _family(), _svg_for(), _cache_remote_token_image(), _extract_image_uri(), resolve_token_image_uri() (+24 more)
...
Cohesion: 0.07
Nodes (22): RulesEngine, test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_engine_upkeep_start_enqueues_begin_step_triggers(), test_cast_spell_rejects_if_cost_unpaid(), test_mana_pool_empties_on_step_transition() (+14 more)
...
Cohesion: 0.2
Nodes (29): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), CardInstance, test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing() (+21 more)

### Community 18 - "Community 18"
Cohesion: 0.13
Nodes (12): draw_cards(), RulesEngine, draw_card(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th (+4 more)
...
Cohesion: 0.13
Nodes (21): build_cast_hints(), check_cost_option_available(), compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_attack_is_declared_once_per_combat_step(), test_additional_land_effect_text_allows_second_land_same_turn() (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.15
Nodes (25): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _max_attackers_blockable_by_creature(), _minimum_blockers_required(), _remove_dead_creatures(), has_keyword() (+17 more)
...
Cohesion: 0.12
Nodes (21): _has_any_target_options(), _is_land_card(), card_cant_attack(), card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers(), _defender_label() (+13 more)

### Community 29 - "Community 29"
Cohesion: 0.12
Nodes (6): AIDecision, AIDecision, _card_looks_like_land(), parse_mana_cost(), test_control_ai_mulligan_counts_land_with_missing_types_from_oracle(), test_control_ai_mulligans_land_light_hand()

### Community 30 - "Community 30"
Cohesion: 0.15
Nodes (16): simulate_batch_start(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), MatchState, Zone (+8 more)

### Community 31 - "Community 31"
Cohesion: 0.13
Nodes (20): destroy_all_creatures(), destroy_permanent(), gain_life(), lose_life(), sacrifice(), apply_damage_replacements(), replace_draw_cards(), replace_gain_life() (+12 more)
...
Cohesion: 0.16
Nodes (17): enrich_divide_total(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints(), test_non_divide_x_spell_does_not_auto_set_divide_total(), test_build_cast_hints_exposes_face_selection_schema() (+9 more)
...
Cohesion: 0.18
Nodes (16): _collect_triggers(), emit_event(), _first_number(), _maybe_payload(), _order_apnap(), _trigger_from_oracle(), destroy_permanent(), sacrifice() (+8 more)
...
Cohesion: 0.23
Nodes (8): FakeRepo, test_ai_diagnostics_reports_matchup_metrics(), FakeRepo, test_ai_diagnostics_reports_matchup_metrics(), test_compare_replay_logs_labels_cast_resolution_error(), test_compare_replay_logs_labels_pass_vs_action_root_cause(), test_compare_replay_logs_reports_first_divergence(), test_scan_log_tracks_stall_and_land_window_anomalies()
...
Cohesion: 0.19
Nodes (12): _deal_unblocked_damage(), _mark_creature_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), prevent_damage() (+4 more)
...
Cohesion: 0.29
Nodes (6): apply_state_based_actions(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_ai_prefers_attack_on_open_board(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery()
...
Cohesion: 0.48
Nodes (6): _classify_divergence_category(), classify_first_divergence(), classify_log_line(), first_log_divergence(), normalize_log_line(), compare_replay_logs()
...
- **Why does `AIAgent` connect `Community 2` to `Community 32`, `Community 64`, `Community 68`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 43`, `Community 14`, `Community 15`, `Community 47`, `Community 49`, `Community 61`, `Community 23`, `Community 24`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 38`, `Community 42`, `Community 43`, `Community 45`, `Community 47`, `Community 49`, `Community 64`, `Community 68`, `Community 83`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 9` to `Community 0`, `Community 1`, `Community 7`, `Community 11`, `Community 14`, `Community 17`, `Community 18`, `Community 21`, `Community 24`, `Community 25`, `Community 30`, `Community 35`, `Community 37`, `Community 38`, `Community 45`, `Community 64`, `Community 68`, `Community 79`, `Community 83`?**
