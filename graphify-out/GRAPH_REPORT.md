...
## Corpus Check
- 166 files · ~430,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2254 nodes · 5923 edges · 112 communities (110 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2672 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c05b7a5d`
...
1. `AIAgent` - 233 edges
2. `RulesEngine` - 148 edges
3. `from_decks()` - 143 edges
4. `CardInstance` - 138 edges
5. `from_decks()` - 136 edges
6. `AIAgent` - 87 edges
7. `RulesEngine` - 79 edges
8. `Repository` - 75 edges
9. `resolve_effect()` - 74 edges
...
Cohesion: 0.05
Nodes (54): check_cost_option_available(), compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, test_discard_additional_cost_is_paid() (+46 more)
...
Cohesion: 0.05
Nodes (55): ai_diagnostics(), analytics_history(), apply_sideboard(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _ensure_builtin_decks(), _ensure_expansion_top_decks() (+47 more)
...
Cohesion: 0.06
Nodes (53): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+45 more)
...
Cohesion: 0.05
Nodes (23): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), cycle_search(), deal_damage_multi(), destroy_all_artifacts(), destroy_all_artifacts_and_enchantments() (+15 more)
...
Cohesion: 0.17
Nodes (39): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, MatchController, PriorityStopsRequest (+31 more)
...
Cohesion: 0.12
Nodes (46): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing() (+38 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (18): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa (+10 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (18): import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), DeckService, ai_diagnostics(), _ensure_builtin_decks(), _ensure_expansion_top_decks() (+10 more)
...
Cohesion: 0.1
Nodes (16): card_completeness(), list_cards(), Report cached metadata and asset gaps for a deck's distinct card names., suggest_card(), get_with_backoff(), CardService, ScryfallSyncService, _BlankCachedCard (+8 more)
...
Cohesion: 0.19
Nodes (36): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), apply_state_based_actions(), from_decks(), _setup_creature() (+28 more)
...
Cohesion: 0.1
Nodes (35): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _creature_is_lethally_damaged(), declare_attackers(), _defender_label(), _max_attackers_blockable_by_creature(), _minimum_blockers_required(), _remove_dead_creatures() (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.1
Nodes (26): _hydrate_deck_cards(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload(), _fallback_name_aliases(), _normalize_card_name(), ensure_placeholder_image(), _family() (+18 more)
...
Cohesion: 0.11
Nodes (11): RulesEngine, draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life(), test_summoning_sickness_cleared_only_for_old_creatures() (+3 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (21): Apply a selected face to a battlefield double-faced permanent., transform_card(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types() (+13 more)

### Community 25 - "Community 25"
Cohesion: 0.14
Nodes (24): emit_event(), _order_apnap(), destroy_permanent(), sacrifice(), resolve_top_of_stack(), add_to_stack(), resolve_top_of_stack(), StackItem (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.14
Nodes (27): Backend tests, code:bash (cd frontend), Frontend, Frontend, Frontend, Frontend, Frontend, Frontend (+19 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (25): destroy_all_creatures(), destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), draw_cards(), gain_life(), replace_draw_cards(), replace_gain_life() (+17 more)

### Community 28 - "Community 28"
Cohesion: 0.22
Nodes (25): effective_power(), effective_toughness(), _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_indestructible_grant_prevents_combat_lethal_death(), test_opponent_static_minus_kills_x1_creature() (+17 more)

### Community 29 - "Community 29"
Cohesion: 0.08
Nodes (25): resolve_effect(), Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage. (+17 more)

### Community 30 - "Community 30"
Cohesion: 0.08
Nodes (26): 3) Frontend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (22): resolve_effect(), test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage., test_create_token_respects_amount_and_keywords(), test_deal_damage_cumulative_lethal() (+14 more)
...
Cohesion: 0.18
Nodes (21): autoplay_tick(), _human_priority_pause(), _is_full_ai_match(), init_db(), autoplay_tick(), _human_priority_pause(), _is_full_ai_match(), _start_next_game_state() (+13 more)

### Community 35 - "Community 35"
Cohesion: 0.13
Nodes (5): Choose a bounded tactical horizon without making every turn expensive., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active.

### Community 36 - "Community 36"
Cohesion: 0.13
Nodes (23): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+15 more)
...
Cohesion: 0.18
Nodes (15): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback() (+7 more)
...
Cohesion: 0.16
Nodes (16): _deal_unblocked_damage(), _mark_creature_damage(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage() (+8 more)
...
Cohesion: 0.23
Nodes (13): attach_if_legal(), attached_to(), is_aura(), is_equipment(), _apply_attachment_state_checks(), _apply_legend_rule(), apply_state_based_actions(), _is_legendary() (+5 more)
...
Cohesion: 0.24
Nodes (11): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match_snapshot(), _tupleize(), _state(), test_day_night_starts_at_upkeep_after_no_spells(), test_day_night_transforms_matching_double_faced_permanents(), test_day_night_transitions_only_on_zero_or_two_spells() (+3 more)
...
Cohesion: 0.19
Nodes (14): _remaining_lethal_damage(), _all_battlefield_ids(), _continuous_pt_delta(), _counter_pt_delta(), effective_keywords(), effective_power(), effective_toughness(), _has_subtype() (+6 more)

### Community 61 - "Community 61"
Cohesion: 0.21
Nodes (10): card_color_names(), _combat_damage_step(), _damage_prevented_by_protection(), protected_from_source(), protection_match_reason(), _protection_tokens(), _damage_prevented_by_protection(), protected_from_source() (+2 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 13`, `Community 24`, `Community 25`, `Community 32`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 44`, `Community 49`, `Community 50`, `Community 59`, `Community 64`, `Community 72`, `Community 87`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 17`, `Community 18`, `Community 19`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 31`, `Community 34`, `Community 37`, `Community 41`, `Community 43`, `Community 44`, `Community 45`, `Community 50`, `Community 53`, `Community 57`, `Community 72`, `Community 73`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 18` to `Community 1`, `Community 34`, `Community 4`, `Community 6`, `Community 39`, `Community 73`, `Community 12`, `Community 45`, `Community 48`, `Community 17`, `Community 50`, `Community 84`, `Community 53`, `Community 23`, `Community 24`, `Community 25`, `Community 28`, `Community 31`?**
...
- **Are the 139 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 139 INFERRED edges - model-reasoned connections that need verification._
- **Are the 135 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 135 INFERRED edges - model-reasoned connections that need verification._
