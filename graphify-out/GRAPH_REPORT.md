...
## Corpus Check
- 168 files · ~431,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2279 nodes · 5984 edges · 108 communities (107 shown, 1 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2701 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f206a66`
...
1. `AIAgent` - 233 edges
2. `RulesEngine` - 150 edges
3. `CardInstance` - 143 edges
...
Cohesion: 0.05
Nodes (55): apply_additional_costs(), _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land(), _is_land_card(), Zone (+47 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (44): legal_moves(), Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_additional_land_effect_text_allows_second_land_same_turn(), test_engine_rejects_play_land_when_player_is_not_active() (+36 more)
...
Cohesion: 0.09
Nodes (54): apply_cost_modifiers(), apply_replacement_effects(), CostContext, ReplacementContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands() (+46 more)
...
Cohesion: 0.06
Nodes (43): apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+35 more)
...
Cohesion: 0.11
Nodes (50): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing(), test_oracle_multiclause_sequence_parsing() (+42 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (28): check_cost_option_available(), _auto_bottom_cards(), RulesEngine, compute_max_land_plays_this_turn(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana() (+20 more)
...
Cohesion: 0.08
Nodes (40): collect_cost_options(), CostOption, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), resolve_effect() (+32 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (42): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), declare_attackers(), _defender_label() (+34 more)
...
Cohesion: 0.11
Nodes (39): create_shark_token(), create_token(), discard_cards(), emit_event(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text() (+31 more)
...
Cohesion: 0.11
Nodes (4): Choose a bounded tactical horizon without making every turn expensive., _step_key(), should_force_closure(), should_force_inevitability_line()
...
Cohesion: 0.11
Nodes (7): _card_looks_like_land(), _cmc(), topdeck_put_creatures_battlefield(), parse_mana_cost(), _auto_bottom_cards(), mana_value(), parse_mana_cost()

### Community 31 - "Community 31"
Cohesion: 0.14
Nodes (28): Backend tests, code:bash (cd frontend), Frontend, Frontend, Frontend, Frontend, Frontend, Frontend (+20 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (27): 3) Frontend, Backend, Backend, Backend, Backend, Backend, Backend, Backend (+19 more)

### Community 33 - "Community 33"
Cohesion: 0.17
Nodes (25): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., Return PT bonus from +1/+1 and -1/-1 counters on a card., Return PT bonus from +1/+1 and -1/-1 counters on a card., Return PT bonus from +1/+1 and -1/-1 counters on a card., Return PT bonus from +1/+1 and -1/-1 counters on a card. (+17 more)
...
Cohesion: 0.12
Nodes (24): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+16 more)

### Community 36 - "Community 36"
Cohesion: 0.12
Nodes (23): destroy_all_creatures(), destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), draw_cards(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements() (+15 more)

### Community 37 - "Community 37"
Cohesion: 0.13
Nodes (21): _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., apply_state_based_actions(), apply_state_based_actions(), +1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin, _setup_creature() (+13 more)

### Community 38 - "Community 38"
Cohesion: 0.15
Nodes (18): MatchState, AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, build_cast_hints(), validate_cast_choice(), test_ability_model_exposes_effect_targets_modes_and_choices() (+10 more)
...
Cohesion: 0.22
Nodes (17): build_cast_hints(), enrich_divide_total(), inspect_target_hints(), enrich_divide_total(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed() (+9 more)
...
Cohesion: 0.18
Nodes (16): emit_event(), _order_apnap(), StackItem, destroy_permanent(), gain_life(), sacrifice(), replace_gain_life(), add_to_stack() (+8 more)
...
Cohesion: 0.23
Nodes (12): deserialize_match_snapshot(), Serialize all mutable rules state needed to resume a match., serialize_match(), serialize_match_snapshot(), _tupleize(), _state(), test_day_night_starts_at_upkeep_after_no_spells(), test_day_night_transforms_matching_double_faced_permanents() (+4 more)
...
Cohesion: 0.26
Nodes (12): _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_creature_is_filtered_from_attackers(), test_must_attack_if_able_auto_added_when_omitted(), _setup_creature(), test_cant_attack_alone_enforced(), test_cant_attack_alone_not_treated_as_global_cant_attack(), test_cant_attack_creature_is_filtered_from_attackers() (+4 more)
...
Cohesion: 0.33
Nodes (4): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active.
...
Cohesion: 0.67
Nodes (3): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering.

### Community 88 - "Community 88"
Cohesion: 0.67
Nodes (3): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., transform_card()

### Community 89 - "Community 89"
Cohesion: 0.67
Nodes (3): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., transform_if_top_matches()
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 18`, `Community 22`, `Community 24`, `Community 25`, `Community 27`, `Community 30`, `Community 38`, `Community 39`, `Community 45`, `Community 47`, `Community 53`, `Community 57`, `Community 59`, `Community 72`, `Community 76`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 4` to `Community 0`, `Community 3`, `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 27`, `Community 29`, `Community 33`, `Community 37`, `Community 38`, `Community 39`, `Community 47`, `Community 50`, `Community 59`, `Community 60`, `Community 62`, `Community 72`, `Community 75`, `Community 85`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 11` to `Community 67`, `Community 4`, `Community 37`, `Community 38`, `Community 36`, `Community 41`, `Community 42`, `Community 12`, `Community 46`, `Community 79`, `Community 16`, `Community 50`, `Community 19`, `Community 20`, `Community 85`, `Community 59`, `Community 29`, `Community 63`?**
...
- **Are the 142 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 142 INFERRED edges - model-reasoned connections that need verification._
- **Are the 136 inferred relationships involving `RulesEngine` (e.g. with `MatchController` and `DeckImportRequest`) actually correct?**
  _`RulesEngine` has 136 INFERRED edges - model-reasoned connections that need verification._
- **Are the 141 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 141 INFERRED edges - model-reasoned connections that need verification._