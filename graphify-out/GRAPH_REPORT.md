...
## Corpus Check
- 170 files · ~433,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2299 nodes · 6020 edges · 112 communities (110 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2713 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5aa15544`
...
Cohesion: 0.05
Nodes (47): ai_diagnostics(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+39 more)
...
Cohesion: 0.11
Nodes (34): check_cost_option_available(), RulesEngine, from_decks(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_discard_additional_cost_is_paid(), test_cannot_target_creature_with_protection_from_source_color() (+26 more)
...
Cohesion: 0.11
Nodes (39): create_shark_token(), create_token(), discard_cards(), emit_event(), _order_apnap(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your() (+31 more)
...
Cohesion: 0.07
Nodes (18): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Evaluate small-board blocker assignments by resolving cloned combat., Depth-limited stack planner for counter wars; only runs while stack is active., Resolve simulated abilities only when the opponent has no response., Resolve simulated abilities only when the opponent has no response. (+10 more)
...
Cohesion: 0.11
Nodes (32): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), declare_attackers(), _defender_label(), _max_attackers_blockable_by_creature(), _minimum_blockers_required() (+24 more)
...
Cohesion: 0.19
Nodes (24): deal_damage(), CardInstance, test_master_block_search_prevents_lethal_damage_when_trade_is_available(), _state(), test_combat_only_override_applies_to_combat_damage(), test_named_source_override_does_not_unlock_other_sources(), test_target_permanent_can_have_damage_prevention_override(), test_target_player_can_have_damage_prevention_override() (+16 more)

### Community 34 - "Community 34"
Cohesion: 0.15
Nodes (21): exile_permanent(), StackItem, add_to_stack(), resolve_top_of_stack(), add_to_stack(), _state_with_cycler(), test_cycling_discard_cost_emits_discard_trigger_before_cycle_draw(), test_cycling_draw_uses_draw_replacement_effects() (+13 more)
...
Cohesion: 0.13
Nodes (14): compute_max_land_plays_this_turn(), resolve_top_of_stack(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_summoning_sickness_cleared_only_for_old_creatures() (+6 more)

### Community 38 - "Community 38"
Cohesion: 0.13
Nodes (22): build_cast_hints(), _extract_modes(), inspect_target_hints(), inspect_target_hints(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text(), test_shark_typhoon_does_not_require_x_value_for_cast() (+14 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (22): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), choose_mana_color_for_player(), _choose_any_permanent_target(), _choose_noncreature_permanent_target() (+14 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (16): _mark_creature_damage(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield() (+8 more)
...
Cohesion: 0.17
Nodes (16): enrich_divide_total(), validate_cast_choice(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), test_non_divide_x_spell_does_not_auto_set_divide_total(), _state(), test_aura_target_restrictions_are_exposed_and_carried_to_stack_payload() (+8 more)
...
Cohesion: 0.19
Nodes (11): AbilitySpec, build_ability_spec(), EffectSpec, Stable application-level representation of a card action.      The parser remain, test_ability_model_exposes_effect_targets_modes_and_choices(), test_ability_model_marks_unparsed_action_text_as_fallback(), test_planeswalker_static_and_loyalty_text_is_not_cast_time_fallback(), _state() (+3 more)
...
Cohesion: 0.18
Nodes (9): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., transform_card(), transform_if_top_matches() (+1 more)
...
Cohesion: 0.29
Nodes (9): _can_cast_spell(), _has_any_target_options(), _is_land_card(), _can_cast_spell(), _extract_equip_cost(), _has_any_target_options(), _is_land_card(), legal_moves() (+1 more)
...
Cohesion: 0.25
Nodes (7): test_aura_without_target_goes_to_graveyard(), test_replacement_gain_life_to_draw_cards(), test_timing_restriction_first_main_phase_only(), test_hexproof_blocks_opponent_targeted_spell(), test_replacement_gain_life_to_draw_cards(), test_timing_restriction_first_main_phase_only(), test_ward_tax_blocks_underpaid_targeted_spell()
...
Cohesion: 0.33
Nodes (7): _deal_unblocked_damage(), consume_player_prevention_shield(), _deal_unblocked_damage(), test_unblocked_damage_to_removed_planeswalker_disappears(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam, When an unblocked attacker targets a PW that leaves the battlefield,     the dam, test_unblocked_damage_to_removed_planeswalker_disappears()
...
- **Why does `AIAgent` connect `Community 0` to `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 21`, `Community 23`, `Community 26`, `Community 29`, `Community 33`, `Community 34`, `Community 36`, `Community 41`, `Community 48`, `Community 52`, `Community 60`, `Community 88`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 7` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 23`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 34`, `Community 37`, `Community 41`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 56`, `Community 77`, `Community 86`, `Community 88`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 33` to `Community 34`, `Community 66`, `Community 35`, `Community 4`, `Community 38`, `Community 7`, `Community 68`, `Community 43`, `Community 44`, `Community 14`, `Community 47`, `Community 16`, `Community 49`, `Community 18`, `Community 53`, `Community 22`, `Community 63`?**
...
- **Are the 144 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 144 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 144 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 144 INFERRED edges - model-reasoned connections that need verification._