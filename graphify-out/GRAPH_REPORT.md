...
## Corpus Check
- 140 files · ~369,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1607 nodes · 4384 edges · 97 communities (93 shown, 4 thin omitted)
- Extraction: 52% EXTRACTED · 48% INFERRED · 0% AMBIGUOUS · INFERRED: 2097 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be4f8311`
...
Cohesion: 0.06
Nodes (42): ai_diagnostics(), apply_sideboard(), _card_looks_like_land(), _default_player_for_state(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), _force_ai_land_action(), get_expansion_top_deck() (+34 more)
...
Cohesion: 0.1
Nodes (32): check_cost_option_available(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), from_decks(), test_discard_additional_cost_is_paid(), test_attack_is_declared_once_per_combat_step(), test_indestructible_grant_prevents_combat_lethal_death() (+24 more)
...
Cohesion: 0.09
Nodes (14): RulesEngine, test_cannot_target_creature_with_protection_from_source_color(), test_invalid_x_target_choice_does_not_spend_mana(), test_land_named_card_cannot_be_cast_as_spell(), test_london_mulligan_flow_completes_pregame(), When an unblocked attacker targets a PW that leaves the battlefield,     the dam, test_attack_can_target_planeswalker_and_reduce_loyalty(), test_unblocked_damage_to_removed_planeswalker_disappears() (+6 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (11): Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, Push control decks to convert resources instead of over-passing in developed boa, _step_key() (+3 more)

### Community 16 - "Community 16"
Cohesion: 0.17
Nodes (28): _creature_value(), _combat_damage_step(), _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers() (+20 more)
...
Cohesion: 0.11
Nodes (20): simulate_batch_start(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState (+12 more)
...
Cohesion: 0.17
Nodes (10): RulesEngine, compute_max_land_plays_this_turn(), draw_card(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life() (+2 more)
...
Cohesion: 0.15
Nodes (9): _board_value(), evaluate_board(), evaluate_inevitability(), _noncreature_value(), _planeswalker_count(), evaluate_board(), test_control_ai_prefers_removal_against_evasive_threat(), test_evaluate_board_penalizes_opponent_planeswalker_pressure() (+1 more)
...
Cohesion: 0.17
Nodes (5): import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck(), DeckService
...
Cohesion: 0.13
Nodes (15): draw_cards(), gain_life(), lose_life(), draw_card(), apply_damage_replacements(), replace_draw_cards(), replace_gain_life(), apply_damage_replacements() (+7 more)
...
Cohesion: 0.22
Nodes (9): _infer_mana_from_land(), _is_land_card(), pass_priority(), _auto_bottom_cards(), _extract_equip_cost_text(), _infer_mana_from_land(), _is_land_card(), _land_colors_from_metadata() (+1 more)
...
Cohesion: 0.33
Nodes (7): apply_state_based_actions(), apply_state_based_actions(), test_opponent_static_minus_kills_x1_creature(), test_legend_rule_is_per_controller_not_global(), test_legend_rule_moves_duplicate_legendary_to_graveyard(), test_legend_rule_applies_for_offline_named_legendary_permanents(), test_ossification_is_inferred_as_enchantment_not_sorcery()
...
Cohesion: 0.36
Nodes (5): _DummyRepo, test_batch_does_not_auto_award_unresolved_games_to_deck_a(), _DummyRepo, test_batch_does_not_auto_award_unresolved_games_to_deck_a(), test_batch_is_deterministic_for_same_inputs()
...
- **Why does `AIAgent` connect `Community 3` to `Community 1`, `Community 34`, `Community 2`, `Community 4`, `Community 68`, `Community 38`, `Community 6`, `Community 70`, `Community 7`, `Community 42`, `Community 46`, `Community 15`, `Community 14`, `Community 20`, `Community 21`, `Community 25`, `Community 28`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 13`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 38`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 48`, `Community 59`, `Community 68`, `Community 70`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 13` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 14`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 24`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 40`, `Community 43`, `Community 44`, `Community 60`, `Community 70`?**
