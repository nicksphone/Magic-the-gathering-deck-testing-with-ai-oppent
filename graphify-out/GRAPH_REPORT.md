...
## Corpus Check
- 141 files · ~372,479 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1667 nodes · 4500 edges · 94 communities (91 shown, 3 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2127 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36941527`
...
Cohesion: 0.09
Nodes (54): _auto_bottom_cards(), topdeck_put_creatures_battlefield(), apply_cost_modifiers(), CostContext, add_generic_to_cost(), _apply_generic_delta_to_cost(), auto_pay_cost(), can_pay_with_pool_and_lands() (+46 more)
...
Cohesion: 0.06
Nodes (39): ai_diagnostics(), _card_looks_like_land(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match(), _hydrate_deck_cards(), _is_full_ai_match() (+31 more)
...
Cohesion: 0.09
Nodes (33): from_decks(), compute_max_land_plays_this_turn(), resolve_effect(), apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it. (+25 more)
...
Cohesion: 0.09
Nodes (28): resolve_effect(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., test_deal_damage_cumulative_lethal(), test_deal_damage_non_lethal_doesnt_kill(), Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Indestructible creatures should survive lethal spell damage. (+20 more)
...
Cohesion: 0.12
Nodes (22): card_color_names(), deal_damage(), deal_damage_multi(), prevent_damage(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage() (+14 more)
...
Cohesion: 0.14
Nodes (26): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage() (+18 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (25): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), validate_cast_choice() (+17 more)

### Community 25 - "Community 25"
Cohesion: 0.12
Nodes (22): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _infer_mana_from_land() (+14 more)
...
Cohesion: 0.2
Nodes (22): _creature_value(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., _base_pt_with_layers(), effective_power(), effective_toughness() (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.17
Nodes (21): destroy_all_creatures(), destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), emit_event(), Return destination zone for a dying creature: 'graveyard' or 'exile'., Return destination zone for a dying creature: 'graveyard' or 'exile'., replace_die_zone() (+13 more)

### Community 31 - "Community 31"
Cohesion: 0.16
Nodes (18): classify_first_divergence(), classify_log_line(), first_log_divergence(), normalize_log_line(), compare_replay_logs(), get_match_replay(), classify_first_divergence(), classify_log_line() (+10 more)

### Community 32 - "Community 32"
Cohesion: 0.11
Nodes (16): draw_cards(), gain_life(), lose_life(), draw_card(), draw_cards(), gain_life(), apply_damage_replacements(), replace_draw_cards() (+8 more)
...
Cohesion: 0.25
Nodes (10): _can_cast_spell(), _has_any_target_options(), _is_land_card(), _can_cast_spell(), _extract_equip_cost(), _has_any_target_options(), _is_land_card(), legal_moves() (+2 more)
...
- **Why does `AIAgent` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 65`, `Community 4`, `Community 5`, `Community 38`, `Community 6`, `Community 39`, `Community 44`, `Community 49`, `Community 18`, `Community 21`, `Community 22`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 25`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 37`, `Community 44`, `Community 62`, `Community 65`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 9` to `Community 32`, `Community 65`, `Community 0`, `Community 35`, `Community 33`, `Community 2`, `Community 37`, `Community 1`, `Community 6`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 22`, `Community 24`, `Community 29`, `Community 30`?**
