...
## Corpus Check
- 170 files · ~432,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2297 nodes · 6012 edges · 113 communities (111 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2709 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6de5ecbf`
...
## Communities (113 total, 2 thin omitted)
...
Cohesion: 0.05
Nodes (51): analytics_history(), apply_sideboard(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves() (+43 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (58): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _auto_bottom_cards() (+50 more)
...
Cohesion: 0.06
Nodes (37): Apply the core day/night turn-count rule at the beginning of upkeep., Apply the core day/night turn-count rule at the beginning of upkeep., RulesEngine, draw_card(), test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped() (+29 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (46): attach_if_legal(), attached_to(), is_aura(), is_equipment(), emit_event(), _order_apnap(), destroy_permanent(), sacrifice() (+38 more)
...
Cohesion: 0.09
Nodes (45): create_shark_token(), create_token(), destroy_permanent(), discard_cards(), exile_permanent(), sacrifice(), StackItem, emit_event() (+37 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (27): build_cast_hints(), check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), test_cannot_target_creature_with_protection_from_source_color() (+19 more)
...
Cohesion: 0.11
Nodes (26): draw_cards(), resolve_effect(), replace_draw_cards(), apply_state_based_actions(), from_decks(), MatchState, test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect() (+18 more)
...
Cohesion: 0.09
Nodes (20): ai_diagnostics(), _ensure_builtin_decks(), _ensure_expansion_top_decks(), get_expansion_top_deck(), import_all_expansion_top_decks(), import_deck(), import_deck_file(), import_expansion_top_deck() (+12 more)
...
Cohesion: 0.16
Nodes (26): autoplay_tick(), _human_priority_pause(), lifespan(), MatchController, _restore_active_matches(), init_db(), autoplay_tick(), _human_priority_pause() (+18 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (28): enrich_divide_total(), validate_cast_choice(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes(), inspect_target_hints() (+20 more)
...
Cohesion: 0.18
Nodes (28): effective_power(), effective_toughness(), apply_state_based_actions(), _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_indestructible_grant_prevents_combat_lethal_death() (+20 more)
...
Cohesion: 0.29
Nodes (5): test_attack_can_target_planeswalker_and_reduce_loyalty(), test_planeswalker_loyalty_ability_appears_in_legal_moves(), test_unblocked_damage_to_removed_planeswalker_disappears(), test_attack_can_target_planeswalker_and_reduce_loyalty(), test_planeswalker_loyalty_ability_appears_in_legal_moves()
...
Cohesion: 0.27
Nodes (6): Spell damage should kill creatures — state-based lethal check after damage., Spell damage should kill creatures — state-based lethal check after damage., test_deal_damage_destroys_creature_with_lethal_damage(), Bug #8: resolve_effect should gracefully handle non-dict payloads., Bug #8: resolve_effect should gracefully handle non-dict payloads., test_resolve_effect_rejects_non_dict_payload()
...
- **Why does `AIAgent` connect `Community 0` to `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 17`, `Community 22`, `Community 26`, `Community 30`, `Community 35`, `Community 39`, `Community 40`, `Community 41`, `Community 45`, `Community 47`, `Community 53`, `Community 61`, `Community 66`, `Community 99`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 10` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 19`, `Community 21`, `Community 26`, `Community 28`, `Community 29`, `Community 35`, `Community 39`, `Community 40`, `Community 41`, `Community 47`, `Community 50`, `Community 51`, `Community 53`, `Community 66`, `Community 76`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 7` to `Community 33`, `Community 67`, `Community 99`, `Community 40`, `Community 41`, `Community 10`, `Community 11`, `Community 15`, `Community 48`, `Community 51`, `Community 27`, `Community 28`, `Community 29`, `Community 62`?**
...
- **Are the 143 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 143 INFERRED edges - model-reasoned connections that need verification._