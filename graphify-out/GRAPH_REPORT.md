...
## Corpus Check
- 142 files · ~374,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1703 nodes · 4585 edges · 96 communities (92 shown, 4 thin omitted)
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 2140 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98a06ef9`
...
Cohesion: 0.06
Nodes (52): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, test_discard_additional_cost_is_paid() (+44 more)
...
Cohesion: 0.06
Nodes (46): analyze_deck(), _card_text_matches(), _cmc(), guess_archetype(), _looks_like_creature_name(), _looks_like_land(), classify(), main() (+38 more)
...
Cohesion: 0.1
Nodes (31): from_decks(), MatchState, resolve_effect(), apply_state_based_actions(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), _put_trigger_creature() (+23 more)
...
Cohesion: 0.09
Nodes (27): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), _auto_bottom_cards() (+19 more)
...
Cohesion: 0.22
Nodes (29): combat_damage(), declare_blockers(), combat_damage(), declare_blockers(), from_decks(), MatchState, _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage() (+21 more)
...
Cohesion: 0.22
Nodes (27): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), CardInstance, test_non_divide_x_spell_does_not_auto_set_divide_total(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing() (+19 more)
...
Cohesion: 0.14
Nodes (23): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), inspect_target_hints(), build_cast_hints(), enrich_divide_total(), validate_cast_choice(), _extract_modes() (+15 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (22): _can_cast_spell(), _has_any_target_options(), _is_land_card(), card_cant_attack_alone(), card_cant_block(), card_must_attack_if_able(), card_must_block_if_able(), declare_attackers() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.21
Nodes (23): effective_power(), effective_toughness(), apply_state_based_actions(), _setup_creature(), _setup_permanent(), test_counters_affect_effective_stats_dynamically(), test_creatures_you_control_have_reach_allows_blocking_flyers(), test_opponent_static_minus_kills_x1_creature() (+15 more)
...
Cohesion: 0.14
Nodes (19): destroy_all_creatures(), destroy_permanent(), draw_cards(), gain_life(), lose_life(), sacrifice(), draw_card(), apply_damage_replacements() (+11 more)

### Community 31 - "Community 31"
Cohesion: 0.26
Nodes (14): autoplay_tick(), init_db(), autoplay_tick(), _ensure_card_faces_column(), init_db(), main(), test_autoplay_advances_to_next_game_for_full_ai_match(), test_autoplay_forces_ai_land_drop_on_own_main_phase() (+6 more)
...
Cohesion: 0.16
Nodes (16): simulate_batch_start(), Enum, _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), Zone (+8 more)
...
Cohesion: 0.22
Nodes (15): attach_if_legal(), attached_to(), is_aura(), is_equipment(), resolve_top_of_stack(), _apply_attachment_state_checks(), add_to_stack(), resolve_top_of_stack() (+7 more)
...
Cohesion: 0.18
Nodes (16): _collect_triggers(), emit_event(), _first_number(), _maybe_payload(), _order_apnap(), _trigger_from_oracle(), destroy_permanent(), gain_life() (+8 more)
...
Cohesion: 0.14
Nodes (13): _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard() (+5 more)
...
Cohesion: 0.31
Nodes (12): StackItem, emit_event(), add_to_stack(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event(), test_begin_end_step_triggers_only_for_active_player_when_oracle_says_your(), test_begin_upkeep_triggers_apply_apnap_for_each_upkeep_text(), test_creature_dies_trigger_does_not_match_opponent_creature() (+4 more)
...
## Knowledge Gaps
- **182 isolated node(s):** `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Push control decks to convert resources instead of over-passing in developed boa`, `Ingest external tournament event payloads into normalized local tables.      Exp`, `When an unblocked attacker targets a PW that leaves the battlefield,     the dam`, `Spell damage should kill creatures — state-based lethal check after damage.` (+177 more)
...
- **Why does `AIAgent` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 67`, `Community 8`, `Community 44`, `Community 13`, `Community 45`, `Community 17`, `Community 18`, `Community 52`, `Community 56`, `Community 28`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 13`, `Community 15`, `Community 19`, `Community 22`, `Community 26`, `Community 28`, `Community 31`, `Community 34`, `Community 35`, `Community 44`, `Community 45`, `Community 47`, `Community 64`, `Community 67`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 13` to `Community 0`, `Community 1`, `Community 34`, `Community 67`, `Community 36`, `Community 35`, `Community 3`, `Community 64`, `Community 40`, `Community 5`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 60`, `Community 30`, `Community 31`?**
