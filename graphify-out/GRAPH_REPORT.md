...
## Corpus Check
- 174 files · ~437,762 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2395 nodes · 6199 edges · 125 communities (121 shown, 4 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2777 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d931fb4`
...
Cohesion: 0.05
Nodes (60): apply_additional_costs(), collect_cost_options(), CostOption, _first_discardable_card(), _first_sacrificable_creature(), _join_costs(), normalize_cost_choice(), crew_vehicle() (+52 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (52): ai_diagnostics(), analytics_history(), apply_sideboard(), autoplay_tick(), card_completeness(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state() (+44 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (31): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), create_shark_token(), create_token(), cycle_search(), deal_damage_multi() (+23 more)
...
Cohesion: 0.06
Nodes (37): RulesEngine, test_discard_additional_cost_is_paid(), test_engine_rejects_play_land_when_player_is_not_active(), test_generates_basic_legal_moves(), test_land_named_card_is_not_offered_as_cast_spell_even_if_mistyped(), test_mana_creature_is_not_misclassified_as_land_from_oracle_text(), test_non_active_player_cannot_get_play_land_legal_move(), test_london_mulligan_flow_completes_pregame() (+29 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (49): CardInstance, infer_effect_from_oracle(), infer_effect_from_oracle(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing(), test_oracle_counterspell_parsing(), test_oracle_damage_parsing(), test_oracle_multiclause_sequence_parsing() (+41 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (28): check_cost_option_available(), RulesEngine, compute_max_land_plays_this_turn(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), draw_card(), test_cannot_target_creature_with_protection_from_source_color() (+20 more)
...
Cohesion: 0.08
Nodes (41): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _deal_unblocked_damage(), _defender_label(), _mark_creature_damage(), _max_attackers_blockable_by_creature() (+33 more)
...
Cohesion: 0.18
Nodes (38): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), apply_state_based_actions(), from_decks(), _setup_creature() (+30 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (38): destroy_permanent(), discard_cards(), sacrifice(), StackItem, emit_event(), add_to_stack(), test_sacrifice_handler_puts_stolen_creature_into_its_owners_graveyard(), _put_trigger_creature() (+30 more)
...
Cohesion: 0.1
Nodes (9): Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., Depth-limited stack planner for counter wars; only runs while stack is active., _step_key(), should_force_closure() (+1 more)
...
Cohesion: 0.18
Nodes (29): _remaining_lethal_damage(), _counter_pt_delta(), effective_power(), effective_toughness(), Return PT bonus from +1/+1 and -1/-1 counters on a card., effective_power(), effective_toughness(), _setup_creature() (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (27): _count_controlled_type(), gain_life(), lose_life(), _move_creature_to_graveyard(), draw_cards(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements() (+19 more)
...
Cohesion: 0.1
Nodes (24): cycle_draw(), draw_cards(), Resolve the draw portion of a fixed-cost cycling ability., Resolve the draw portion of a fixed-cost cycling ability., Enum, draw_card(), _infer_keywords(), _infer_loyalty() (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (23): resolve_effect(), Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats(), Sub-lethal damage should not kill the creature., Multiple damage instances should accumulate and kill., Spell damage should kill creatures — state-based lethal check after damage., Indestructible creatures should survive lethal spell damage., test_create_token_respects_amount_and_keywords() (+15 more)

### Community 34 - "Community 34"
Cohesion: 0.15
Nodes (21): attached_to(), is_aura(), is_equipment(), attach_if_legal(), attached_to(), attachment_target_is_legal(), is_aura(), is_equipment() (+13 more)
...
Cohesion: 0.15
Nodes (5): _card_looks_like_land(), _auto_bottom_cards(), add_generic_to_cost(), mana_value(), parse_mana_cost()

### Community 39 - "Community 39"
Cohesion: 0.15
Nodes (20): _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player() (+12 more)
...
Cohesion: 0.2
Nodes (18): build_cast_hints(), enrich_divide_total(), inspect_target_hints(), enrich_divide_total(), _extract_modes(), inspect_target_hints(), CardInstance, test_memory_deluge_does_not_require_x_value_for_cast() (+10 more)

### Community 44 - "Community 44"
Cohesion: 0.15
Nodes (14): attach_if_legal(), prevent_damage(), _creature_is_lethally_damaged(), deal_damage(), deal_damage_multi(), _move_creature_to_graveyard(), prevent_damage(), add_card_prevention_shield() (+6 more)

### Community 45 - "Community 45"
Cohesion: 0.15
Nodes (18): emit_event(), _order_apnap(), destroy_permanent(), gain_life(), sacrifice(), replace_gain_life(), add_to_stack(), resolve_top_of_stack() (+10 more)
...
Cohesion: 0.22
Nodes (15): build_cast_hints(), validate_cast_choice(), _state_with_target(), test_bounce_ability_spec_is_not_marked_as_oracle_fallback(), test_bounce_inference_exposes_nonland_permanent_targets(), test_bounce_rejects_card_outside_current_target_candidates(), test_bounce_returns_stolen_permanent_to_owner_hand_and_clears_control(), test_build_cast_hints_exposes_face_selection_schema() (+7 more)
...
## Knowledge Gaps
- **362 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+357 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 16`, `Community 20`, `Community 22`, `Community 23`, `Community 30`, `Community 32`, `Community 36`, `Community 38`, `Community 40`, `Community 41`, `Community 42`, `Community 46`, `Community 48`, `Community 49`, `Community 52`, `Community 55`, `Community 64`, `Community 71`, `Community 75`, `Community 103`, `Community 106`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 9` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 16`, `Community 17`, `Community 19`, `Community 23`, `Community 26`, `Community 32`, `Community 33`, `Community 34`, `Community 40`, `Community 41`, `Community 42`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 71`, `Community 84`, `Community 85`, `Community 93`, `Community 103`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `emit_event()` connect `Community 17` to `Community 32`, `Community 34`, `Community 3`, `Community 5`, `Community 101`, `Community 9`, `Community 10`, `Community 76`, `Community 45`, `Community 14`, `Community 48`, `Community 16`, `Community 21`, `Community 27`, `Community 93`, `Community 62`?**
...
- **Are the 148 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 148 INFERRED edges - model-reasoned connections that need verification._
