...
## Corpus Check
- 174 files · ~438,623 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2409 nodes · 6232 edges · 129 communities (127 shown, 2 thin omitted)
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2790 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8403f44`
...
Cohesion: 0.05
Nodes (54): check_cost_option_available(), RulesEngine, draw_cards(), legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, draw_card() (+46 more)
...
Cohesion: 0.05
Nodes (46): analytics_history(), apply_sideboard(), _card_looks_like_land(), _controller_snapshot(), _default_player_for_state(), _force_ai_land_action(), get_legal_moves(), get_match() (+38 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (49): ActionRequest, BatchSimulationJobStartResponse, BatchSimulationJobStatusResponse, BulkSyncRequest, DeckAnalyzeRequest, DeckImportRequest, ingest_tournament_json(), PriorityStopsRequest (+41 more)
...
Cohesion: 0.06
Nodes (21): get_repo(), get_repo(), sync_card(), CardCache, DeckRecord, MatchRecord, StatsSnapshot, ActiveMatchRecord (+13 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (26): add_counters(), copy_ability(), copy_spell(), _copy_stack_object(), _creature_is_lethally_damaged(), cycle_search(), deal_damage_multi(), destroy_all_artifacts() (+18 more)
...
Cohesion: 0.1
Nodes (42): create_shark_token(), create_token(), discard_cards(), StackItem, emit_event(), add_to_stack(), _put_trigger_creature(), test_apnap_trigger_order_on_shared_event() (+34 more)
...
Cohesion: 0.09
Nodes (33): _infer_keywords(), _infer_loyalty(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, resolve_effect(), from_decks() (+25 more)
...
Cohesion: 0.12
Nodes (33): _attacker_has_active_landwalk_with_state(), _can_block_attacker(), _combat_damage_step(), _creature_is_lethally_damaged(), _damage_prevented_by_protection(), _deal_unblocked_damage(), declare_attackers(), _defender_label() (+25 more)
...
Cohesion: 0.09
Nodes (22): card_completeness(), _hydrate_deck_cards(), list_cards(), Report cached metadata and asset gaps for a deck's distinct card names., suggest_card(), _get_attr_or_key(), select_display_image_uri(), fallback_card_payload() (+14 more)

### Community 23 - "Community 23"
Cohesion: 0.14
Nodes (26): _collect_triggers(), _first_number(), _maybe_payload(), _trigger_from_oracle(), _collect_triggers(), emit_event_batch(), _first_number(), _has_artifact_or_enchantment_type() (+18 more)
...
Cohesion: 0.19
Nodes (26): deal_damage(), CardInstance, _state(), test_combat_only_override_applies_to_combat_damage(), test_named_source_override_does_not_unlock_other_sources(), test_target_permanent_can_have_damage_prevention_override(), test_target_player_can_have_damage_prevention_override(), test_combat_death_replacement_exiles_creature_instead_of_graveyard() (+18 more)
...
Cohesion: 0.12
Nodes (25): build_cast_hints(), _extract_modes(), inspect_target_hints(), inspect_target_hints(), test_memory_deluge_does_not_require_x_value_for_cast(), test_mode_and_x_hints_exposed(), test_planeswalker_cast_does_not_require_x_value_from_loyalty_text(), test_shark_typhoon_does_not_require_x_value_for_cast() (+17 more)
...
Cohesion: 0.13
Nodes (15): compute_max_land_plays_this_turn(), apply_state_based_actions(), apply_state_based_actions(), test_cleanup_discards_down_to_seven_by_default(), test_cleanup_keeps_over_seven_with_no_max_hand_size_effect(), Creatures present at untap lose summoning sickness; new ones keep it., A creature entering during a player's own turn keeps summoning sickness until th, test_combat_damage_reduces_life() (+7 more)
...
Cohesion: 0.15
Nodes (5): _card_looks_like_land(), _cmc(), _auto_bottom_cards(), mana_value(), parse_mana_cost()

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (21): destroy_permanent(), _move_creature_to_graveyard(), sacrifice(), replace_draw_cards(), apply_damage_replacements(), apply_permanent_damage_replacements(), _battlefield_oracle_texts(), _battlefield_position_map() (+13 more)

### Community 40 - "Community 40"
Cohesion: 0.15
Nodes (20): _extract_keywords_from_text(), _first_creature(), _infer_clause_effect(), _infer_topdeck_creature_put_effect(), _parse_count_token(), _split_clauses(), choose_mana_color_for_player(), _choose_any_permanent_target() (+12 more)
...
Cohesion: 0.24
Nodes (12): AnalyticsService, FakeRepo, test_ai_diagnostics_reports_matchup_metrics(), test_compare_replay_logs_labels_cast_resolution_error(), test_compare_replay_logs_labels_face_choice_mismatch(), test_compare_replay_logs_labels_mode_choice_mismatch(), test_compare_replay_logs_labels_pass_vs_action_root_cause(), test_compare_replay_logs_labels_stack_target_mismatch() (+4 more)
...
Cohesion: 0.17
Nodes (10): prevent_damage(), prevent_damage(), add_card_prevention_shield(), add_player_prevention_shield(), test_expansion_top_entries_have_deck_text(), test_ai_prefers_attack_on_open_board(), test_ossification_is_inferred_as_enchantment_not_sorcery(), test_deal_damage_to_creature_marks_damage_not_toughness() (+2 more)
...
Cohesion: 0.22
Nodes (14): enrich_divide_total(), infer_effect_from_oracle(), enrich_divide_total(), CardInstance, test_non_divide_x_spell_does_not_auto_set_divide_total(), test_x_mode_inference_respects_selected_mode_and_x(), test_oracle_add_counters_parsing(), test_oracle_collected_company_style_parsing() (+6 more)
...
Cohesion: 0.15
Nodes (13): extract_activated_abilities(), Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface., Extract simple mana-cost activated abilities from a card surface. (+5 more)

### Community 65 - "Community 65"
Cohesion: 0.19
Nodes (11): extract_saga_chapters(), Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., Parse chapter lines into ordered lore-counter triggers., _apply_legend_rule(), _apply_saga_state_actions(), _is_legendary() (+3 more)
...
Cohesion: 0.12
Nodes (12): Indestructible creatures should survive lethal spell damage., Indestructible creatures should survive lethal spell damage., Sub-lethal damage should not kill the creature., Sub-lethal damage should not kill the creature., Spell damage should kill creatures — state-based lethal check after damage., Spell damage should kill creatures — state-based lethal check after damage., test_deal_damage_destroys_creature_with_lethal_damage(), test_deal_damage_non_lethal_doesnt_kill() (+4 more)
...
Cohesion: 0.2
Nodes (11): card_cant_block(), card_must_block_if_able(), declare_attackers(), _defender_label(), _valid_defenders(), can_cast_in_current_timing(), card_cant_attack(), card_cant_attack_alone() (+3 more)
...
Cohesion: 0.2
Nodes (10): put_land_from_hand(), Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is, Resolve an effect that puts a land from hand onto the battlefield.      This is (+2 more)
...
Cohesion: 0.22
Nodes (9): Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent., Apply a selected face to a battlefield double-faced permanent. (+1 more)

### Community 86 - "Community 86"
Cohesion: 0.22
Nodes (9): Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes., Reveal the top card and transform the source when its type condition passes. (+1 more)
...
Cohesion: 0.25
Nodes (8): look_top_choose(), Resolve a three-pile top-card choice using deterministic value ordering., Resolve a three-pile top-card choice using deterministic value ordering., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback., Resolve a top-card hand/exile/bottom choice, with a legacy AI fallback.

### Community 90 - "Community 90"
Cohesion: 0.33
Nodes (3): guess_archetype(), FakeRepo, test_ai_diagnostics_reports_matchup_metrics()
...
Cohesion: 0.29
Nodes (7): Audit Status (2026-07-16), Audit Status (2026-07-18), Audit Status (2026-07-19), MTG Deck Testing Lab Finish Plan, Priority Order, Verification Gates, Verified Current State
...
Cohesion: 0.29
Nodes (7): Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., Return whether a card satisfies a structured library-search filter., search_card_matches()
...
Cohesion: 0.5
Nodes (4): exile_all_creatures(), Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events., Exile every creature, preserving ownership and leave events.
...
## Knowledge Gaps
- **371 isolated node(s):** `Report cached metadata and asset gaps for a deck's distinct card names.`, `Choose a bounded tactical horizon without making every turn expensive.`, `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Evaluate small-board blocker assignments by resolving cloned combat.`, `Search small-board attack subsets through the defender's best legal blocks.` (+366 more)
...
- **Why does `AIAgent` connect `Community 0` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 14`, `Community 18`, `Community 21`, `Community 26`, `Community 30`, `Community 36`, `Community 38`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 51`, `Community 56`, `Community 63`, `Community 72`, `Community 77`, `Community 84`, `Community 90`, `Community 105`, `Community 108`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `RulesEngine` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 12`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 31`, `Community 35`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 51`, `Community 54`, `Community 63`, `Community 65`, `Community 68`, `Community 72`, `Community 91`, `Community 96`, `Community 105`, `Community 106`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `CardInstance` connect `Community 28` to `Community 0`, `Community 1`, `Community 12`, `Community 13`, `Community 14`, `Community 20`, `Community 32`, `Community 34`, `Community 35`, `Community 39`, `Community 43`, `Community 45`, `Community 47`, `Community 48`, `Community 58`, `Community 62`, `Community 69`, `Community 78`, `Community 105`, `Community 106`?**
...
- **Are the 161 inferred relationships involving `CardInstance` (e.g. with `EffectSpec` and `AbilitySpec`) actually correct?**
  _`CardInstance` has 161 INFERRED edges - model-reasoned connections that need verification._
- **Are the 149 inferred relationships involving `str` (e.g. with `_controller_snapshot()` and `_restore_active_matches()`) actually correct?**
  _`str` has 149 INFERRED edges - model-reasoned connections that need verification._
