...
## Corpus Check
- 130 files · ~361,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 3988 edges · 87 communities (82 shown, 5 thin omitted)
- Extraction: 51% EXTRACTED · 49% INFERRED · 0% AMBIGUOUS · INFERRED: 1971 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f78fe31a`
...
Cohesion: 0.08
Nodes (61): build_cast_hints(), enrich_divide_total(), validate_cast_choice(), CardInstance, _extract_keywords_from_text(), _extract_modes(), _first_creature(), _infer_clause_effect() (+53 more)
...
Cohesion: 0.11
Nodes (41): check_cost_option_available(), RulesEngine, legal_moves(), extract_loyalty_abilities(), can_cast_in_current_timing(), RulesEngine, from_decks(), test_discard_additional_cost_is_paid() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (42): analyze_deck(), guess_archetype(), classify(), main(), analyze_deck_payload(), get_match_replay(), fallback_card_payload(), compact_action() (+34 more)
...
Cohesion: 0.17
Nodes (35): combat_damage(), declare_blockers(), from_decks(), combat_damage(), declare_blockers(), _setup_creature(), test_anthem_effect_allows_creature_to_survive_marked_damage(), test_anthem_effect_increases_combat_damage_output() (+27 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (30): resolve_effect(), draw_cards(), gain_life(), resolve_effect(), replace_draw_cards(), Zone, Anthem-like buffs must not permanently modify card.power/toughness., test_continuous_buff_does_not_mutate_base_stats() (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (10): copy_ability(), copy_spell(), _copy_stack_object(), destroy_permanent(), sacrifice(), create_token(), _creature_is_lethally_damaged(), deal_damage() (+2 more)
...
Cohesion: 0.11
Nodes (8): AIDecision, _card_looks_like_land(), AIDecision, _card_looks_like_land(), add_generic_to_cost(), parse_mana_cost(), test_control_ai_mulligan_counts_land_with_missing_types_from_oracle(), test_control_ai_mulligans_land_light_hand()
...
Cohesion: 0.15
Nodes (10): build_priors_from_logs(), save_log_priors(), rebuild_ai_priors(), simulate_batch_start(), _infer_loyalty(), main(), _read_training_run_logs(), _infer_loyalty() (+2 more)
...
Cohesion: 0.15
Nodes (12): _infer_mana_from_land(), _is_land_card(), pass_priority(), check_cost_option_available(), normalize_cost_choice(), _auto_bottom_cards(), _extract_equip_cost_text(), _infer_mana_from_land() (+4 more)
...
Cohesion: 0.16
Nodes (12): Enum, _infer_keywords(), _infer_power(), _infer_toughness(), _infer_types(), MatchState, Zone, _infer_keywords() (+4 more)
...
## Knowledge Gaps
- **101 isolated node(s):** `Depth-limited stack planner for counter wars; only runs while stack is active.`, `Push control decks to convert resources instead of over-passing in developed boa`, `Ingest external tournament event payloads into normalized local tables.      Exp`, `Anthem-like buffs must not permanently modify card.power/toughness.`, `+1/+1 and -1/-1 counters should affect effective_power/toughness without mutatin` (+96 more)
...
- **Why does `RulesEngine` connect `Community 3` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 23`, `Community 26`, `Community 27`, `Community 32`, `Community 37`, `Community 43`, `Community 54`, `Community 58`, `Community 59`, `Community 60`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `AIAgent` connect `Community 5` to `Community 34`, `Community 3`, `Community 2`, `Community 37`, `Community 6`, `Community 7`, `Community 4`, `Community 18`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 58`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `from_decks()` connect `Community 11` to `Community 0`, `Community 1`, `Community 32`, `Community 3`, `Community 58`, `Community 37`, `Community 4`, `Community 6`, `Community 12`, `Community 15`, `Community 50`, `Community 19`, `Community 23`, `Community 25`, `Community 26`, `Community 59`, `Community 29`, `Community 30`?**
