...
- Backend: `416 passed`, 32 deprecation warnings.
...
- The current representative corpus still has concrete fallback cards in normal games, including Storm the Festival and Shark Typhoon; unusual modal, top-library, cycling, and multi-part permanent effects remain outside the generic resolver.
