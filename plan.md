...
- Current consolidated rules/AI validation: `242 passed`; frontend production build passes; the current three-game deterministic replay smoke has 0 determinism failures and 0 drift labels.
...
- Current focused implementation gate combines cycling, search, top-card choices, Oracle, event, replacement, continuous-effect, and AI tests: `242 passed`.
