...
- Current consolidated rules/AI validation: `250 passed`; frontend production build passes; the current three-game deterministic replay smoke has 0 determinism failures and 0 drift labels.
...
- Current focused implementation gate combines cycling, search, top-card choices, bounce, Saga, Vehicle, Oracle, event, replacement, continuous-effect, and AI tests: `250 passed`.
