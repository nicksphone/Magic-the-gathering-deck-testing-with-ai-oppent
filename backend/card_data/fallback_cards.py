...
FALLBACK_CARD_DATA: dict[str, dict[str, Any]] = {
    ...
    "fable of the mirror-breaker": {"mana_cost": "{2}{R}", "type_line": "Enchantment — Saga", "oracle_text": "I — Create a 2/2 red Goblin Shaman creature token with \"Whenever this creature attacks, create a Treasure token.\"\nII — You may discard up to two cards. If you do, draw that many cards.\nIII — Exile this Saga, then return it to the battlefield transformed under your control.", "power": None, "toughness": None},
