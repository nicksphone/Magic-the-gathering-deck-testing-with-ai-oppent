...
class GamePlayApp(QWidget):
    ...
    def check_win_loss_condition(self):
        if self.ai_life_total <= 0:
           ...
           Here’s the **complete `game_play.py`** file with all features fully integrated:
...
class GamePlayApp(QWidget):
    ...
    def drawHere is the complete **`game_play.py`** file with all the necessary features fully integrated:
